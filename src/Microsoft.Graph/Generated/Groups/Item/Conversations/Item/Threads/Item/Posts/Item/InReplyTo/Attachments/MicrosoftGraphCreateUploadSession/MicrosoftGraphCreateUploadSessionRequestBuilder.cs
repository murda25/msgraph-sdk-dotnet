...
namespace Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.MicrosoftGraphCreateUploadSession {
    /// <summary>
    ...
    public class MicrosoftGraphCreateUploadSessionRequestBuilder {
        ...
        public MicrosoftGraphCreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/attachments/microsoft.graph.createUploadSession";
