...
using Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.MicrosoftGraphForward;
using Microsoft.Graph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.MicrosoftGraphReply;
...
#nullable enable
        public async Task<Post?> GetAsync(Action<PostItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Post> GetAsync(Action<PostItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
