...
namespace Microsoft.Graph.Groups.Item.Conversations.Item.Threads {
    ...
    public class ThreadsRequestBuilder {
        ...
        /// </summary>
        public async Task<ConversationThreadCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ThreadsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ConversationThread> PostAsync(ConversationThread body, CancellationToken cancellationToken = default, Action<ThreadsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
