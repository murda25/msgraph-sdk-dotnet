...
namespace Microsoft.Graph.Groups.Item.Onenote.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.onenote.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/onenote/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
