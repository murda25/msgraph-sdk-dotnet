...
using MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook;
using MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup;
using MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups;
using MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections;
...
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}{?select,expand}";
