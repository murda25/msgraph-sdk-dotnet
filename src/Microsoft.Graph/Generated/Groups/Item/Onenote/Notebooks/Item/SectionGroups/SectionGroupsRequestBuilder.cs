...
using MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\onenote\notebooks\{notebook-id}\sectionGroups</summary>
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.onenote.notebooks.item.sectionGroups.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SectionGroup body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
