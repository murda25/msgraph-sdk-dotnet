...
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.ParentSectionGroup.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}/parentSectionGroup/$ref";
