using Microsoft.Graph.Groups.Item.Onenote.Notebooks.Item.MicrosoftGraphCopyNotebook;
...
namespace Microsoft.Graph.Groups.Item.Onenote.Notebooks.Item {
    ...
    public class NotebookItemRequestBuilder {
        ...
        public NotebookItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}{?%24select,%24expand}";
