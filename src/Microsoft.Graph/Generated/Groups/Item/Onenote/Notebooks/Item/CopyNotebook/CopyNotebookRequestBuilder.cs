...
namespace Microsoft.Graph.Groups.Item.Onenote.Notebooks.Item.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        public CopyNotebookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/microsoft.graph.copyNotebook";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CopyNotebookRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// </summary>
        public async Task<OnenoteOperation> PostAsync(CopyNotebookRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
