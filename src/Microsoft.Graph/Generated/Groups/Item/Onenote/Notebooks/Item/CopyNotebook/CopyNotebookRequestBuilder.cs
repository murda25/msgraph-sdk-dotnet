...
namespace Microsoft.Graph.Groups.Item.Onenote.Notebooks.Item.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CopyNotebookRequestBody body, Action<CopyNotebookRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<OnenoteOperation> PostAsync(CopyNotebookRequestBody body, Action<CopyNotebookRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
