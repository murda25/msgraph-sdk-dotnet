...
using MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.onenote.notebooks.item.sectionGroups.item.sections.item collection</summary>
