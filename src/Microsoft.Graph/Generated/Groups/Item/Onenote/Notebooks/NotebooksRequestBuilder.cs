...
using Microsoft.Graph.Groups.Item.Onenote.Notebooks.MicrosoftGraphGetNotebookFromWebUrl;
using Microsoft.Graph.Groups.Item.Onenote.Notebooks.MicrosoftGraphGetRecentNotebooksWithIncludePersonalNotebooks;
...
namespace Microsoft.Graph.Groups.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder {
        ...
        public NotebooksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
