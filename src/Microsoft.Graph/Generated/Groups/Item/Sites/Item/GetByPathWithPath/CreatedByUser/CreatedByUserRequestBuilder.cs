...
namespace Microsoft.Graph.Groups.Item.Sites.Item.GetByPathWithPath.CreatedByUser {
    ...
    public class CreatedByUserRequestBuilder : BaseRequestBuilder {
        ...
        public CreatedByUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/createdByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreatedByUserRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreatedByUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/createdByUser{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
