...
namespace Microsoft.Graph.Groups.Item.Sites.Item.TermStores {
    ...
    public class TermStoresRequestBuilder {
        ...
        /// </summary>
        public async Task<StoreCollectionResponse> GetAsync(Action<TermStoresRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Store> PostAsync(Store body, Action<TermStoresRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
