...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.Item.ToTerm {
    ...
    public class ToTermRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}/sets/{set_id}/relations/{relation_id}/toTerm{?select,expand}";
