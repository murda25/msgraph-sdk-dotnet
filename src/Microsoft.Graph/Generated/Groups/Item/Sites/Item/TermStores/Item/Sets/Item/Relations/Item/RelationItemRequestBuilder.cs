...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.FromTerm;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.Set;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.ToTerm;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Relations.Item {
    ...
    public class RelationItemRequestBuilder {
        ...
        public RelationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/relations/{relation_id}{?select,expand}";
