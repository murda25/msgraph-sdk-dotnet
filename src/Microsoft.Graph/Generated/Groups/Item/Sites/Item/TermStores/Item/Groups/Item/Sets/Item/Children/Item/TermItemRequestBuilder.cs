...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Relations;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Set;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder Children { get =>
            new MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/groups/{group_id1}/sets/{set_id}/children/{term_id}{?select,expand}";
