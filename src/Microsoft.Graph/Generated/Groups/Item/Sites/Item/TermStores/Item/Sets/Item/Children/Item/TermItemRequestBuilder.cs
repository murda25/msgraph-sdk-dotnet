...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Children;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Set;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder Children { get =>
            new MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        }
