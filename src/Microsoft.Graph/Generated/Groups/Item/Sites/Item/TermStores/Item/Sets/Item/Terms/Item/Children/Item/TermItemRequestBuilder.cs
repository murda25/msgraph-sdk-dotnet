...
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item.Relations;
using MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item.Set;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/children/{term_id1}{?select,expand}";
