...
namespace Microsoft.Graph.Groups.Item.Sites.Item.Lists {
    ...
    public class ListsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.List> PostAsync(Microsoft.Graph.Models.List body, CancellationToken cancellationToken = default, Action<ListsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
