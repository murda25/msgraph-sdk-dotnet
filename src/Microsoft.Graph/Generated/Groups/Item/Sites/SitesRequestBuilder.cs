...
namespace Microsoft.Graph.Groups.Item.Sites {
    ...
    public class SitesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Models.Site body, Action<SitesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<SiteCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SitesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Site> PostAsync(Microsoft.Graph.Models.Site body, CancellationToken cancellationToken = default, Action<SitesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.Site>(requestInfo, Microsoft.Graph.Models.Site.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
