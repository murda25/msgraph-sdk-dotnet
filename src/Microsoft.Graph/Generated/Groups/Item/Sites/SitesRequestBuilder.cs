...
using MicrosoftGraphSdk.Groups.Item.Sites.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Sites {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\sites</summary>
