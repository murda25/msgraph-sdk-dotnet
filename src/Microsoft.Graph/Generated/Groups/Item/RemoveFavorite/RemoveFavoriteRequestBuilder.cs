...
namespace Microsoft.Graph.Groups.Item.RemoveFavorite {
    ...
    public class RemoveFavoriteRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RemoveFavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
