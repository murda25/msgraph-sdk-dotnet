...
namespace Microsoft.Graph.Groups.Item.RemoveFavorite {
    ...
    public class RemoveFavoriteRequestBuilder {
        ...
        public RemoveFavoriteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/removeFavorite";
...
#nullable enable
        public async Task PostAsync(Action<RemoveFavoriteRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<RemoveFavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
