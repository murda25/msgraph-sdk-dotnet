...
namespace Microsoft.Graph.Groups.Item.TransitiveMembers {
    ...
    public class TransitiveMembersRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<TransitiveMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
