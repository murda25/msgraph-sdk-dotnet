using Microsoft.Graph.Groups.Item.TransitiveMembers.Application;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Count;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Device;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Group;
using Microsoft.Graph.Groups.Item.TransitiveMembers.Item;
using Microsoft.Graph.Groups.Item.TransitiveMembers.OrgContact;
using Microsoft.Graph.Groups.Item.TransitiveMembers.ServicePrincipal;
using Microsoft.Graph.Groups.Item.TransitiveMembers.User;
...
namespace Microsoft.Graph.Groups.Item.TransitiveMembers {
    ...
    public class TransitiveMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.transitiveMembers.item collection</summary>
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TransitiveMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
