...
namespace Microsoft.Graph.Groups.Item.TransitiveMembers.MicrosoftGraphOrgContact.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/microsoft.graph.orgContact/$count{?%24search,%24filter}";
