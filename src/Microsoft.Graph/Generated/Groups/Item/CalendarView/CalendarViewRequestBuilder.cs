...
namespace Microsoft.Graph.Groups.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendarView{?startDateTime,endDateTime,%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
