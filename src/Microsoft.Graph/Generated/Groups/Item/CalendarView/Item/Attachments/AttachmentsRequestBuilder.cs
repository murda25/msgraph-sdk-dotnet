...
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Attachments.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.calendarView.item.attachments.item collection</summary>
