...
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MicrosoftGraphAccept;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MicrosoftGraphCancel;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MicrosoftGraphDecline;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MicrosoftGraphDismissReminder;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MicrosoftGraphForward;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MicrosoftGraphSnoozeReminder;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MicrosoftGraphTentativelyAccept;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item.SingleValueExtendedProperties;
...
namespace Microsoft.Graph.Groups.Item.CalendarView.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}{?%24select}";
