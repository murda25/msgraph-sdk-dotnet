...
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Accept;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Attachments;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Calendar;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Cancel;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Decline;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.DismissReminder;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Extensions;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.Forward;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.SingleValueExtendedProperties;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.SnoozeReminder;
using MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item.TentativelyAccept;
...
namespace MicrosoftGraphSdk.Groups.Item.CalendarView.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}/instances/{event_id1}{?select}";
