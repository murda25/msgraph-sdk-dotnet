...
namespace Microsoft.Graph.Groups.Item.Events.Item.Instances.Item.MicrosoftGraphForward {
    /// <summary>
    ...
    public class MicrosoftGraphForwardRequestBuilder {
        ...
        public MicrosoftGraphForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.forward";
