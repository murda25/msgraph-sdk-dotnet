...
using MicrosoftGraphSdk.Groups.Item.Events.Item.Instances.Delta;
using MicrosoftGraphSdk.Groups.Item.Events.Item.Instances.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Events.Item.Instances {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.events.item.instances.item collection</summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
