...
namespace MicrosoftGraphSdk.Groups.Item.Events.Item.Calendar.GetSchedule {
    ...
    public class GetScheduleRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraphSdk.Groups.Item.Events.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraphSdk.Groups.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
