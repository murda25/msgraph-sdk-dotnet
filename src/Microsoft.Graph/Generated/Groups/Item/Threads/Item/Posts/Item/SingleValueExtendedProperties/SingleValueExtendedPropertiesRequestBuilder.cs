...
using MicrosoftGraphSdk.Groups.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.threads.item.posts.item.singleValueExtendedProperties.item collection</summary>
