...
namespace Microsoft.Graph.Groups.Item.Threads.Item.Posts.Item.InReplyTo {
    ...
    public class InReplyToRequestBuilder {
        ...
        /// </summary>
        public async Task<Post> GetAsync(Action<InReplyToRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Post> PatchAsync(Post body, Action<InReplyToRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
