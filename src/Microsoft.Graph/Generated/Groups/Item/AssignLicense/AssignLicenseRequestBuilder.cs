...
namespace Microsoft.Graph.Groups.Item.AssignLicense {
    ...
    public class AssignLicenseRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Group> PostAsync(AssignLicensePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignLicenseRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
