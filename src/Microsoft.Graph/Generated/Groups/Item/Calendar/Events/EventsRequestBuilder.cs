...
namespace Microsoft.Graph.Groups.Item.Calendar.Events {
    ...
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.calendar.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
