...
using MicrosoftGraphSdk.Groups.Item.Calendar.Events.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.Events.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\events\{event-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.calendar.events.item.singleValueExtendedProperties.item collection</summary>
