...
using MicrosoftGraphSdk.Groups.Item.Calendar.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Groups.Item.Calendar.Events.Item.Attachments.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.calendar.events.item.attachments.item collection</summary>
