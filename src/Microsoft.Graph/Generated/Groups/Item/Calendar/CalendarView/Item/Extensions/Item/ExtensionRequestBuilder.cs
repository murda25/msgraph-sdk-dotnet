...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendar\calendarView\{event-id}\extensions\{extension-id}</summary>
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendar/calendarView/{event_id}/extensions/{extension_id}{?select,expand}";
