...
namespace Microsoft.Graph.Groups.Item.Calendar.CalendarView.Item.Attachments.MicrosoftGraphCreateUploadSession {
    /// <summary>
    ...
    public class MicrosoftGraphCreateUploadSessionRequestBuilder {
        ...
        public MicrosoftGraphCreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/attachments/microsoft.graph.createUploadSession";
