...
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Delta;
using MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Calendar.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.calendar.calendarView.item.instances.item collection</summary>
