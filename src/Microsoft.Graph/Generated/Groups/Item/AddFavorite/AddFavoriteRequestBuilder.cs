...
namespace Microsoft.Graph.Groups.Item.AddFavorite {
    ...
    public class AddFavoriteRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<AddFavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
