using Microsoft.Graph.Groups.Item.Drives.Item.Following.Count;
using Microsoft.Graph.Groups.Item.Drives.Item.Following.Item;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Following {
    ...
    public class FollowingRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.drives.item.following.item collection</summary>
        ...
        public FollowingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/following{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
