using Microsoft.Graph.Groups.Item.Drives.Item.Bundles;
using Microsoft.Graph.Groups.Item.Drives.Item.Following;
using Microsoft.Graph.Groups.Item.Drives.Item.Items;
using Microsoft.Graph.Groups.Item.Drives.Item.List;
using Microsoft.Graph.Groups.Item.Drives.Item.Recent;
using Microsoft.Graph.Groups.Item.Drives.Item.Root;
using Microsoft.Graph.Groups.Item.Drives.Item.SearchWithQ;
using Microsoft.Graph.Groups.Item.Drives.Item.SharedWithMe;
using Microsoft.Graph.Groups.Item.Drives.Item.Special;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Microsoft.Graph.Models.Drive body, Action<DriveItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DriveItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Drive> GetAsync(CancellationToken cancellationToken = default, Action<DriveItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.Drive>(requestInfo, Microsoft.Graph.Models.Drive.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update the navigation property drives in groups
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Drive body, CancellationToken cancellationToken = default, Action<DriveItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
