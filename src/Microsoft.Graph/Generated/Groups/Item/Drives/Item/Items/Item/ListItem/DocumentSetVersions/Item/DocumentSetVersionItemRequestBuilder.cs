using Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item.Restore;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
