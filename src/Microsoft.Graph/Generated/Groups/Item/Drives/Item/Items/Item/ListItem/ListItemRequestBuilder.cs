...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.Fields;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.GetActivitiesByInterval;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Groups.Item.Drives.Item.Items.Item.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
