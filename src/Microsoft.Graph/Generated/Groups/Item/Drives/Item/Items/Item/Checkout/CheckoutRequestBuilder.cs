...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Checkout {
    ...
    public class CheckoutRequestBuilder {
        ...
        public CheckoutRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.checkout";
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<CheckoutRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
