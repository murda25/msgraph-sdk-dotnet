...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Checkout {
    ...
    public class CheckoutRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<CheckoutRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
