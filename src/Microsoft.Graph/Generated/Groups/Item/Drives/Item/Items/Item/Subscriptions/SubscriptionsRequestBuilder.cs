using Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Subscriptions.Count;
using Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Subscriptions.Item;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.drives.item.items.item.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
