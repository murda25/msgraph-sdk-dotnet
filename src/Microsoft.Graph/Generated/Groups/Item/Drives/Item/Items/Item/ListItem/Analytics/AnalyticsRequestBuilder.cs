...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.ListItem.Analytics {
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/analytics{?%24select,%24expand}";
