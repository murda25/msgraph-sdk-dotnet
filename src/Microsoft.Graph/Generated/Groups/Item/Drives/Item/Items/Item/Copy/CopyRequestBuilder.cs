...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.copy";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(CopyPostRequestBody body, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
