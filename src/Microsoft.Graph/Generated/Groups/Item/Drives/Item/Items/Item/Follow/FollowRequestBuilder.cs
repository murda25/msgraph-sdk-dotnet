...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Follow {
    ...
    public class FollowRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(CancellationToken cancellationToken = default, Action<FollowRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
