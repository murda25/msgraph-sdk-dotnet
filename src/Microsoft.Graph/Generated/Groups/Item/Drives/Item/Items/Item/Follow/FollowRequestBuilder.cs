...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Follow {
    ...
    public class FollowRequestBuilder {
        ...
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(Action<FollowRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
