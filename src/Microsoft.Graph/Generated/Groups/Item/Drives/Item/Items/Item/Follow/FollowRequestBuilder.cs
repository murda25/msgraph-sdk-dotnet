...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Follow {
    ...
    public class FollowRequestBuilder {
        ...
        public FollowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.follow";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(Action<FollowRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
