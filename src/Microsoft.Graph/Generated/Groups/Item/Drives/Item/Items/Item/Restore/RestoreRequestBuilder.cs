...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.restore";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(RestorePostRequestBody body, Action<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
