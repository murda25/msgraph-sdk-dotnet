...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Items.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(RestorePostRequestBody body, CancellationToken cancellationToken = default, Action<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
