...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Permissions.Item.Grant;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
