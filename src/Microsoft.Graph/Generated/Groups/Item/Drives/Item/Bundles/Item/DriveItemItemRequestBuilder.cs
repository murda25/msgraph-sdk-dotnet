using Microsoft.Graph.Groups.Item.Drives.Item.Bundles.Item.Content;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Bundles.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/bundles/{driveItem%2Did}{?%24select,%24expand}";
