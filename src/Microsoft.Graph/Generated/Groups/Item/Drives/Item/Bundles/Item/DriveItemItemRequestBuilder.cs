...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Analytics;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Children;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Content;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.ListItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Permissions;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Subscriptions;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Thumbnails;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item.Versions;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Bundles.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/bundles/{driveItem_id}{?select,expand}";
        ...
        /// <summary>
        /// Delete navigation property bundles for groups
        ...
        /// <summary>
        /// Update the navigation property bundles in groups
