using Microsoft.Graph.Groups.Item.Drives.Item.Root.Versions.Item.Content;
using Microsoft.Graph.Groups.Item.Drives.Item.Root.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Root.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/versions/{driveItemVersion%2Did}{?%24select,%24expand}";
