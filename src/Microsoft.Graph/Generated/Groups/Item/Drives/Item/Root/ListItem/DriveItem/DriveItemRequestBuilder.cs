using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.DriveItem.Content;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/listItem/driveItem{?%24select,%24expand}";
