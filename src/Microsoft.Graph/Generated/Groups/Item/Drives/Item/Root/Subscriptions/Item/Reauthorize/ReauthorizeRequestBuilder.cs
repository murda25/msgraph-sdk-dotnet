...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Root.Subscriptions.Item.Reauthorize {
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
