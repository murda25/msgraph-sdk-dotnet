using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.Analytics;
using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.DocumentSetVersions;
using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.DriveItem;
using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.Fields;
using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.GetActivitiesByInterval;
using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.Versions;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new Microsoft.Graph.Groups.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/listItem{?%24select,%24expand}";
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Microsoft.Graph.Models.ListItem body, Action<ListItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ListItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.ListItem> GetAsync(CancellationToken cancellationToken = default, Action<ListItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.ListItem>(requestInfo, Microsoft.Graph.Models.ListItem.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Update the navigation property listItem in groups
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.ListItem body, CancellationToken cancellationToken = default, Action<ListItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
