...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.Analytics;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.DriveItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.Fields;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.GetActivitiesByInterval;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder DriveItem { get =>
            new MicrosoftGraphSdk.Groups.Item.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        }
