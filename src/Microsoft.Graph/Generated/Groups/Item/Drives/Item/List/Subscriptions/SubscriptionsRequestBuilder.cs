using Microsoft.Graph.Groups.Item.Drives.Item.List.Subscriptions.Count;
using Microsoft.Graph.Groups.Item.Drives.Item.List.Subscriptions.Item;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.drives.item.list.subscriptions.item collection</summary>
