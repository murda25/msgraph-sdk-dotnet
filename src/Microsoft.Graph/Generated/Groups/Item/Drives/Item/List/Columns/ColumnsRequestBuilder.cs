using Microsoft.Graph.Groups.Item.Drives.Item.List.Columns.Count;
using Microsoft.Graph.Groups.Item.Drives.Item.List.Columns.Item;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.List.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.drives.item.list.columns.item collection</summary>
