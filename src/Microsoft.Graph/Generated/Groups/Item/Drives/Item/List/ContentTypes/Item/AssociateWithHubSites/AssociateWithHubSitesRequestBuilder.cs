...
namespace Microsoft.Graph.Groups.Item.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites {
    /// <summary>
    ...
    public class AssociateWithHubSitesRequestBuilder {
        ...
        public AssociateWithHubSitesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/microsoft.graph.associateWithHubSites";
