...
namespace Microsoft.Graph.Groups.Item.Drives.Item.List.Subscriptions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/subscriptions/$count{?%24search,%24filter}";
