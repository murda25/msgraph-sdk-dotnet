using Microsoft.Graph.Groups.Item.Drives.Item.List.ContentTypes.AddCopy;
using Microsoft.Graph.Groups.Item.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub;
using Microsoft.Graph.Groups.Item.Drives.Item.List.ContentTypes.Count;
using Microsoft.Graph.Groups.Item.Drives.Item.List.ContentTypes.GetCompatibleHubContentTypes;
using Microsoft.Graph.Groups.Item.Drives.Item.List.ContentTypes.Item;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.drives.item.list.contentTypes.item collection</summary>
