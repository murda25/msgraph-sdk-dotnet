...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.ContentTypes.AddCopy;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.ContentTypes.Count;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.ContentTypes.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.drives.item.list.contentTypes.item collection</summary>
