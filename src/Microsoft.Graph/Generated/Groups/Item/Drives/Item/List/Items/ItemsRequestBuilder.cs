...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Items.Count;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Items.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.drives.item.list.items.item collection</summary>
