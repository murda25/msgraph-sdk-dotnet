using Microsoft.Graph.Groups.Item.Drives.Item.Special.Item.Content;
...
namespace Microsoft.Graph.Groups.Item.Drives.Item.Special.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/special/{driveItem%2Did}{?%24select,%24expand}";
