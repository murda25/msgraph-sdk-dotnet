...
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Analytics;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Children;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Content;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.ListItem;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Permissions;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Subscriptions;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Thumbnails;
using MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item.Versions;
...
namespace MicrosoftGraphSdk.Groups.Item.Drives.Item.Special.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/drives/{drive_id}/special/{driveItem_id}{?select,expand}";
        ...
        /// <summary>
        /// Delete navigation property special for groups
        ...
        /// <summary>
        /// Update the navigation property special in groups
