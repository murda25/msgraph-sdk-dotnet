...
namespace MicrosoftGraphSdk.Groups.Item.CheckGrantedPermissionsForApp {
    ...
    public class CheckGrantedPermissionsForAppRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraphSdk.Groups.Item.CheckGrantedPermissionsForApp.CheckGrantedPermissionsForApp>> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreatePostRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraphSdk.Groups.Item.CheckGrantedPermissionsForApp.CheckGrantedPermissionsForApp>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
