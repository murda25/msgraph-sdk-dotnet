...
namespace Microsoft.Graph.Groups.Item.MembersWithLicenseErrors.Item.Group.ResetUnseenCount {
    ...
    public class ResetUnseenCountRequestBuilder {
        ...
        public ResetUnseenCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.resetUnseenCount";
