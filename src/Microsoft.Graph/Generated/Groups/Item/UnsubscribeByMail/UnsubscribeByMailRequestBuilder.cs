...
namespace Microsoft.Graph.Groups.Item.UnsubscribeByMail {
    ...
    public class UnsubscribeByMailRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UnsubscribeByMailRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
