using Microsoft.Graph.Groups.Item.PermissionGrants.Item.MicrosoftGraphCheckMemberGroups;
using Microsoft.Graph.Groups.Item.PermissionGrants.Item.MicrosoftGraphCheckMemberObjects;
using Microsoft.Graph.Groups.Item.PermissionGrants.Item.MicrosoftGraphGetMemberGroups;
using Microsoft.Graph.Groups.Item.PermissionGrants.Item.MicrosoftGraphGetMemberObjects;
using Microsoft.Graph.Groups.Item.PermissionGrants.Item.MicrosoftGraphRestore;
...
namespace Microsoft.Graph.Groups.Item.PermissionGrants.Item {
    ...
    public class ResourceSpecificPermissionGrantItemRequestBuilder {
        ...
        public ResourceSpecificPermissionGrantItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}";
