...
namespace MicrosoftGraphSdk.Groups.Item.PermissionGrants.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\permissionGrants\{resourceSpecificPermissionGrant-id}</summary>
    public class ResourceSpecificPermissionGrantRequestBuilder {
        ...
        public ResourceSpecificPermissionGrantRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/permissionGrants/{resourceSpecificPermissionGrant_id}{?select,expand}";
