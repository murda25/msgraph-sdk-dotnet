...
namespace Microsoft.Graph.Groups.Item.Team.Channels.Item.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentItemRequestBuilder {
        ...
        public ChatMessageHostedContentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}{?%24select,%24expand}";
