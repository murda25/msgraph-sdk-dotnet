...
namespace Microsoft.Graph.Groups.Item.Team.Channels.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.team.channels.item.members.item collection</summary>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/members{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
