...
using MicrosoftGraphSdk.Groups.Item.Team.Channels.Count;
using MicrosoftGraphSdk.Groups.Item.Team.Channels.GetAllMessages;
using MicrosoftGraphSdk.Groups.Item.Team.Channels.Item;
...
namespace MicrosoftGraphSdk.Groups.Item.Team.Channels {
    ...
    public class ChannelsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.groups.item.team.channels.item collection</summary>
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Channel body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// </summary>
        public async Task<ChannelCollectionResponse> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Channel> PostAsync(Channel body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
