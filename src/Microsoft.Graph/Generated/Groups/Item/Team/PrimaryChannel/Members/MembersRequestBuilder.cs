...
namespace Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.team.primaryChannel.members.item collection</summary>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/primaryChannel/members{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
