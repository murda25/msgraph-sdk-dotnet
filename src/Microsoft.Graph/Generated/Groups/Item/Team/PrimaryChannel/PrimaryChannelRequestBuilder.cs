...
using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.MicrosoftGraphCompleteMigration;
using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName;
using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.MicrosoftGraphProvisionEmail;
using Microsoft.Graph.Groups.Item.Team.PrimaryChannel.MicrosoftGraphRemoveEmail;
...
namespace Microsoft.Graph.Groups.Item.Team.PrimaryChannel {
    ...
    public class PrimaryChannelRequestBuilder {
        ...
        public PrimaryChannelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/primaryChannel{?%24select,%24expand}";
