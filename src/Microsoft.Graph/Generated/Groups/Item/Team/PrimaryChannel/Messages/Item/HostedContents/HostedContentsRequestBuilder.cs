...
namespace Microsoft.Graph.Groups.Item.Team.PrimaryChannel.Messages.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.team.primaryChannel.messages.item.hostedContents.item collection</summary>
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
