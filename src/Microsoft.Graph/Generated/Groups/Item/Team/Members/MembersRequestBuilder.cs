...
namespace Microsoft.Graph.Groups.Item.Team.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.team.members.item collection</summary>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
