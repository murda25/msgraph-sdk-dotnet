...
namespace Microsoft.Graph.Groups.Item.Team.Schedule.SwapShiftsChangeRequests {
    ...
    public class SwapShiftsChangeRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<SwapShiftsChangeRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SwapShiftsChangeRequest> PostAsync(SwapShiftsChangeRequest body, CancellationToken cancellationToken = default, Action<SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
