...
namespace Microsoft.Graph.Groups.Item.Team.Schedule.SwapShiftsChangeRequests {
    ...
    public class SwapShiftsChangeRequestsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SwapShiftsChangeRequest body, Action<SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<SwapShiftsChangeRequestCollectionResponse> GetAsync(Action<SwapShiftsChangeRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SwapShiftsChangeRequest> PostAsync(SwapShiftsChangeRequest body, Action<SwapShiftsChangeRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
