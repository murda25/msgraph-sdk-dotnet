...
namespace Microsoft.Graph.Groups.Item.Team.AllChannels {
    ...
    public class AllChannelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.team.allChannels.item collection</summary>
        ...
        /// </summary>
        public AllChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AllChannelsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task<ChannelCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AllChannelsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
