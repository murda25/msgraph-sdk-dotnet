...
namespace Microsoft.Graph.Groups.Item.Team.AllChannels {
    ...
    public class AllChannelsRequestBuilder {
        ...
        /// </summary>
        public async Task<ChannelCollectionResponse> GetAsync(Action<AllChannelsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
