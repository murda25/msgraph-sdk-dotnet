...
namespace Microsoft.Graph.Groups.Item.Team.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.team.operations.item collection</summary>
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/operations{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
