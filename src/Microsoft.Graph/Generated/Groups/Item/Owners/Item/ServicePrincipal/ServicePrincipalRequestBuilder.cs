...
namespace Microsoft.Graph.Groups.Item.Owners.Item.ServicePrincipal {
    /// <summary>
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
