...
namespace Microsoft.Graph.Groups.Item.Owners.Item.Group.AddFavorite {
    ...
    public class AddFavoriteRequestBuilder {
        ...
        public AddFavoriteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.addFavorite";
