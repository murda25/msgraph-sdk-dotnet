...
namespace Microsoft.Graph.Groups.Item.Owners.MicrosoftGraphDevice.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/microsoft.graph.device/$count{?%24search,%24filter}";
