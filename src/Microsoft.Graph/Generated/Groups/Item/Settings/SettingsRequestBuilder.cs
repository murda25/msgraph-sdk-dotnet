...
namespace Microsoft.Graph.Groups.Item.Settings {
    ...
    public class SettingsRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupSettingCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupSetting> PostAsync(GroupSetting body, CancellationToken cancellationToken = default, Action<SettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
