...
namespace Microsoft.Graph.Groups.Item.Members.Item.Group.ResetUnseenCount {
    ...
    public class ResetUnseenCountRequestBuilder {
        ...
        public ResetUnseenCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.resetUnseenCount";
