using Microsoft.Graph.Groups.Item.Members.Item.Group.AddFavorite;
using Microsoft.Graph.Groups.Item.Members.Item.Group.AssignLicense;
using Microsoft.Graph.Groups.Item.Members.Item.Group.CheckGrantedPermissionsForApp;
using Microsoft.Graph.Groups.Item.Members.Item.Group.CheckMemberGroups;
using Microsoft.Graph.Groups.Item.Members.Item.Group.CheckMemberObjects;
using Microsoft.Graph.Groups.Item.Members.Item.Group.GetMemberGroups;
using Microsoft.Graph.Groups.Item.Members.Item.Group.GetMemberObjects;
using Microsoft.Graph.Groups.Item.Members.Item.Group.RemoveFavorite;
using Microsoft.Graph.Groups.Item.Members.Item.Group.Renew;
using Microsoft.Graph.Groups.Item.Members.Item.Group.ResetUnseenCount;
using Microsoft.Graph.Groups.Item.Members.Item.Group.Restore;
using Microsoft.Graph.Groups.Item.Members.Item.Group.SubscribeByMail;
using Microsoft.Graph.Groups.Item.Members.Item.Group.UnsubscribeByMail;
using Microsoft.Graph.Groups.Item.Members.Item.Group.ValidateProperties;
...
namespace Microsoft.Graph.Groups.Item.Members.Item.Group {
    ...
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/microsoft.graph.group{?%24select,%24expand}";
