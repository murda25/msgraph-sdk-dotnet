...
namespace Microsoft.Graph.Groups.Item.Members.Item.Group.UnsubscribeByMail {
    ...
    public class UnsubscribeByMailRequestBuilder {
        ...
        public UnsubscribeByMailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.unsubscribeByMail";
