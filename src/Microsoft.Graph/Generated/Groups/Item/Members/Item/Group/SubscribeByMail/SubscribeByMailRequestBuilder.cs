...
namespace Microsoft.Graph.Groups.Item.Members.Item.Group.SubscribeByMail {
    ...
    public class SubscribeByMailRequestBuilder {
        ...
        public SubscribeByMailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.subscribeByMail";
