...
namespace Microsoft.Graph.Groups.Item.MemberOf.Item.Group.AddFavorite {
    ...
    public class AddFavoriteRequestBuilder {
        ...
        public AddFavoriteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.addFavorite";
