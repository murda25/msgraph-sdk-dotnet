using Microsoft.Graph.Groups.Item.MemberOf.Application;
using Microsoft.Graph.Groups.Item.MemberOf.Count;
using Microsoft.Graph.Groups.Item.MemberOf.Device;
using Microsoft.Graph.Groups.Item.MemberOf.Group;
using Microsoft.Graph.Groups.Item.MemberOf.Item;
using Microsoft.Graph.Groups.Item.MemberOf.OrgContact;
using Microsoft.Graph.Groups.Item.MemberOf.ServicePrincipal;
using Microsoft.Graph.Groups.Item.MemberOf.User;
...
namespace Microsoft.Graph.Groups.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.memberOf.item collection</summary>
