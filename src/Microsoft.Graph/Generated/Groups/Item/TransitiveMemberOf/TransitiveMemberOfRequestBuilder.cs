using Microsoft.Graph.Groups.Item.TransitiveMemberOf.Application;
using Microsoft.Graph.Groups.Item.TransitiveMemberOf.Count;
using Microsoft.Graph.Groups.Item.TransitiveMemberOf.Device;
using Microsoft.Graph.Groups.Item.TransitiveMemberOf.Group;
using Microsoft.Graph.Groups.Item.TransitiveMemberOf.Item;
using Microsoft.Graph.Groups.Item.TransitiveMemberOf.OrgContact;
using Microsoft.Graph.Groups.Item.TransitiveMemberOf.ServicePrincipal;
using Microsoft.Graph.Groups.Item.TransitiveMemberOf.User;
...
namespace Microsoft.Graph.Groups.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.transitiveMemberOf.item collection</summary>
