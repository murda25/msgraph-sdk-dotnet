...
namespace Microsoft.Graph.Groups.Item.TransitiveMemberOf.MicrosoftGraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
