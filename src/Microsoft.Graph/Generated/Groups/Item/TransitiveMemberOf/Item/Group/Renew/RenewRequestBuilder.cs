...
namespace Microsoft.Graph.Groups.Item.TransitiveMemberOf.Item.Group.Renew {
    ...
    public class RenewRequestBuilder {
        ...
        public RenewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.renew";
