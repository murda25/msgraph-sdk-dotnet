...
namespace Microsoft.Graph.Groups.Item.TransitiveMemberOf.Item.Group.UnsubscribeByMail {
    ...
    public class UnsubscribeByMailRequestBuilder {
        ...
        public UnsubscribeByMailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.group/microsoft.graph.unsubscribeByMail";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public UnsubscribeByMailRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task PostAsync(Action<UnsubscribeByMailRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
