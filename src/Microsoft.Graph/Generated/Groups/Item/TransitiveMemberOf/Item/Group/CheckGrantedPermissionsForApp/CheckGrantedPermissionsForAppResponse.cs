...
using System.IO;
using System.Linq;
namespace Microsoft.Graph.Groups.Item.TransitiveMemberOf.Item.Group.CheckGrantedPermissionsForApp {
    /// <summary>Provides operations to call the checkGrantedPermissionsForApp method.</summary>
    public class CheckGrantedPermissionsForAppResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ResourceSpecificPermissionGrant> Value {
            get { return BackingStore?.Get<List<ResourceSpecificPermissionGrant>>(nameof(Value)); }
        ...
        /// </summary>
        public static CheckGrantedPermissionsForAppResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
