...
namespace Microsoft.Graph.Groups.Item.Planner.Plans {
    ...
    public class PlansRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.groups.item.planner.plans.item collection</summary>
        ...
        public PlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/planner/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Retrieve a list of **plannerPlan** objects owned by a group object.</summary>
