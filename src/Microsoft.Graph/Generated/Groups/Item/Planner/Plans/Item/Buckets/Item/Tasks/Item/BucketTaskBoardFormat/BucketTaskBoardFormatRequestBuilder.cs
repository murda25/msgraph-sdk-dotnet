...
namespace Microsoft.Graph.Groups.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.BucketTaskBoardFormat {
    ...
    public class BucketTaskBoardFormatRequestBuilder {
        ...
        public BucketTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24select,%24expand}";
