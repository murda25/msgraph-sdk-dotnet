...
using MicrosoftGraphSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat;
using MicrosoftGraphSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat;
using MicrosoftGraphSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.Details;
using MicrosoftGraphSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat;
...
namespace MicrosoftGraphSdk.Groups.Item.Planner.Plans.Item.Tasks.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\planner\plans\{plannerPlan-id}\tasks\{plannerTask-id}</summary>
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/planner/plans/{plannerPlan_id}/tasks/{plannerTask_id}{?select,expand}";
