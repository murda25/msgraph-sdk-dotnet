...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages.Archive {
    ...
    public class ArchiveRequestBuilder {
        ...
        /// </summary>
        public async Task<ArchiveResponse> PostAsync(ArchiveRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
