...
namespace MicrosoftGraphSdk.IdentityProviders {
    ...
    public class IdentityProvidersRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(IdentityProvider body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
