...
namespace Microsoft.Graph.IdentityGovernance.LifecycleWorkflows.TaskDefinitions {
    ...
    public class TaskDefinitionsRequestBuilder : BaseRequestBuilder {
        ...
        public TaskDefinitionItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("taskDefinition%2Did", position);
        ...
        public TaskDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/taskDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TaskDefinitionsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<TaskDefinitionCollectionResponse?> GetAsync(Action<TaskDefinitionsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<TaskDefinitionCollectionResponse> GetAsync(Action<TaskDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
