...
#nullable enable
        public async Task<Microsoft.Graph.Models.IdentityGovernance.TaskDefinition?> GetAsync(Action<TaskDefinitionItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.IdentityGovernance.TaskDefinition> GetAsync(Action<TaskDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
