...
namespace MicrosoftGraphSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests {
    ...
    public class UserConsentRequestsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UserConsentRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
