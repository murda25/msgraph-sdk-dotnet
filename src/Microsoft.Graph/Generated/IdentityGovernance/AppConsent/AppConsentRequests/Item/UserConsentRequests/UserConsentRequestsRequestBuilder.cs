...
namespace Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests {
    ...
    public class UserConsentRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<UserConsentRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<UserConsentRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UserConsentRequest> PostAsync(UserConsentRequest body, CancellationToken cancellationToken = default, Action<UserConsentRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
