...
namespace Microsoft.Graph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item.Approval.Stages {
    ...
    public class StagesRequestBuilder {
        ...
        /// </summary>
        public async Task<ApprovalStageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<StagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApprovalStage> PostAsync(ApprovalStage body, CancellationToken cancellationToken = default, Action<StagesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
