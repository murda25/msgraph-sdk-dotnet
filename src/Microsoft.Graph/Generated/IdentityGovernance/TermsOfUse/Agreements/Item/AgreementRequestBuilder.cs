...
namespace MicrosoftGraphSdk.IdentityGovernance.TermsOfUse.Agreements.Item {
    ...
    public class AgreementRequestBuilder {
        ...
        /// </summary>
        public AgreementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AgreementRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
