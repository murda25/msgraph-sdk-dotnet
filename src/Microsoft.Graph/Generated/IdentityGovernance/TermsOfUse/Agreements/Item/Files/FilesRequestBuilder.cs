...
namespace Microsoft.Graph.IdentityGovernance.TermsOfUse.Agreements.Item.Files {
    ...
    public class FilesRequestBuilder {
        ...
        /// </summary>
        public async Task<AgreementFileLocalizationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<FilesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AgreementFileLocalization> PostAsync(AgreementFileLocalization body, CancellationToken cancellationToken = default, Action<FilesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
