...
namespace Microsoft.Graph.IdentityGovernance.AccessReviews.Definitions.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessReviewInstanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<InstancesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessReviewInstance> PostAsync(AccessReviewInstance body, CancellationToken cancellationToken = default, Action<InstancesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
