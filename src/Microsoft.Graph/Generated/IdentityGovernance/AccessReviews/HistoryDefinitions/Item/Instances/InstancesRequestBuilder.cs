...
namespace Microsoft.Graph.IdentityGovernance.AccessReviews.HistoryDefinitions.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessReviewHistoryInstanceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<InstancesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessReviewHistoryInstance> PostAsync(AccessReviewHistoryInstance body, CancellationToken cancellationToken = default, Action<InstancesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
