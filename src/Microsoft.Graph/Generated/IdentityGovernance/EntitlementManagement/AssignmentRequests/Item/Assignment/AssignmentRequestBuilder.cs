...
namespace MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Assignment {
    ...
    public class AssignmentRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageAssignment> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
