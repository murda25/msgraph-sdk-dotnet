...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Assignment {
    ...
    public class AssignmentRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageAssignment> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
