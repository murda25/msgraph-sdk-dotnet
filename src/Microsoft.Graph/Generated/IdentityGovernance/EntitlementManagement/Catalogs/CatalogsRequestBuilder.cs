...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.Catalogs {
    ...
    public class CatalogsRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageCatalogCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CatalogsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessPackageCatalog> PostAsync(AccessPackageCatalog body, CancellationToken cancellationToken = default, Action<CatalogsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
