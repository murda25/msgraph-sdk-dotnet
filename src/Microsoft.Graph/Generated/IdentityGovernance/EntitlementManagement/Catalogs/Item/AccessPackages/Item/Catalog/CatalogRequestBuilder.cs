...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item.Catalog {
    ...
    public class CatalogRequestBuilder : BaseRequestBuilder {
        ...
        public CatalogRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/{accessPackage%2Did}/catalog{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CatalogRequestBuilder and sets the default values.
        /// </summary>
