...
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item.AssignmentPolicies.Count;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item.AssignmentPolicies.Item;
...
namespace MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item.AssignmentPolicies {
    ...
    public class AssignmentPoliciesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identityGovernance.entitlementManagement.catalogs.item.accessPackages.item.assignmentPolicies.item collection</summary>
