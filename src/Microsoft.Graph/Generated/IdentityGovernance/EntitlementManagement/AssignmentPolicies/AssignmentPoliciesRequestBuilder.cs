...
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AssignmentPolicies.Count;
using MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AssignmentPolicies.Item;
...
namespace MicrosoftGraphSdk.IdentityGovernance.EntitlementManagement.AssignmentPolicies {
    ...
    public class AssignmentPoliciesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.identityGovernance.entitlementManagement.assignmentPolicies.item collection</summary>
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AccessPackageAssignmentPolicy body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessPackageAssignmentPolicy> PostAsync(AccessPackageAssignmentPolicy body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
