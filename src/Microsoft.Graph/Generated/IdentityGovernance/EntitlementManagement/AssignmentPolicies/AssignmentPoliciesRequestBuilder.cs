...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.AssignmentPolicies {
    ...
    public class AssignmentPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageAssignmentPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessPackageAssignmentPolicy> PostAsync(AccessPackageAssignmentPolicy body, CancellationToken cancellationToken = default, Action<AssignmentPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
