...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals {
    ...
    public class AccessPackageAssignmentApprovalsRequestBuilder {
        ...
        /// </summary>
        public async Task<ApprovalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Approval> PostAsync(Microsoft.Graph.Models.Approval body, CancellationToken cancellationToken = default, Action<AccessPackageAssignmentApprovalsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
