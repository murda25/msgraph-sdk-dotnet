...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnResponse : IAdditionalDataHolder, IParsable {
        ...
        public List<Microsoft.Graph.Models.Approval> Value { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as FilterByCurrentUserWithOnResponse).Value = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Approval>(Microsoft.Graph.Models.Approval.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
