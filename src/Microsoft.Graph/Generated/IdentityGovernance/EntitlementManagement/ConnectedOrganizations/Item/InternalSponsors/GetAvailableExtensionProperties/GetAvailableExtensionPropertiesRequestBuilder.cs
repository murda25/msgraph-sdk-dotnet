...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.ConnectedOrganizations.Item.InternalSponsors.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetAvailableExtensionPropertiesPostRequestBody body, Action<GetAvailableExtensionPropertiesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetAvailableExtensionPropertiesResponse> PostAsync(GetAvailableExtensionPropertiesPostRequestBody body, CancellationToken cancellationToken = default, Action<GetAvailableExtensionPropertiesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<GetAvailableExtensionPropertiesResponse>(requestInfo, GetAvailableExtensionPropertiesResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
