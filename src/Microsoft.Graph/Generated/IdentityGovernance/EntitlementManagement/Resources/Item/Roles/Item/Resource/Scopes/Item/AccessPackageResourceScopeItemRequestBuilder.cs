...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.Resources.Item.Roles.Item.Resource.Scopes.Item {
    ...
    public class AccessPackageResourceScopeItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccessPackageResourceScopeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}/roles/{accessPackageResourceRole%2Did}/resource/scopes/{accessPackageResourceScope%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
