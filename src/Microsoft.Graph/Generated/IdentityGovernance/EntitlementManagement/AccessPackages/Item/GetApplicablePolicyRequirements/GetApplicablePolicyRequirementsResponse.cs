    ...
    public class GetApplicablePolicyRequirementsResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetApplicablePolicyRequirementsResponse).Value = n.GetCollectionOfObjectValues<AccessPackageAssignmentRequestRequirements>(AccessPackageAssignmentRequestRequirements.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
