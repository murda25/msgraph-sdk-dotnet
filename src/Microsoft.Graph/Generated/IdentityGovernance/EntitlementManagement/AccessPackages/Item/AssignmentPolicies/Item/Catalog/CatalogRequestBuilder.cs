...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.AccessPackages.Item.AssignmentPolicies.Item.Catalog {
    ...
    public class CatalogRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageCatalog> GetAsync(Action<CatalogRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
