...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.Assignments.Item.AssignmentPolicy {
    ...
    public class AssignmentPolicyRequestBuilder {
        ...
        /// </summary>
        public async Task<AccessPackageAssignmentPolicy> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
