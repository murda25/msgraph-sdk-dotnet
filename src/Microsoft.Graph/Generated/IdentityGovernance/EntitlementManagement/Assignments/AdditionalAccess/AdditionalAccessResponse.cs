...
namespace Microsoft.Graph.IdentityGovernance.EntitlementManagement.Assignments.AdditionalAccess {
    ...
    public class AdditionalAccessResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        /// </summary>
        public static AdditionalAccessResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
