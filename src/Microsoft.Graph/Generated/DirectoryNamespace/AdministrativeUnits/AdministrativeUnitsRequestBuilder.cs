...
namespace Microsoft.Graph.DirectoryNamespace.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.AdministrativeUnit> PostAsync(Microsoft.Graph.Models.AdministrativeUnit body, CancellationToken cancellationToken = default, Action<AdministrativeUnitsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
