...
namespace Microsoft.Graph.DirectoryNamespace.AdministrativeUnits.Item.ScopedRoleMembers {
    ...
    public class ScopedRoleMembersRequestBuilder {
        ...
        /// </summary>
        public async Task<ScopedRoleMembershipCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ScopedRoleMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ScopedRoleMembership> PostAsync(ScopedRoleMembership body, CancellationToken cancellationToken = default, Action<ScopedRoleMembersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
