...
namespace Microsoft.Graph.DirectoryNamespace.AdministrativeUnits.Item.Members.ServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
