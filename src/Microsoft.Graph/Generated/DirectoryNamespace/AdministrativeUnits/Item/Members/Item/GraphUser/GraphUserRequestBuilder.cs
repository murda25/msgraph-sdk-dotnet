...
namespace Microsoft.Graph.DirectoryNamespace.AdministrativeUnits.Item.Members.Item.GraphUser {
    ...
    public class GraphUserRequestBuilder {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.user{?%24select,%24expand}";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.User?> GetAsync(Action<GraphUserRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.User> GetAsync(Action<GraphUserRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
