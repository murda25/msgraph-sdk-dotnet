...
namespace Microsoft.Graph.DirectoryNamespace.FederationConfigurations {
    ...
    public class FederationConfigurationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.directory.federationConfigurations.item collection</summary>
        ...
        /// </summary>
        public async Task<IdentityProviderBaseCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<FederationConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IdentityProviderBase> PostAsync(IdentityProviderBase body, CancellationToken cancellationToken = default, Action<FederationConfigurationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
