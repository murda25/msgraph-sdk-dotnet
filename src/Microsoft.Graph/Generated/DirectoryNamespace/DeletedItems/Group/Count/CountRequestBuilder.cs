...
namespace Microsoft.Graph.DirectoryNamespace.DeletedItems.Group.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/deletedItems/microsoft.graph.group/$count{?%24search,%24filter}";
