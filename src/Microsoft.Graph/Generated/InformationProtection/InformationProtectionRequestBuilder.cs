...
namespace Microsoft.Graph.InformationProtection {
    ...
    public class InformationProtectionRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.InformationProtection> GetAsync(CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.InformationProtection body, CancellationToken cancellationToken = default, Action<InformationProtectionRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
