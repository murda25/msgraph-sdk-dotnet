...
namespace Microsoft.Graph.InformationProtection.Bitlocker.RecoveryKeys.Item {
    ...
    public class BitlockerRecoveryKeyItemRequestBuilder {
        ...
        /// </summary>
        public async Task<BitlockerRecoveryKey> GetAsync(CancellationToken cancellationToken = default, Action<BitlockerRecoveryKeyItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
