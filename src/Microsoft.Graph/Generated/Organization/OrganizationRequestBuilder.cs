...
using Microsoft.Graph.Organization.MicrosoftGraphGetAvailableExtensionProperties;
using Microsoft.Graph.Organization.MicrosoftGraphGetByIds;
using Microsoft.Graph.Organization.MicrosoftGraphValidateProperties;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Organization?> PostAsync(Microsoft.Graph.Models.Organization body, Action<OrganizationRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Organization> PostAsync(Microsoft.Graph.Models.Organization body, Action<OrganizationRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
