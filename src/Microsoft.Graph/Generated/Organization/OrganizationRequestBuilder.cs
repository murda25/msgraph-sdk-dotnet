...
namespace Microsoft.Graph.Organization {
    ...
    public class OrganizationRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Organization> PostAsync(Microsoft.Graph.Models.Organization body, CancellationToken cancellationToken = default, Action<OrganizationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
