...
namespace Microsoft.Graph.Print {
    ...
    public class PrintRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Print> GetAsync(Action<PrintRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
