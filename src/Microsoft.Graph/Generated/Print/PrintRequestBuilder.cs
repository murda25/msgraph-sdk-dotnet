...
namespace Microsoft.Graph.Print {
    ...
    public class PrintRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Print> GetAsync(CancellationToken cancellationToken = default, Action<PrintRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Print body, CancellationToken cancellationToken = default, Action<PrintRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
