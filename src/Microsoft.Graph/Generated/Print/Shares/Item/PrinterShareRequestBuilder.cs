...
using MicrosoftGraphSdk.Print.Shares.Item.AllowedGroups;
using MicrosoftGraphSdk.Print.Shares.Item.AllowedUsers;
using MicrosoftGraphSdk.Print.Shares.Item.Printer;
using System;
...
namespace MicrosoftGraphSdk.Print.Shares.Item {
    ...
    public class PrinterShareRequestBuilder {
        ...
        /// </summary>
        public PrinterShareRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public PrinterShareRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
