...
namespace Microsoft.Graph.Print.Shares.Item.AllowedUsers {
    ...
    public class AllowedUsersRequestBuilder {
        ...
        /// </summary>
        public async Task<UserCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AllowedUsersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
