...
namespace Microsoft.Graph.Print.TaskDefinitions {
    ...
    public class TaskDefinitionsRequestBuilder {
        ...
        /// </summary>
        public async Task<PrintTaskDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintTaskDefinition> PostAsync(PrintTaskDefinition body, CancellationToken cancellationToken = default, Action<TaskDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
