...
namespace Microsoft.Graph.Print.TaskDefinitions.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// </summary>
        public async Task<PrintTaskCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TasksRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintTask> PostAsync(PrintTask body, CancellationToken cancellationToken = default, Action<TasksRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
