...
namespace Microsoft.Graph.Print.TaskDefinitions.Item.Tasks.Item.Trigger {
    ...
    public class TriggerRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<TriggerRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PrintTaskTrigger> GetAsync(CancellationToken cancellationToken = default, Action<TriggerRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
