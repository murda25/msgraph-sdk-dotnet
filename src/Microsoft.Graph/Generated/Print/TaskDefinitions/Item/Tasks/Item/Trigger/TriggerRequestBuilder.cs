...
namespace Microsoft.Graph.Print.TaskDefinitions.Item.Tasks.Item.Trigger {
    ...
    public class TriggerRequestBuilder {
        ...
        /// </summary>
        public async Task<PrintTaskTrigger> GetAsync(Action<TriggerRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
