...
using MicrosoftGraphSdk.Print.TaskDefinitions.Item.Tasks;
using System;
...
namespace MicrosoftGraphSdk.Print.TaskDefinitions.Item {
    ...
    public class PrintTaskDefinitionRequestBuilder {
        ...
        /// </summary>
        public PrintTaskDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/print/taskDefinitions/{printTaskDefinition_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public PrintTaskDefinitionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
