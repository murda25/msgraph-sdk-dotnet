...
namespace Microsoft.Graph.Print.Printers.Item.MicrosoftGraphRestoreFactoryDefaults {
    /// <summary>
    ...
    public class MicrosoftGraphRestoreFactoryDefaultsRequestBuilder {
        ...
        public MicrosoftGraphRestoreFactoryDefaultsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphRestoreFactoryDefaultsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphRestoreFactoryDefaultsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphRestoreFactoryDefaultsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
