...
using MicrosoftGraphSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers.Item;
...
namespace MicrosoftGraphSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers {
    ...
    public class ScopedRoleMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.directory.administrativeUnits.item.scopedRoleMembers.item collection</summary>
