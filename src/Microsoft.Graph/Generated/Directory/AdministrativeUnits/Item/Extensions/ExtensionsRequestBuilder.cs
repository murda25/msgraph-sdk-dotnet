using Microsoft.Graph.Directory.AdministrativeUnits.Item.Extensions.Count;
using Microsoft.Graph.Directory.AdministrativeUnits.Item.Extensions.Item;
...
namespace Microsoft.Graph.Directory.AdministrativeUnits.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.directory.administrativeUnits.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
