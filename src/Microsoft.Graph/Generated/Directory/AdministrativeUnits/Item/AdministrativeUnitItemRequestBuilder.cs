using Microsoft.Graph.Directory.AdministrativeUnits.Item.Extensions;
using Microsoft.Graph.Directory.AdministrativeUnits.Item.Members;
using Microsoft.Graph.Directory.AdministrativeUnits.Item.ScopedRoleMembers;
...
namespace Microsoft.Graph.Directory.AdministrativeUnits.Item {
    ...
    public class AdministrativeUnitItemRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Microsoft.Graph.Models.AdministrativeUnit body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.AdministrativeUnit body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
