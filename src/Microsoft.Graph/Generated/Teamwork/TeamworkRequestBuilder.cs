...
namespace Microsoft.Graph.Teamwork {
    ...
    public class TeamworkRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Teamwork> GetAsync(CancellationToken cancellationToken = default, Action<TeamworkRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Teamwork body, CancellationToken cancellationToken = default, Action<TeamworkRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
