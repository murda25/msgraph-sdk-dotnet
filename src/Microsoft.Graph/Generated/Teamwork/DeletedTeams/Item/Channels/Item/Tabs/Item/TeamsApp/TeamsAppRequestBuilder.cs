...
namespace Microsoft.Graph.Teamwork.DeletedTeams.Item.Channels.Item.Tabs.Item.TeamsApp {
    ...
    public class TeamsAppRequestBuilder {
        ...
        public TeamsAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/tabs/{teamsTab%2Did}/teamsApp{?%24select,%24expand}";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.TeamsApp?> GetAsync(Action<TeamsAppRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.TeamsApp> GetAsync(Action<TeamsAppRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
