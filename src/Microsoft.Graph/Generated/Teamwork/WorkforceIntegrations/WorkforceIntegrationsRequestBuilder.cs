...
namespace MicrosoftGraphSdk.Teamwork.WorkforceIntegrations {
    /// <summary>Builds and executes requests for operations under \teamwork\workforceIntegrations</summary>
    public class WorkforceIntegrationsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WorkforceIntegration body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
