...
using Microsoft.Graph.Workbooks.Count;
using Microsoft.Graph.Workbooks.Item;
...
namespace Microsoft.Graph.Workbooks {
    ...
    public class WorkbooksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.workbooks.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Models.DriveItem body, Action<WorkbooksRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DriveItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<WorkbooksRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(Microsoft.Graph.Models.DriveItem body, CancellationToken cancellationToken = default, Action<WorkbooksRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
