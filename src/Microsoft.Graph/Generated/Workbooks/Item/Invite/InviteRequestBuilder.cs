...
namespace Microsoft.Graph.Workbooks.Item.Invite {
    ...
    public class InviteRequestBuilder {
        ...
        public InviteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/microsoft.graph.invite";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(InviteRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// </summary>
        public async Task<InviteResponse> PostAsync(InviteRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
