...
using Microsoft.Graph.Workbooks.Item.Subscriptions.Count;
using Microsoft.Graph.Workbooks.Item.Subscriptions.Item;
...
namespace Microsoft.Graph.Workbooks.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.workbooks.item.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
