...
namespace Microsoft.Graph.Workbooks.Item.Subscriptions.Item.Reauthorize {
    /// <summary>
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
