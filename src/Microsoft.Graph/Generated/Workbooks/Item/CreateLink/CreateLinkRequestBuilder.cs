...
namespace Microsoft.Graph.Workbooks.Item.CreateLink {
    ...
    public class CreateLinkRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Permission> PostAsync(CreateLinkRequestBody body, Action<CreateLinkRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
