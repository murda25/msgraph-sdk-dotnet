...
namespace Microsoft.Graph.Workbooks.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        public GetActivitiesByIntervalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/microsoft.graph.getActivitiesByInterval(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
