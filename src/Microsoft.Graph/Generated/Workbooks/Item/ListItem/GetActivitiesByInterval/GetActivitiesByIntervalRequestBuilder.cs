...
namespace MicrosoftGraphSdk.Workbooks.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraphSdk.Workbooks.Item.ListItem.GetActivitiesByInterval.GetActivitiesByInterval>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraphSdk.Workbooks.Item.ListItem.GetActivitiesByInterval.GetActivitiesByInterval>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
