...
using Microsoft.Graph.Workbooks.Item.Children.Count;
using Microsoft.Graph.Workbooks.Item.Children.Item;
...
namespace Microsoft.Graph.Workbooks.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.workbooks.item.children.item collection</summary>
        public Microsoft.Graph.Workbooks.Item.Children.Item.DriveItemItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("driveItem%2Did1", position);
            return new Microsoft.Graph.Workbooks.Item.Children.Item.DriveItemItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
