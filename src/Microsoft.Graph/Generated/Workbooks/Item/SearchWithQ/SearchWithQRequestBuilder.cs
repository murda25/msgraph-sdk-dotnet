...
namespace MicrosoftGraphSdk.Workbooks.Item.SearchWithQ {
    ...
    public class SearchWithQRequestBuilder {
        ...
        public SearchWithQRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string q = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/microsoft.graph.search(q='{q}')";
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraphSdk.Workbooks.Item.SearchWithQ.SearchWithQ>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraphSdk.Workbooks.Item.SearchWithQ.SearchWithQ>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
