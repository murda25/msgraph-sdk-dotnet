...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.ImageWithWidthWithHeightWithFittingMode {
    ...
    public class ImageWithWidthWithHeightWithFittingModeRequestBuilder {
        ...
        /// </summary>
        public ImageWithWidthWithHeightWithFittingModeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? height = default, int? width = default, string fittingMode = default) {
