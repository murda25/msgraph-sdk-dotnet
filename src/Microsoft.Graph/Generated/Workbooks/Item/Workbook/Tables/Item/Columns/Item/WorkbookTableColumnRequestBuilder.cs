...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.DataBodyRange;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.Filter;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.HeaderRowRange;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.Range;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.TotalRowRange;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\columns\{workbookTableColumn-id}</summary>
    public class WorkbookTableColumnRequestBuilder {
        ...
        public WorkbookTableColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/columns/{workbookTableColumn_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public WorkbookTableColumnRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
