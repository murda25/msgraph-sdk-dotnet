...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item.Worksheet.RangeWithAddress {
        ...
        public class RangeWithAddressResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as RangeWithAddressResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
