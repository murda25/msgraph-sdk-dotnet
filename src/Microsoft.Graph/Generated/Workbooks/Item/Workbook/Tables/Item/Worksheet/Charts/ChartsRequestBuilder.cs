...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Add;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Count;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemAtWithIndex;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.ItemWithName;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts {
    ...
    public class ChartsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.workbooks.item.workbook.tables.item.worksheet.charts.item collection</summary>
        ...
        public ChartsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/charts{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        public async Task<ChartsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ChartsResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
