...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Add;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Count;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Tables.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.workbooks.item.workbook.tables.item.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/columns{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
