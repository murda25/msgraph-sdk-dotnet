...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Add;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Count;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.workbooks.item.workbook.worksheets.item.tables.item collection</summary>
