...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Add;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Count;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Item;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.ItemAtWithIndex;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.workbooks.item.workbook.worksheets.item.tables.item.rows.item collection</summary>
