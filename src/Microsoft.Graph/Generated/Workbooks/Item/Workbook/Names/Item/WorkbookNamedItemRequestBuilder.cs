...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Range;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item {
    ...
    public class WorkbookNamedItemRequestBuilder {
        ...
        public WorkbookNamedItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}{?select,expand}";
