...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.ImageWithWidthWithHeight {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\charts\{workbookChart-id}\microsoft.graph.image(width={width},height={height})</summary>
    public class ImageWithWidthWithHeightRequestBuilder {
        ...
        public ImageWithWidthWithHeightRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? height = default, int? width = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/charts/{workbookChart_id}/microsoft.graph.image(width={width},height={height})";
