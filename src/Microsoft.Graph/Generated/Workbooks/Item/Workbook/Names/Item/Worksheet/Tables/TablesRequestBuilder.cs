...
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Add;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Count;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item;
using MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.ItemAtWithIndex;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.workbooks.item.workbook.names.item.worksheet.tables.item collection</summary>
        ...
        public TablesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/tables{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
