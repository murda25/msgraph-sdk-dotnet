...
namespace MicrosoftGraphSdk.Workbooks.Item.Permissions.Item.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraphSdk.Workbooks.Item.Permissions.Item.Grant.Grant>> PostAsync(GrantRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraphSdk.Workbooks.Item.Permissions.Item.Grant.Grant>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
