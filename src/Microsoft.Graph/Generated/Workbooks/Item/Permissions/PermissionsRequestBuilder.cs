...
using MicrosoftGraphSdk.Workbooks.Item.Permissions.Item;
using System;
...
namespace MicrosoftGraphSdk.Workbooks.Item.Permissions {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\permissions</summary>
    public class PermissionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.workbooks.item.permissions.item collection</summary>
