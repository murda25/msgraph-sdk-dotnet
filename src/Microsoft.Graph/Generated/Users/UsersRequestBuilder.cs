...
#nullable restore
        ...
        /// <summary>
        /// Create a new user.The request body contains the user to create. At a minimum, you must specify the required properties for the user. You can optionally specify any other writable properties. This API is supported in the following national cloud deployments.
