...
namespace Microsoft.Graph.Users.Item.DirectReports.Item.User.RemoveAllDevicesFromManagement {
    ...
    public class RemoveAllDevicesFromManagementRequestBuilder {
        ...
        public RemoveAllDevicesFromManagementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/directReports/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.removeAllDevicesFromManagement";
