...
namespace Microsoft.Graph.Users.Item.Drives.Item.Root.ListItem.DocumentSetVersions.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/documentSetVersions/{documentSetVersion%2Did}/microsoft.graph.restore";
