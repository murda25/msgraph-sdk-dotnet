...
namespace Microsoft.Graph.Users.Item.Drives.Item.Root.ListItem.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/fields{?%24select,%24expand}";
