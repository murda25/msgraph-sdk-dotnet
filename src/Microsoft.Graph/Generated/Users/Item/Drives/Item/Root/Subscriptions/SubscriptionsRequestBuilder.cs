...
using Microsoft.Graph.Users.Item.Drives.Item.Root.Subscriptions.Count;
using Microsoft.Graph.Users.Item.Drives.Item.Root.Subscriptions.Item;
...
namespace Microsoft.Graph.Users.Item.Drives.Item.Root.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.drives.item.root.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/subscriptions{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
