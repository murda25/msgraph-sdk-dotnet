...
using Microsoft.Graph.Users.Item.Drives.Item.Root.Subscriptions.Item.Reauthorize;
...
namespace Microsoft.Graph.Users.Item.Drives.Item.Root.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/subscriptions/{subscription%2Did}{?%24select,%24expand}";
