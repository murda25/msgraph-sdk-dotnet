...
namespace Microsoft.Graph.Users.Item.Drives.Item.Root.DeltaWithToken {
    ...
    public class DeltaWithTokenRequestBuilder {
        ...
        public DeltaWithTokenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string token = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/microsoft.graph.delta(token='{token}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
