...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.Items.Item.Analytics {
    /// <summary>
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/analytics{?%24select,%24expand}";
