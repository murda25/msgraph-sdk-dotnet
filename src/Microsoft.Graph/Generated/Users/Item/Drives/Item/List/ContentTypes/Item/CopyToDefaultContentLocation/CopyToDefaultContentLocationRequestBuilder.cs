...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.ContentTypes.Item.CopyToDefaultContentLocation {
    ...
    public class CopyToDefaultContentLocationRequestBuilder {
        ...
        public CopyToDefaultContentLocationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/contentTypes/{contentType_id}/microsoft.graph.copyToDefaultContentLocation";
