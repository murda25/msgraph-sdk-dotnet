...
using Microsoft.Graph.Users.Item.Drives.Item.List.Items.Item.DocumentSetVersions.Count;
using Microsoft.Graph.Users.Item.Drives.Item.List.Items.Item.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.Items.Item.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.drives.item.list.items.item.documentSetVersions.item collection</summary>
