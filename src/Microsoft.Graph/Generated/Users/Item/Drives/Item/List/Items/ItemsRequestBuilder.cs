...
using MicrosoftGraphSdk.Users.Item.Drives.Item.List.Items.Count;
using MicrosoftGraphSdk.Users.Item.Drives.Item.List.Items.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.drives.item.list.items.item collection</summary>
