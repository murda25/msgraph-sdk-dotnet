...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.Drive {
    ...
    public class DriveRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Drive> GetAsync(CancellationToken cancellationToken = default, Action<DriveRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
