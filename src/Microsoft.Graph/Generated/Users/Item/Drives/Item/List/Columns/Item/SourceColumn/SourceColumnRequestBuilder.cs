...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}";
