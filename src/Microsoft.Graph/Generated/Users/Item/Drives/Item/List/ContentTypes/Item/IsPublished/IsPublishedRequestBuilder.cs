...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.ContentTypes.Item.IsPublished {
    /// <summary>
    ...
    public class IsPublishedRequestBuilder {
        ...
        public IsPublishedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/microsoft.graph.isPublished()";
