...
using Microsoft.Graph.Users.Item.Drives.Item.List.ContentTypes.Item.Columns.Item.SourceColumn;
...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.ContentTypes.Item.Columns.Item {
    ...
    public class ColumnDefinitionItemRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}";
