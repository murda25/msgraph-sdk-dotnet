...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.List.Items.Item.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        public GetActivitiesByIntervalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/items/{listItem_id}/microsoft.graph.getActivitiesByInterval()";
