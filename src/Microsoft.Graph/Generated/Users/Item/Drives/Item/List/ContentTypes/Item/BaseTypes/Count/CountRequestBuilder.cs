...
namespace Microsoft.Graph.Users.Item.Drives.Item.List.ContentTypes.Item.BaseTypes.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/baseTypes/$count{?%24search,%24filter}";
