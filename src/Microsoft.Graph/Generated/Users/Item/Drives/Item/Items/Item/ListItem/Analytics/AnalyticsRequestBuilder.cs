...
namespace Microsoft.Graph.Users.Item.Drives.Item.Items.Item.ListItem.Analytics {
    /// <summary>
    ...
    public class AnalyticsRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/analytics{?%24select,%24expand}";
