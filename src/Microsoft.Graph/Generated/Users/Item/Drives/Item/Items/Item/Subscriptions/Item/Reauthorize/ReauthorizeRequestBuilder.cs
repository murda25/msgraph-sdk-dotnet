...
namespace Microsoft.Graph.Users.Item.Drives.Item.Items.Item.Subscriptions.Item.Reauthorize {
    /// <summary>
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
