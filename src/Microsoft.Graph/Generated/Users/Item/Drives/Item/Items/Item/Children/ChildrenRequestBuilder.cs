...
using Microsoft.Graph.Users.Item.Drives.Item.Items.Item.Children.Count;
using Microsoft.Graph.Users.Item.Drives.Item.Items.Item.Children.Item;
...
namespace Microsoft.Graph.Users.Item.Drives.Item.Items.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.drives.item.items.item.children.item collection</summary>
        public Microsoft.Graph.Users.Item.Drives.Item.Items.Item.Children.Item.DriveItemItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("driveItem%2Did1", position);
            return new Microsoft.Graph.Users.Item.Drives.Item.Items.Item.Children.Item.DriveItemItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
