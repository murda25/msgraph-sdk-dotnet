...
using Microsoft.Graph.Users.Item.Drives.Item.Items.Item.ListItem.DriveItem.Content;
...
namespace Microsoft.Graph.Users.Item.Drives.Item.Items.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/driveItem{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> GetAsync(Action<DriveItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
