...
namespace Microsoft.Graph.Users.Item.Drives.Item.Items.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> GetAsync(CancellationToken cancellationToken = default, Action<DriveItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
