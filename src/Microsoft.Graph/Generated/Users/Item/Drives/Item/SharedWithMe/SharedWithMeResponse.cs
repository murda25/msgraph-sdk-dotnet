...
namespace Microsoft.Graph.Users.Item.Drives.Item.SharedWithMe {
    ...
    public class SharedWithMeResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<Microsoft.Graph.Models.DriveItem> Value {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.DriveItem>>(nameof(Value)); }
