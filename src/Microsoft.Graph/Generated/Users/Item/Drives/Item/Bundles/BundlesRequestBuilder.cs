...
using Microsoft.Graph.Users.Item.Drives.Item.Bundles.Count;
using Microsoft.Graph.Users.Item.Drives.Item.Bundles.Item;
...
namespace Microsoft.Graph.Users.Item.Drives.Item.Bundles {
    ...
    public class BundlesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.drives.item.bundles.item collection</summary>
        ...
        public BundlesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/bundles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
