...
using MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Permissions.Item.Grant;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Drives.Item.Following.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/following/{driveItem_id}/permissions/{permission_id}{?select,expand}";
