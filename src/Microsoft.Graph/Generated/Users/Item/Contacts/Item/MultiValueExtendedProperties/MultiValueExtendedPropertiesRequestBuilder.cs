...
using MicrosoftGraphSdk.Users.Item.Contacts.Item.MultiValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Contacts.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.contacts.item.multiValueExtendedProperties.item collection</summary>
