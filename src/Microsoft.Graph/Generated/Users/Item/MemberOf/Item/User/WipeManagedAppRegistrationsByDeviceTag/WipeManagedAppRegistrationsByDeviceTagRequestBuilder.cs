...
namespace Microsoft.Graph.Users.Item.MemberOf.Item.User.WipeManagedAppRegistrationsByDeviceTag {
    ...
    public class WipeManagedAppRegistrationsByDeviceTagRequestBuilder {
        ...
        public WipeManagedAppRegistrationsByDeviceTagRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.wipeManagedAppRegistrationsByDeviceTag";
