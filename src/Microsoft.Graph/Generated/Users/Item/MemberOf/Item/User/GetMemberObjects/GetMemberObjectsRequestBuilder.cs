...
namespace Microsoft.Graph.Users.Item.MemberOf.Item.User.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getMemberObjects";
