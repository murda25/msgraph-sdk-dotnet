...
using Microsoft.Graph.Users.Item.MemberOf.Group.Count;
...
namespace Microsoft.Graph.Users.Item.MemberOf.Group {
    ...
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/memberOf/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
