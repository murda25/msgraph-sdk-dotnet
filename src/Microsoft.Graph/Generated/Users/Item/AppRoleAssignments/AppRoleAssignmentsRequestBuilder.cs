...
using MicrosoftGraphSdk.Users.Item.AppRoleAssignments.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.AppRoleAssignments {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\appRoleAssignments</summary>
    public class AppRoleAssignmentsRequestBuilder {
        ...
        public AppRoleAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/appRoleAssignments{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
