...
namespace Microsoft.Graph.Users.Item.Manager {
    ...
    public class ManagerRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObject> GetAsync(Action<ManagerRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
