...
namespace Microsoft.Graph.Users.Item.OwnedDevices.MicrosoftGraphAppRoleAssignment.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}";
