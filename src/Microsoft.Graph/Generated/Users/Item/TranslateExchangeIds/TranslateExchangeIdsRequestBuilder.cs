...
namespace Microsoft.Graph.Users.Item.TranslateExchangeIds {
    ...
    public class TranslateExchangeIdsRequestBuilder {
        ...
        /// </summary>
        public async Task<TranslateExchangeIdsResponse> PostAsync(TranslateExchangeIdsPostRequestBody body, CancellationToken cancellationToken = default, Action<TranslateExchangeIdsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
