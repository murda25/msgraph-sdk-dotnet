...
namespace Microsoft.Graph.Users.Item.Calendars.Item.Events.Item.Instances.Item.Attachments.MicrosoftGraphCreateUploadSession {
    /// <summary>
    ...
    public class MicrosoftGraphCreateUploadSessionRequestBuilder {
        ...
        public MicrosoftGraphCreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/attachments/microsoft.graph.createUploadSession";
