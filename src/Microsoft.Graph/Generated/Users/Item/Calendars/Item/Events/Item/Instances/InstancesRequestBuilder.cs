...
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Delta;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendars.item.events.item.instances.item collection</summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/events/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
