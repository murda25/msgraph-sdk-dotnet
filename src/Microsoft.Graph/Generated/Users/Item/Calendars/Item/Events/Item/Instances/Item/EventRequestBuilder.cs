...
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Accept;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Cancel;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Decline;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.DismissReminder;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Forward;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.SnoozeReminder;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\events\{event-id}\instances\{event-id1}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}{?select}";
