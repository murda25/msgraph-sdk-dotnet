...
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Attachments.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.Events.Item.Attachments {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\events\{event-id}\attachments</summary>
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendars.item.events.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/events/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
