...
using MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarView.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarView.Item.Attachments.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarView.Item.Attachments {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\calendarView\{event-id}\attachments</summary>
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendars.item.calendarView.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarView/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
