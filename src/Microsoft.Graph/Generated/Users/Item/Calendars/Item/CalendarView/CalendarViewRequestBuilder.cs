...
using MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarView.Delta;
using MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarView.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarView {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendars.item.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarView{?startDateTime,endDateTime,top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
