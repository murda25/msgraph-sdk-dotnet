...
namespace MicrosoftGraphSdk.Users.Item.Calendars.Item.CalendarPermissions.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendars\{calendar-id}\calendarPermissions\{calendarPermission-id}</summary>
    public class CalendarPermissionRequestBuilder {
        ...
        public CalendarPermissionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendars/{calendar_id}/calendarPermissions/{calendarPermission_id}{?select}";
