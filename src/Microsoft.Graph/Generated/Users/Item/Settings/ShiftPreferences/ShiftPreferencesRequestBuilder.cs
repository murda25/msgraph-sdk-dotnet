...
namespace Microsoft.Graph.Users.Item.Settings.ShiftPreferences {
    ...
    public class ShiftPreferencesRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<ShiftPreferencesRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.ShiftPreferences> GetAsync(Action<ShiftPreferencesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
