...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Archive {
    ...
    public class ArchiveRequestBuilder {
        ...
        public ArchiveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.archive";
        ...
        /// </summary>
        public async Task PostAsync(ArchivePostRequestBody body, CancellationToken cancellationToken = default, Action<ArchiveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
