...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Archive {
    ...
    public class ArchiveRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ArchivePostRequestBody body, Action<ArchiveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
