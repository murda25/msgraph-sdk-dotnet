...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Schedule.Share {
    ...
    public class ShareRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SharePostRequestBody body, Action<ShareRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(SharePostRequestBody body, CancellationToken cancellationToken = default, Action<ShareRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
