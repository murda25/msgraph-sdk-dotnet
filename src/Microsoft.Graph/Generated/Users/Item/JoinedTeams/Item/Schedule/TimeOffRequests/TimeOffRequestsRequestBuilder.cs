...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Schedule.TimeOffRequests {
    ...
    public class TimeOffRequestsRequestBuilder {
        ...
        public TimeOffRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeOffRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get timeOffRequests from users</summary>
