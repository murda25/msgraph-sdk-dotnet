...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.Schedule.Shifts.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/schedule/shifts/$count";
