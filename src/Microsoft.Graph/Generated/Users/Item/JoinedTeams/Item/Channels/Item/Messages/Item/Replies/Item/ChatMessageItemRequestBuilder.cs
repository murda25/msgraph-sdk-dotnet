...
using Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item.Replies.Item.MicrosoftGraphSoftDelete;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item.Replies.Item.MicrosoftGraphUndoSoftDelete;
...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}";
