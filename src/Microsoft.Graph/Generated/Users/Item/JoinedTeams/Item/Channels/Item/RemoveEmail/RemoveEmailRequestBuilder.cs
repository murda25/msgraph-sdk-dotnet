...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.Channels.Item.RemoveEmail {
    ...
    public class RemoveEmailRequestBuilder {
        ...
        public RemoveEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/microsoft.graph.removeEmail";
