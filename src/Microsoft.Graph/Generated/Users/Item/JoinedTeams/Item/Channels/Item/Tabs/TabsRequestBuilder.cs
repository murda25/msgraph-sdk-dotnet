...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.Tabs {
    ...
    public class TabsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.joinedTeams.item.channels.item.tabs.item collection</summary>
        ...
        public TabsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
