...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.Tabs.Item.TeamsApp {
    ...
    public class TeamsAppRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.TeamsApp> GetAsync(Action<TeamsAppRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
