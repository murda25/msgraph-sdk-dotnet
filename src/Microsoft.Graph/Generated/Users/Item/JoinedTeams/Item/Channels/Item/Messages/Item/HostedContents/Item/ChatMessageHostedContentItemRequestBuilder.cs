...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentItemRequestBuilder {
        ...
        public ChatMessageHostedContentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/messages/{chatMessage_id}/hostedContents/{chatMessageHostedContent_id}{?select,expand}";
