...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentItemRequestBuilder {
        ...
        public ChatMessageHostedContentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}{?%24select,%24expand}";
