...
using MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.Channels.Item.FilesFolder.Content;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.Channels.Item.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/channels/{channel_id}/filesFolder{?select,expand}";
