...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> GetAsync(CancellationToken cancellationToken = default, Action<FilesFolderRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
