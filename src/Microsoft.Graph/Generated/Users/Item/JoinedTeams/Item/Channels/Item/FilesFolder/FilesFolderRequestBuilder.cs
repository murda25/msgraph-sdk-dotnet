...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Channels.Item.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/filesFolder{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> GetAsync(Action<FilesFolderRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
