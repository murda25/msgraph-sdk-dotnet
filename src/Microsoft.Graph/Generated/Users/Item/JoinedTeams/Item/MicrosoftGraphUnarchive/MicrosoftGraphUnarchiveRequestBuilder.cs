...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.MicrosoftGraphUnarchive {
    /// <summary>
    ...
    public class MicrosoftGraphUnarchiveRequestBuilder {
        ...
        public MicrosoftGraphUnarchiveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.unarchive";
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphUnarchiveRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphUnarchiveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
