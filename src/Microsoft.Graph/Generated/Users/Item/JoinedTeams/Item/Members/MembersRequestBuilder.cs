...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.joinedTeams.item.members.item collection</summary>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
