...
using MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.FilesFolder.Content;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/filesFolder{?select,expand}";
