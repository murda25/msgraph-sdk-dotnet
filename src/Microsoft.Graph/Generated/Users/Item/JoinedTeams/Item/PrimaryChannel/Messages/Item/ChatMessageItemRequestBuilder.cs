...
using Microsoft.Graph.Users.Item.JoinedTeams.Item.PrimaryChannel.Messages.Item.MicrosoftGraphSoftDelete;
using Microsoft.Graph.Users.Item.JoinedTeams.Item.PrimaryChannel.Messages.Item.MicrosoftGraphUndoSoftDelete;
...
namespace Microsoft.Graph.Users.Item.JoinedTeams.Item.PrimaryChannel.Messages.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}{?%24select,%24expand}";
