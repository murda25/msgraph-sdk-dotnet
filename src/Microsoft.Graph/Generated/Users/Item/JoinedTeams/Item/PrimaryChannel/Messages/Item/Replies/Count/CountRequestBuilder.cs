...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies/$count";
