...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.Members.Item {
    ...
    public class ConversationMemberItemRequestBuilder {
        ...
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/members/{conversationMember_id}{?select,expand}";
