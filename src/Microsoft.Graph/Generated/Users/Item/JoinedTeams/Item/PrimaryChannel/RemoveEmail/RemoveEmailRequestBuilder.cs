...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.RemoveEmail {
    ...
    public class RemoveEmailRequestBuilder {
        ...
        public RemoveEmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/microsoft.graph.removeEmail";
