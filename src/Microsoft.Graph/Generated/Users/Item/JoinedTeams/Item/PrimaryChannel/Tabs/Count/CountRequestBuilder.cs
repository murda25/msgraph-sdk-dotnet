...
namespace MicrosoftGraphSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.Tabs.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}/primaryChannel/tabs/$count";
