...
namespace Microsoft.Graph.Users.Item.JoinedTeams {
    ...
    public class JoinedTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.joinedTeams.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Models.Team body, Action<JoinedTeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Team> PostAsync(Microsoft.Graph.Models.Team body, Action<JoinedTeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
