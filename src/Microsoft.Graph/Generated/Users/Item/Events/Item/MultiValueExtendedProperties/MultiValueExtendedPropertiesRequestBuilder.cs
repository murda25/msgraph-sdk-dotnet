...
using MicrosoftGraphSdk.Users.Item.Events.Item.MultiValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Events.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.events.item.multiValueExtendedProperties.item collection</summary>
