...
namespace Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods {
    ...
    public class WindowsHelloForBusinessMethodsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<WindowsHelloForBusinessAuthenticationMethodCollectionResponse> GetAsync(Action<WindowsHelloForBusinessMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<WindowsHelloForBusinessAuthenticationMethod> PostAsync(WindowsHelloForBusinessAuthenticationMethod body, Action<WindowsHelloForBusinessMethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
