...
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.AssignLicense;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ChangePassword;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.CheckMemberGroups;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.CheckMemberObjects;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ExportPersonalData;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.FindMeetingTimes;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetMailTips;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetMemberGroups;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetMemberObjects;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.Restore;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.SendMail;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
