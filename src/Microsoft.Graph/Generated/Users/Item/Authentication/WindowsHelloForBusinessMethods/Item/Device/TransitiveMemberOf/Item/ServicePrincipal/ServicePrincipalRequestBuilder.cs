...
namespace Microsoft.Graph.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.ServicePrincipal> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
