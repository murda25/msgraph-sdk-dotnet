...
using MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.Extensions;
using MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf;
using MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredOwners;
using MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredUsers;
using MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod_id}/device{?select,expand}";
