...
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.AssignLicense;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.ChangePassword;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.CheckMemberGroups;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.CheckMemberObjects;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.ExportPersonalData;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.FindMeetingTimes;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.GetMailTips;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.GetMemberGroups;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.GetMemberObjects;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.Restore;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.SendMail;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User {
