...
using MicrosoftGraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item {
    ...
    public class MicrosoftAuthenticatorAuthenticationMethodRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public MicrosoftAuthenticatorAuthenticationMethodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
