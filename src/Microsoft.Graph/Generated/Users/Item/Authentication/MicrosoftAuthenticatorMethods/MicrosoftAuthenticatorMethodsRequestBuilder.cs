...
namespace Microsoft.Graph.Users.Item.Authentication.MicrosoftAuthenticatorMethods {
    ...
    public class MicrosoftAuthenticatorMethodsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.authentication.microsoftAuthenticatorMethods.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<MicrosoftAuthenticatorAuthenticationMethod> PostAsync(MicrosoftAuthenticatorAuthenticationMethod body, Action<MicrosoftAuthenticatorMethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
