...
namespace Microsoft.Graph.Users.Item.Authentication.Fido2Methods {
    ...
    public class Fido2MethodsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<Fido2MethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Fido2AuthenticationMethodCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<Fido2MethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Fido2AuthenticationMethod> PostAsync(Fido2AuthenticationMethod body, CancellationToken cancellationToken = default, Action<Fido2MethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
