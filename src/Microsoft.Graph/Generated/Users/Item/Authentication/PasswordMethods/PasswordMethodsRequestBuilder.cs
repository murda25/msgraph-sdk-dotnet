...
namespace Microsoft.Graph.Users.Item.Authentication.PasswordMethods {
    ...
    public class PasswordMethodsRequestBuilder {
        ...
        /// </summary>
        public async Task<PasswordAuthenticationMethodCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PasswordMethodsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PasswordAuthenticationMethod> PostAsync(PasswordAuthenticationMethod body, CancellationToken cancellationToken = default, Action<PasswordMethodsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
