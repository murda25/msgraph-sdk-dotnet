...
namespace Microsoft.Graph.Users.Item.Authentication.PhoneMethods.Item.DisableSmsSignIn {
    ...
    public class DisableSmsSignInRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<DisableSmsSignInRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
