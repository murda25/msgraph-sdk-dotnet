...
namespace Microsoft.Graph.Users.Item.LicenseDetails {
    ...
    public class LicenseDetailsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.LicenseDetails> PostAsync(Microsoft.Graph.Models.LicenseDetails body, CancellationToken cancellationToken = default, Action<LicenseDetailsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
