...
namespace Microsoft.Graph.Users.Item.LicenseDetails {
    ...
    public class LicenseDetailsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.LicenseDetails> PostAsync(Microsoft.Graph.Models.LicenseDetails body, Action<LicenseDetailsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
