...
namespace Microsoft.Graph.Users.Item.RegisteredDevices.MicrosoftGraphEndpoint.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/registeredDevices/microsoft.graph.endpoint/$count{?%24search,%24filter}";
