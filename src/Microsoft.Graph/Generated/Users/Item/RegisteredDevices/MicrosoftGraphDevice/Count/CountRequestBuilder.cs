...
namespace Microsoft.Graph.Users.Item.RegisteredDevices.MicrosoftGraphDevice.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/registeredDevices/microsoft.graph.device/$count{?%24search,%24filter}";
