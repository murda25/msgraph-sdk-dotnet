...
namespace Microsoft.Graph.Users.Item.RegisteredDevices.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/registeredDevices/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}";
