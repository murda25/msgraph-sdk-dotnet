...
namespace Microsoft.Graph.Users.Item.RegisteredDevices.Item.GraphDevice {
    ...
    public class GraphDeviceRequestBuilder {
        ...
        public GraphDeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/registeredDevices/{directoryObject%2Did}/graph.device{?%24select,%24expand}";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Device?> GetAsync(Action<GraphDeviceRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Device> GetAsync(Action<GraphDeviceRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
