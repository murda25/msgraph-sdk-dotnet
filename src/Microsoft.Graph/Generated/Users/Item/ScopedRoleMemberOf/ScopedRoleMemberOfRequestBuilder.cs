...
using MicrosoftGraphSdk.Users.Item.ScopedRoleMemberOf.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.ScopedRoleMemberOf {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\scopedRoleMemberOf</summary>
    public class ScopedRoleMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.scopedRoleMemberOf.item collection</summary>
        ...
        public ScopedRoleMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/scopedRoleMemberOf{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
