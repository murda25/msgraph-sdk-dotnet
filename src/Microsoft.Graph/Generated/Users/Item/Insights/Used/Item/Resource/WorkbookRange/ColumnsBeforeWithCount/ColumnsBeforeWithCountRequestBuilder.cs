...
namespace MicrosoftGraphSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsBeforeWithCount {
        ...
        public class ColumnsBeforeWithCountResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as ColumnsBeforeWithCountResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
