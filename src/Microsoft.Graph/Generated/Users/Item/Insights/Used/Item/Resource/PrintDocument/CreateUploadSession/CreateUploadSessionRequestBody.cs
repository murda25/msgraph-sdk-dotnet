...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Insights.Used.Item.Resource.PrintDocument.CreateUploadSession {
    public class CreateUploadSessionRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"properties", (o,n) => { (o as CreateUploadSessionRequestBody).Properties = n.GetObjectValue<PrintDocumentUploadProperties>(PrintDocumentUploadProperties.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
