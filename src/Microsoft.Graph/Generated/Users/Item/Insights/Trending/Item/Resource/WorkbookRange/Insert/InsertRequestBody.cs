...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.Insert {
    public class InsertRequestBody : IParsable {
        ...
        /// </summary>
        public static InsertRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new InsertRequestBody();
        }
        /// <summary>
