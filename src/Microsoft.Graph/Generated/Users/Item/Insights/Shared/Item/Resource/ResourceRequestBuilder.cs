...
namespace Microsoft.Graph.Users.Item.Insights.Shared.Item.Resource {
    ...
    public class ResourceRequestBuilder {
        ...
        /// </summary>
        public async Task<Entity> GetAsync(CancellationToken cancellationToken = default, Action<ResourceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
