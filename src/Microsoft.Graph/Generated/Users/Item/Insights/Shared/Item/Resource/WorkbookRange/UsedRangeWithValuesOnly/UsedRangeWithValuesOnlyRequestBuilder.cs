...
namespace MicrosoftGraphSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public async Task<UsedRangeWithValuesOnlyResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<UsedRangeWithValuesOnlyResponse>(requestInfo, UsedRangeWithValuesOnlyResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        ...
        public class UsedRangeWithValuesOnlyResponse : IParsable {
            ...
            public static UsedRangeWithValuesOnlyResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                return new UsedRangeWithValuesOnlyResponse();
            }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as UsedRangeWithValuesOnlyResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookRange>(MicrosoftGraphSdk.Models.Microsoft.Graph.WorkbookRange.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
