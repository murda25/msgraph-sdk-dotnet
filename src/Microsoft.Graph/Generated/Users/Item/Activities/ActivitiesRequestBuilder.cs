...
namespace Microsoft.Graph.Users.Item.Activities {
    ...
    public class ActivitiesRequestBuilder {
        ...
        /// </summary>
        public async Task<UserActivityCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UserActivity> PostAsync(UserActivity body, CancellationToken cancellationToken = default, Action<ActivitiesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
