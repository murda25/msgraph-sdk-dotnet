...
namespace MicrosoftGraphSdk.Users.Item.Messages.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public AttachmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/messages/{message_id}/attachments/{attachment_id}{?select,expand}";
