...
namespace Microsoft.Graph.Users.Item.Messages.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        /// </summary>
        public async Task<Message> PostAsync(MovePostRequestBody body, CancellationToken cancellationToken = default, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
