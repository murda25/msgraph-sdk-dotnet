...
namespace Microsoft.Graph.Users.Item.Messages.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        public MoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/microsoft.graph.move";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Message> PostAsync(MovePostRequestBody body, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
