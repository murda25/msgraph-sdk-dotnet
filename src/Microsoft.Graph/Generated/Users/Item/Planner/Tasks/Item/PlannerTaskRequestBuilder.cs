...
using MicrosoftGraphSdk.Users.Item.Planner.Tasks.Item.ProgressTaskBoardFormat;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Planner.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public PlannerTaskRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/planner/tasks/{plannerTask_id}{?select,expand}";
