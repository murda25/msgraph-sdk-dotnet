...
using MicrosoftGraphSdk.Users.Item.Planner.Tasks.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Planner.Tasks {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\planner\tasks</summary>
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.planner.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/planner/tasks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
