...
namespace Microsoft.Graph.Users.Item.Planner.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.planner.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/planner/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Retrieve a list of **plannertask** objects assigned to a User.</summary>
