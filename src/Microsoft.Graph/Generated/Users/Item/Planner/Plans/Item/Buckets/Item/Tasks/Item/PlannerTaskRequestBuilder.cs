...
using MicrosoftGraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat;
using MicrosoftGraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.BucketTaskBoardFormat;
using MicrosoftGraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.Details;
using MicrosoftGraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\planner\plans\{plannerPlan-id}\buckets\{plannerBucket-id}\tasks\{plannerTask-id}</summary>
