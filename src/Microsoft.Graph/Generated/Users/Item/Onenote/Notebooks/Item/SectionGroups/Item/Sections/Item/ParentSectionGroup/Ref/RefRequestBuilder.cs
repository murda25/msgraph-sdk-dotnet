...
namespace MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.ParentSectionGroup.Ref {
    ...
    public class RefRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePutRequestInformation(MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.ParentSectionGroup.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
