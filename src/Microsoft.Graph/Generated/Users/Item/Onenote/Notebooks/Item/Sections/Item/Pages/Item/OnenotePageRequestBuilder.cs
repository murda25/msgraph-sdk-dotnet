...
using MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Content;
using MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.CopyToSection;
using MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.OnenotePatchContent;
using MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentNotebook;
using MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection;
using MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Preview;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onenote/notebooks/{notebook_id}/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
