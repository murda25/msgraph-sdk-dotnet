...
namespace Microsoft.Graph.Users.Item.Onenote.SectionGroups.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.onenote.sectionGroups.item.sectionGroups.item collection</summary>
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
