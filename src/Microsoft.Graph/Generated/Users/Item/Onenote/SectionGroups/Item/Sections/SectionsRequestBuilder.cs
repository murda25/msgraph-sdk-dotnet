...
using MicrosoftGraphSdk.Users.Item.Onenote.SectionGroups.Item.Sections.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Onenote.SectionGroups.Item.Sections {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\onenote\sectionGroups\{sectionGroup-id}\sections</summary>
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.onenote.sectionGroups.item.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onenote/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
