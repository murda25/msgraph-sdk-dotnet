...
using MicrosoftGraphSdk.Users.Item.Onenote.Pages.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Onenote.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.onenote.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onenote/pages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
