...
namespace MicrosoftGraphSdk.Users.Item.ManagedDevices.Item.DeviceCompliancePolicyStates.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\managedDevices\{managedDevice-id}\deviceCompliancePolicyStates\{deviceCompliancePolicyState-id}</summary>
    public class DeviceCompliancePolicyStateRequestBuilder {
        ...
        public DeviceCompliancePolicyStateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/managedDevices/{managedDevice_id}/deviceCompliancePolicyStates/{deviceCompliancePolicyState_id}{?select,expand}";
