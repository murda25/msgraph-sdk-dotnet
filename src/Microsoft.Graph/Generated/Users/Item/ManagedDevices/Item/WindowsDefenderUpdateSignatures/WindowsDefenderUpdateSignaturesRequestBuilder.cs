...
namespace Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsDefenderUpdateSignatures {
    ...
    public class WindowsDefenderUpdateSignaturesRequestBuilder {
        ...
        public WindowsDefenderUpdateSignaturesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.windowsDefenderUpdateSignatures";
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<WindowsDefenderUpdateSignaturesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
