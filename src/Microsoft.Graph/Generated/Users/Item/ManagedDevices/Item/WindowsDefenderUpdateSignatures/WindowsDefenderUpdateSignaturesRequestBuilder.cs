...
namespace Microsoft.Graph.Users.Item.ManagedDevices.Item.WindowsDefenderUpdateSignatures {
    ...
    public class WindowsDefenderUpdateSignaturesRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<WindowsDefenderUpdateSignaturesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
