...
namespace Microsoft.Graph.Users.Item.ManagedDevices.Item.ShutDown {
    ...
    public class ShutDownRequestBuilder {
        ...
        public ShutDownRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.shutDown";
        ...
        /// </summary>
        public async Task PostAsync(Action<ShutDownRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
