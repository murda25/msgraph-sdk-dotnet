...
namespace Microsoft.Graph.Users.Item.ManagedDevices.Item.ShutDown {
    ...
    public class ShutDownRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<ShutDownRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
