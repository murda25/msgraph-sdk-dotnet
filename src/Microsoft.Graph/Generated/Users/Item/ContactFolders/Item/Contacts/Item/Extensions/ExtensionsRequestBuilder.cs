...
using MicrosoftGraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.Extensions.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.ContactFolders.Item.Contacts.Item.Extensions {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contactFolders\{contactFolder-id}\contacts\{contact-id}\extensions</summary>
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.contactFolders.item.contacts.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/contactFolders/{contactFolder_id}/contacts/{contact_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
