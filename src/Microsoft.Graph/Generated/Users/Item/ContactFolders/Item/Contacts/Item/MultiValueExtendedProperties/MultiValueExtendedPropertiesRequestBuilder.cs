...
using Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties.Count;
using Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties.Item;
...
using System;
namespace Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties {
    /// <summary>
    ...
    public class MultiValueExtendedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MultiValueExtendedPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts/{contact%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
