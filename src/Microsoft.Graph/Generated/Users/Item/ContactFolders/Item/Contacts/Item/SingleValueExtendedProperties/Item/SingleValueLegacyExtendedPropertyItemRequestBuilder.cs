...
namespace Microsoft.Graph.Users.Item.ContactFolders.Item.Contacts.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyItemRequestBuilder {
        ...
        public SingleValueLegacyExtendedPropertyItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts/{contact%2Did}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty%2Did}{?%24select,%24expand}";
