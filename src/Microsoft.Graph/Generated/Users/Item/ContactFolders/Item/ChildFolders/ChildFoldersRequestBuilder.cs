...
using MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders.Delta;
using MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.ContactFolders.Item.ChildFolders {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contactFolders\{contactFolder-id}\childFolders</summary>
    public class ChildFoldersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.contactFolders.item.childFolders.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ContactFolder body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
