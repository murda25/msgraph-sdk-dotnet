...
namespace Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder {
        ...
        /// </summary>
        public async Task<ContactFolderCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChildFoldersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ContactFolder> PostAsync(ContactFolder body, CancellationToken cancellationToken = default, Action<ChildFoldersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
