...
namespace Microsoft.Graph.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        /// </summary>
        public async Task<ContactCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ContactsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Contact> PostAsync(Contact body, CancellationToken cancellationToken = default, Action<ContactsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
