...
using MicrosoftGraphSdk.Users.Item.ContactFolders.Item.SingleValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.ContactFolders.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\contactFolders\{contactFolder-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.contactFolders.item.singleValueExtendedProperties.item collection</summary>
