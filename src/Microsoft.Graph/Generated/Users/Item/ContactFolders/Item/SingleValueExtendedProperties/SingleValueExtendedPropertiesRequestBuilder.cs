...
using Microsoft.Graph.Users.Item.ContactFolders.Item.SingleValueExtendedProperties.Count;
using Microsoft.Graph.Users.Item.ContactFolders.Item.SingleValueExtendedProperties.Item;
...
using System;
namespace Microsoft.Graph.Users.Item.ContactFolders.Item.SingleValueExtendedProperties {
    /// <summary>
    ...
    public class SingleValueExtendedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SingleValueExtendedPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
