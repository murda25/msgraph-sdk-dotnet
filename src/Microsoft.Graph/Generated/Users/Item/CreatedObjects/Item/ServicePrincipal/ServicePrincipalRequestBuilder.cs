...
namespace Microsoft.Graph.Users.Item.CreatedObjects.Item.ServicePrincipal {
    /// <summary>
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/createdObjects/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
