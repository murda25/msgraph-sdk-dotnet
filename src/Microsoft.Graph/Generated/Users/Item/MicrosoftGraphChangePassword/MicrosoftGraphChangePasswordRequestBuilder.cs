...
namespace Microsoft.Graph.Users.Item.MicrosoftGraphChangePassword {
    /// <summary>
    ...
    public class MicrosoftGraphChangePasswordRequestBuilder {
        ...
        public MicrosoftGraphChangePasswordRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphChangePasswordRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(ChangePasswordPostRequestBody body, Action<MicrosoftGraphChangePasswordRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ChangePasswordPostRequestBody body, Action<MicrosoftGraphChangePasswordRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
