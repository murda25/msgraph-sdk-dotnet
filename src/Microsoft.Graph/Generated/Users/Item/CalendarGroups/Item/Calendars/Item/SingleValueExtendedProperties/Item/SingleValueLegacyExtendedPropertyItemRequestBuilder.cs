...
namespace Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyItemRequestBuilder {
        ...
        public SingleValueLegacyExtendedPropertyItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty%2Did}{?%24select,%24expand}";
