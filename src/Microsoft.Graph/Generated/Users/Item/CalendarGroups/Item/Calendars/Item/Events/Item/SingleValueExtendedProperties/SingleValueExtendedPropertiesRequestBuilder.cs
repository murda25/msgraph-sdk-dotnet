...
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties.Count;
using Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties {
    /// <summary>
    ...
    public class SingleValueExtendedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SingleValueExtendedPropertiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SingleValueExtendedPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
