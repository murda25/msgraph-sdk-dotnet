...
namespace Microsoft.Graph.Users.Item.CalendarGroups.Item.Calendars.Item.MicrosoftGraphAllowedCalendarSharingRolesWithUser {
    /// <summary>
    ...
    public class MicrosoftGraphAllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public MicrosoftGraphAllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string user = "") {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/microsoft.graph.allowedCalendarSharingRoles(User='{User}'){?%24top,%24skip,%24search,%24filter,%24count}";
