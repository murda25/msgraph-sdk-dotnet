...
using MicrosoftGraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Delta;
using MicrosoftGraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\events</summary>
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendarGroups.item.calendars.item.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
