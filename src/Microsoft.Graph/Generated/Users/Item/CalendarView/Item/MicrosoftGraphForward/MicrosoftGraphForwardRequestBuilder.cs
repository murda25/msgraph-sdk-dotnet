...
namespace Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphForward {
    /// <summary>
    ...
    public class MicrosoftGraphForwardRequestBuilder {
        ...
        public MicrosoftGraphForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/microsoft.graph.forward";
