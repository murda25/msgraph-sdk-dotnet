...
using Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphAccept;
using Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphCancel;
using Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphDecline;
using Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphDismissReminder;
using Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphForward;
using Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphSnoozeReminder;
using Microsoft.Graph.Users.Item.CalendarView.Item.MicrosoftGraphTentativelyAccept;
...
namespace Microsoft.Graph.Users.Item.CalendarView.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}{?startDateTime*,endDateTime*,%24select}";
