...
namespace Microsoft.Graph.Users.Item.CalendarView.Item.Instances.Item.MicrosoftGraphForward {
    /// <summary>
    ...
    public class MicrosoftGraphForwardRequestBuilder {
        ...
        public MicrosoftGraphForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/microsoft.graph.forward";
