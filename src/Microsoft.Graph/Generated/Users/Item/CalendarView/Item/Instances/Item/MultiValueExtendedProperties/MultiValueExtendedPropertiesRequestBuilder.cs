...
using Microsoft.Graph.Users.Item.CalendarView.Item.Instances.Item.MultiValueExtendedProperties.Count;
using Microsoft.Graph.Users.Item.CalendarView.Item.Instances.Item.MultiValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Users.Item.CalendarView.Item.Instances.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MultiValueExtendedPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
