...
using MicrosoftGraphSdk.Users.Item.CalendarView.Item.Instances.Delta;
using MicrosoftGraphSdk.Users.Item.CalendarView.Item.Instances.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.CalendarView.Item.Instances {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarView\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendarView.item.instances.item collection</summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendarView/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
