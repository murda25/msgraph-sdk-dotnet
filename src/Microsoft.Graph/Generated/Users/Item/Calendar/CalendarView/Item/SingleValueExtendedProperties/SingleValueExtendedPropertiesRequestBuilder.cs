...
using MicrosoftGraphSdk.Users.Item.Calendar.CalendarView.Item.SingleValueExtendedProperties.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendar.CalendarView.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\calendarView\{event-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.calendar.calendarView.item.singleValueExtendedProperties.item collection</summary>
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendar/calendarView/{event_id}/singleValueExtendedProperties{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
