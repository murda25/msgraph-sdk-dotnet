...
using Microsoft.Graph.Users.Item.Calendar.CalendarView.Item.Instances.Item.MultiValueExtendedProperties.Count;
using Microsoft.Graph.Users.Item.Calendar.CalendarView.Item.Instances.Item.MultiValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Users.Item.Calendar.CalendarView.Item.Instances.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.calendar.calendarView.item.instances.item.multiValueExtendedProperties.item collection</summary>
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
