...
using MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.Instances.Delta;
using MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.Instances.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.Instances {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
