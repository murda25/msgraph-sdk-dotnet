...
namespace MicrosoftGraphSdk.Users.Item.Calendar.Events.Item.Attachments.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\events\{event-id}\attachments\{attachment-id}</summary>
    public class AttachmentRequestBuilder {
        ...
        public AttachmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}/attachments/{attachment_id}{?select,expand}";
