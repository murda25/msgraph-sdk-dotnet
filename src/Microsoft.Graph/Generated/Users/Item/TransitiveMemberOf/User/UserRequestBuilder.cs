...
using Microsoft.Graph.Users.Item.TransitiveMemberOf.User.Count;
...
namespace Microsoft.Graph.Users.Item.TransitiveMemberOf.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/microsoft.graph.user{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
