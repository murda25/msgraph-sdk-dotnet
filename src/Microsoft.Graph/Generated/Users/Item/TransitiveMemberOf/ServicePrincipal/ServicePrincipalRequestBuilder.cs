...
using Microsoft.Graph.Users.Item.TransitiveMemberOf.ServicePrincipal.Count;
...
namespace Microsoft.Graph.Users.Item.TransitiveMemberOf.ServicePrincipal {
    /// <summary>
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
