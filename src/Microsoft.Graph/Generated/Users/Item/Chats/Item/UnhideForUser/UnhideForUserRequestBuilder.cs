...
namespace Microsoft.Graph.Users.Item.Chats.Item.UnhideForUser {
    ...
    public class UnhideForUserRequestBuilder {
        ...
        public UnhideForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/microsoft.graph.unhideForUser";
        ...
        public RequestInformation CreatePostRequestInformation(UnhideForUserPostRequestBody body, Action<UnhideForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
