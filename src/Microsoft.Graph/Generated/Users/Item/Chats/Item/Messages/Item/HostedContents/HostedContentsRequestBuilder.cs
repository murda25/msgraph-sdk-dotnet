...
namespace Microsoft.Graph.Users.Item.Chats.Item.Messages.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.users.item.chats.item.messages.item.hostedContents.item collection</summary>
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
