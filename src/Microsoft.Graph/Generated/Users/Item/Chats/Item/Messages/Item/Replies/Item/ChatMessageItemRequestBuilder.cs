...
using MicrosoftGraphSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item.HostedContents;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/chats/{chat_id}/messages/{chatMessage_id}/replies/{chatMessage_id1}{?select,expand}";
