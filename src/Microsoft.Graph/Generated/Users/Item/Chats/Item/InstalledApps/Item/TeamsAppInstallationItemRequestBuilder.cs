...
using Microsoft.Graph.Users.Item.Chats.Item.InstalledApps.Item.MicrosoftGraphUpgrade;
...
namespace Microsoft.Graph.Users.Item.Chats.Item.InstalledApps.Item {
    ...
    public class TeamsAppInstallationItemRequestBuilder {
        ...
        public TeamsAppInstallationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}";
