...
namespace Microsoft.Graph.Users.Item.MailFolders {
    ...
    public class MailFoldersRequestBuilder {
        ...
        /// </summary>
        public async Task<MailFolderCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MailFoldersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MailFolder> PostAsync(MailFolder body, CancellationToken cancellationToken = default, Action<MailFoldersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
