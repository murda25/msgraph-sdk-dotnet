...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.MicrosoftGraphMove {
    /// <summary>
    ...
    public class MicrosoftGraphMoveRequestBuilder {
        ...
        public MicrosoftGraphMoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/microsoft.graph.move";
...
#nullable enable
        public async Task<MailFolder?> PostAsync(MovePostRequestBody body, Action<MicrosoftGraphMoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<MailFolder> PostAsync(MovePostRequestBody body, Action<MicrosoftGraphMoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
