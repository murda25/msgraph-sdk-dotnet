...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.MicrosoftGraphCopy {
    /// <summary>
    ...
    public class MicrosoftGraphCopyRequestBuilder {
        ...
        public MicrosoftGraphCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/microsoft.graph.copy";
