...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MicrosoftGraphCopy {
    /// <summary>
    ...
    public class MicrosoftGraphCopyRequestBuilder {
        ...
        public MicrosoftGraphCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/microsoft.graph.copy";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(CopyPostRequestBody body, Action<MicrosoftGraphCopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(CopyPostRequestBody body, Action<MicrosoftGraphCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
