...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        /// </summary>
        public async Task<MailFolder> PostAsync(MoveRequestBody body, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
