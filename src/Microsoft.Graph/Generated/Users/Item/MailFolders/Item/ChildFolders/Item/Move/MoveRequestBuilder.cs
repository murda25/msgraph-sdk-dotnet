...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<MailFolder> PostAsync(MovePostRequestBody body, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
