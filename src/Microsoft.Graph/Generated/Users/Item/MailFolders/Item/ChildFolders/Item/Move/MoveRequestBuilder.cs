...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.ChildFolders.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        /// </summary>
        public async Task<MailFolder> PostAsync(MovePostRequestBody body, CancellationToken cancellationToken = default, Action<MoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
