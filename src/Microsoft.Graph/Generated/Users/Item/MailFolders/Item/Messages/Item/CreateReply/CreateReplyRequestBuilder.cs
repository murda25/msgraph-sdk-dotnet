...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.Messages.Item.CreateReply {
    ...
    public class CreateReplyRequestBuilder {
        ...
        /// </summary>
        public async Task<Message> PostAsync(CreateReplyPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
