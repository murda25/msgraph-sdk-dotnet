...
namespace MicrosoftGraphSdk.Users.Item.MailFolders.Item.Messages.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/messages/{message_id}/extensions/{extension_id}{?select,expand}";
