...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.Messages.Item.MicrosoftGraphCreateForward {
    /// <summary>
    ...
    public class MicrosoftGraphCreateForwardRequestBuilder {
        ...
        public MicrosoftGraphCreateForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.createForward";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(CreateForwardPostRequestBody body, Action<MicrosoftGraphCreateForwardRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(CreateForwardPostRequestBody body, Action<MicrosoftGraphCreateForwardRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
