...
namespace Microsoft.Graph.Users.Item.MailFolders.Item.Messages.Item.MicrosoftGraphMove {
    /// <summary>
    ...
    public class MicrosoftGraphMoveRequestBuilder {
        ...
        public MicrosoftGraphMoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.move";
