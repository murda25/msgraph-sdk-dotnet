...
using MicrosoftGraphSdk.Users.Item.MailFolders.Item.Messages.Delta;
using MicrosoftGraphSdk.Users.Item.MailFolders.Item.Messages.Item;
using System;
...
namespace MicrosoftGraphSdk.Users.Item.MailFolders.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.users.item.mailFolders.item.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/messages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
