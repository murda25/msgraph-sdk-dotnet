...
namespace Microsoft.Graph.DeviceAppManagement.MobileApps.MicrosoftGraphManagedMobileLobApp.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/microsoft.graph.managedMobileLobApp/$count{?%24search,%24filter}";
