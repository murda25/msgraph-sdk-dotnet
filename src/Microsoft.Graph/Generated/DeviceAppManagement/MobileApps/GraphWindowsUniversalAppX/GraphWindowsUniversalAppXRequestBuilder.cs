...
namespace Microsoft.Graph.DeviceAppManagement.MobileApps.GraphWindowsUniversalAppX {
    ...
    public class GraphWindowsUniversalAppXRequestBuilder : BaseRequestBuilder {
        ...
        public GraphWindowsUniversalAppXRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.windowsUniversalAppX{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphWindowsUniversalAppXRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphWindowsUniversalAppXRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/deviceAppManagement/mobileApps/graph.windowsUniversalAppX{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WindowsUniversalAppXCollectionResponse?> GetAsync(Action<GraphWindowsUniversalAppXRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WindowsUniversalAppXCollectionResponse> GetAsync(Action<GraphWindowsUniversalAppXRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
