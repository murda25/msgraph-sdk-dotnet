...
#nullable enable
        public async Task<ManagedMobileLobAppCollectionResponse?> GetAsync(Action<GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ManagedMobileLobAppCollectionResponse> GetAsync(Action<GraphManagedMobileLobAppRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
