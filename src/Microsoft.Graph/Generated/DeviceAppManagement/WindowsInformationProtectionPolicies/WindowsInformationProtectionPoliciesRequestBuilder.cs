...
namespace MicrosoftGraphSdk.DeviceAppManagement.WindowsInformationProtectionPolicies {
    ...
    public class WindowsInformationProtectionPoliciesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WindowsInformationProtectionPolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
