...
namespace Microsoft.Graph.DeviceAppManagement.ManagedAppRegistrations.GetUserIdsWithFlaggedAppRegistration {
    ...
    public class GetUserIdsWithFlaggedAppRegistrationResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public GetUserIdsWithFlaggedAppRegistrationResponse() {
        ...
        /// </summary>
        public static GetUserIdsWithFlaggedAppRegistrationResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetUserIdsWithFlaggedAppRegistrationResponse).Value = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
            };
        }
        /// <summary>
