...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedAppRegistrations.Item.Operations.Item {
    ...
    public class ManagedAppOperationRequestBuilder {
        ...
        /// </summary>
        public ManagedAppOperationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ManagedAppOperationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
