...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedAppStatuses {
    ...
    public class ManagedAppStatusesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ManagedAppStatus body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
