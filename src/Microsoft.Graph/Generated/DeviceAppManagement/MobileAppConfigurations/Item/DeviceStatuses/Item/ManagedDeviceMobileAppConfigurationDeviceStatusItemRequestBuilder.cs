...
namespace Microsoft.Graph.DeviceAppManagement.MobileAppConfigurations.Item.DeviceStatuses.Item {
    ...
    public class ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ManagedDeviceMobileAppConfigurationDeviceStatus body, Action<ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
