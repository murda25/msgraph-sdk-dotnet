...
namespace Microsoft.Graph.DeviceAppManagement.AndroidManagedAppProtections.Item.DeploymentSummary {
    ...
    public class DeploymentSummaryRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedAppPolicyDeploymentSummary> GetAsync(CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ManagedAppPolicyDeploymentSummary body, CancellationToken cancellationToken = default, Action<DeploymentSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
