...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary {
    ...
    public class UserStateSummaryRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UserInstallStateSummary body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
