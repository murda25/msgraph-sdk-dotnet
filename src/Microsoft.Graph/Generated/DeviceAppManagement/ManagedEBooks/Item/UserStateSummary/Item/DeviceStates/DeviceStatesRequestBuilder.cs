...
using MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary.Item.DeviceStates.Item;
...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary.Item.DeviceStates {
    ...
    public class DeviceStatesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceAppManagement.managedEBooks.item.userStateSummary.item.deviceStates.item collection</summary>
