...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary.Item {
    ...
    public class UserInstallStateSummaryRequestBuilder {
        ...
        /// </summary>
        public UserInstallStateSummaryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public UserInstallStateSummaryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(UserInstallStateSummary body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
