...
namespace MicrosoftGraphSdk.DeviceAppManagement.ManagedEBooks.Item.Assignments.Item {
    /// <summary>Builds and executes requests for operations under \deviceAppManagement\managedEBooks\{managedEBook-id}\assignments\{managedEBookAssignment-id}</summary>
    public class ManagedEBookAssignmentRequestBuilder {
        ...
        /// </summary>
        public ManagedEBookAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ManagedEBookAssignmentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ManagedEBookAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
