...
namespace Microsoft.Graph.DeviceAppManagement.VppTokens.Item.SyncLicenses {
    ...
    public class SyncLicensesRequestBuilder {
        ...
        /// </summary>
        public async Task<VppToken> PostAsync(CancellationToken cancellationToken = default, Action<SyncLicensesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
