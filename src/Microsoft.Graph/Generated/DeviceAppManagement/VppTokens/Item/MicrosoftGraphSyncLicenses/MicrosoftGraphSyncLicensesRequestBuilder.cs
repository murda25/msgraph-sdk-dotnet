...
namespace Microsoft.Graph.DeviceAppManagement.VppTokens.Item.MicrosoftGraphSyncLicenses {
    /// <summary>
    ...
    public class MicrosoftGraphSyncLicensesRequestBuilder {
        ...
        public MicrosoftGraphSyncLicensesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSyncLicensesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<VppToken?> PostAsync(Action<MicrosoftGraphSyncLicensesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<VppToken> PostAsync(Action<MicrosoftGraphSyncLicensesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
