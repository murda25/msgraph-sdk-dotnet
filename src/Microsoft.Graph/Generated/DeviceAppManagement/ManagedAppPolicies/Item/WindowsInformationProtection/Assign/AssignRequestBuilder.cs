...
namespace Microsoft.Graph.DeviceAppManagement.ManagedAppPolicies.Item.WindowsInformationProtection.Assign {
    ...
    public class AssignRequestBuilder {
        ...
        public AssignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/managedAppPolicies/{managedAppPolicy%2Did}/microsoft.graph.windowsInformationProtection/microsoft.graph.assign";
