using Microsoft.Graph.DeviceAppManagement.ManagedAppPolicies.Item.WindowsInformationProtection.Assign;
...
namespace Microsoft.Graph.DeviceAppManagement.ManagedAppPolicies.Item.WindowsInformationProtection {
    ...
    public class WindowsInformationProtectionRequestBuilder {
        ...
        public WindowsInformationProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/managedAppPolicies/{managedAppPolicy%2Did}/microsoft.graph.windowsInformationProtection";
