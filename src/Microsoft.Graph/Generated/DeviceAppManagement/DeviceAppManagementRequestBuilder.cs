...
namespace Microsoft.Graph.DeviceAppManagement {
    ...
    public class DeviceAppManagementRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DeviceAppManagement> GetAsync(CancellationToken cancellationToken = default, Action<DeviceAppManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.DeviceAppManagement body, CancellationToken cancellationToken = default, Action<DeviceAppManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
