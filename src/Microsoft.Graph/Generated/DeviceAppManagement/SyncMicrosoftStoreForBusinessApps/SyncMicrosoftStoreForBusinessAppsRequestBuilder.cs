...
namespace Microsoft.Graph.DeviceAppManagement.SyncMicrosoftStoreForBusinessApps {
    ...
    public class SyncMicrosoftStoreForBusinessAppsRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<SyncMicrosoftStoreForBusinessAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
