...
namespace Microsoft.Graph.AuditLogs.Provisioning.Item {
    ...
    public class ProvisioningObjectSummaryItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ProvisioningObjectSummary body, Action<ProvisioningObjectSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
