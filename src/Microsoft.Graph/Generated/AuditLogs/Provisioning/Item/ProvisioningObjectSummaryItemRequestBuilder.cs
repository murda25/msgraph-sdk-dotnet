...
namespace Microsoft.Graph.AuditLogs.Provisioning.Item {
    ...
    public class ProvisioningObjectSummaryItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<ProvisioningObjectSummaryItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ProvisioningObjectSummary> GetAsync(CancellationToken cancellationToken = default, Action<ProvisioningObjectSummaryItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ProvisioningObjectSummary body, CancellationToken cancellationToken = default, Action<ProvisioningObjectSummaryItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
