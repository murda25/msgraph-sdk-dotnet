...
namespace Microsoft.Graph.Me.DirectReports.Item.User.RevokeSignInSessions {
    ...
    public class RevokeSignInSessionsRequestBuilder {
        ...
        public RevokeSignInSessionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/directReports/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.revokeSignInSessions";
