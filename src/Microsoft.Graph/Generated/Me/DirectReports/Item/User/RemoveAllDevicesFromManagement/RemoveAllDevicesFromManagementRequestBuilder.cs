...
namespace Microsoft.Graph.Me.DirectReports.Item.User.RemoveAllDevicesFromManagement {
    ...
    public class RemoveAllDevicesFromManagementRequestBuilder {
        ...
        public RemoveAllDevicesFromManagementRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/directReports/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.removeAllDevicesFromManagement";
