...
namespace Microsoft.Graph.Me.DirectReports.Item.User.GetManagedAppDiagnosticStatuses {
    ...
    public class GetManagedAppDiagnosticStatusesRequestBuilder {
        ...
        public GetManagedAppDiagnosticStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/directReports/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getManagedAppDiagnosticStatuses()";
