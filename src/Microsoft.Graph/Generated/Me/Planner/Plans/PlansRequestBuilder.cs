...
using MicrosoftGraphSdk.Me.Planner.Plans.Item;
...
namespace MicrosoftGraphSdk.Me.Planner.Plans {
    /// <summary>Builds and executes requests for operations under \me\planner\plans</summary>
    public class PlansRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.planner.plans.item collection</summary>
        ...
        public PlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/plans{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
