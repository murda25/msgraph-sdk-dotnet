...
namespace Microsoft.Graph.Me.Planner.Plans {
    ...
    public class PlansRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.planner.plans.item collection</summary>
        ...
        public PlansRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/plans{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
