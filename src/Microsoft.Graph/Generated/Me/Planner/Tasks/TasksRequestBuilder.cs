...
namespace Microsoft.Graph.Me.Planner.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.planner.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/planner/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
