...
using MicrosoftGraphSdk.Me.ContactFolders.Item.Contacts.Item.Extensions.Item;
...
namespace MicrosoftGraphSdk.Me.ContactFolders.Item.Contacts.Item.Extensions {
    /// <summary>Builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\contacts\{contact-id}\extensions</summary>
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.contactFolders.item.contacts.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/contactFolders/{contactFolder_id}/contacts/{contact_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
