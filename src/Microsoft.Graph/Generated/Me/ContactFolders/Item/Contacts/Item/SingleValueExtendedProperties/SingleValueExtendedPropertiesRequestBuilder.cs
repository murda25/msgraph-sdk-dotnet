...
using MicrosoftGraphSdk.Me.ContactFolders.Item.Contacts.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Me.ContactFolders.Item.Contacts.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\contacts\{contact-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.contactFolders.item.contacts.item.singleValueExtendedProperties.item collection</summary>
