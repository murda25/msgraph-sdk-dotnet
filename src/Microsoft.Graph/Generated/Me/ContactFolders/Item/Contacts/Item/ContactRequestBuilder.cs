...
namespace MicrosoftGraphSdk.Me.ContactFolders.Item.Contacts.Item {
    /// <summary>Builds and executes requests for operations under \me\contactFolders\{contactFolder-id}\contacts\{contact-id}</summary>
    public class ContactRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ContactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
