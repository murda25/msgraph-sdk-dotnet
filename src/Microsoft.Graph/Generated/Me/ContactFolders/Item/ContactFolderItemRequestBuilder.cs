...
namespace Microsoft.Graph.Me.ContactFolders.Item {
    ...
    public class ContactFolderItemRequestBuilder : BaseRequestBuilder {
        ...
        public ContactFolderItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/contactFolders/{contactFolder%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ContactFolderItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContactFolderItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/contactFolders/{contactFolder%2Did}{?%24select}", rawUrl) {
        }
        /// <summary>
