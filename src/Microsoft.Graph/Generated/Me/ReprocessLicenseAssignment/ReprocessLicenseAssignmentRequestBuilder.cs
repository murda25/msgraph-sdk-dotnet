...
namespace Microsoft.Graph.Me.ReprocessLicenseAssignment {
    ...
    public class ReprocessLicenseAssignmentRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.User> PostAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
