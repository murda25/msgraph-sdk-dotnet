...
namespace Microsoft.Graph.Me.ReprocessLicenseAssignment {
    ...
    public class ReprocessLicenseAssignmentRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.User> PostAsync(CancellationToken cancellationToken = default, Action<ReprocessLicenseAssignmentRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
