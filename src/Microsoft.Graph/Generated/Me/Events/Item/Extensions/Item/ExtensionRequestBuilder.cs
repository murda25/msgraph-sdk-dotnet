...
namespace MicrosoftGraphSdk.Me.Events.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \me\events\{event-id}\extensions\{extension-id}</summary>
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event_id}/extensions/{extension_id}{?select,expand}";
