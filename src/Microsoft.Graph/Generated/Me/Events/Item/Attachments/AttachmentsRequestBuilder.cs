...
using MicrosoftGraphSdk.Me.Events.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Me.Events.Item.Attachments.Item;
...
namespace MicrosoftGraphSdk.Me.Events.Item.Attachments {
    /// <summary>Builds and executes requests for operations under \me\events\{event-id}\attachments</summary>
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.events.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
