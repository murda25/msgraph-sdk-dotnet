...
namespace Microsoft.Graph.Me.Authentication.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// </summary>
        public async Task<LongRunningOperationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OperationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<LongRunningOperation> PostAsync(LongRunningOperation body, CancellationToken cancellationToken = default, Action<OperationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
