using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Device.Count;
...
namespace Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Device {
    /// <summary>
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
