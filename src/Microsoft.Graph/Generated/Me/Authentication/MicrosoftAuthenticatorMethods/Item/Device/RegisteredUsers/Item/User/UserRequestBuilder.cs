using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.AssignLicense;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ChangePassword;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.CheckMemberGroups;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.CheckMemberObjects;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ExportPersonalData;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.FindMeetingTimes;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetMailTips;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetMemberGroups;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.GetMemberObjects;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.Restore;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.SendMail;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredUsers.Item.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredUsers/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
