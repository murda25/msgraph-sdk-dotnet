...
namespace Microsoft.Graph.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Item.User.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getMemberObjects";
