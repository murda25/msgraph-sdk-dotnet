...
namespace Microsoft.Graph.Me.Authentication.Fido2Methods.Item {
    ...
    public class Fido2AuthenticationMethodItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Fido2AuthenticationMethod> PatchAsync(Fido2AuthenticationMethod body, Action<Fido2AuthenticationMethodItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
