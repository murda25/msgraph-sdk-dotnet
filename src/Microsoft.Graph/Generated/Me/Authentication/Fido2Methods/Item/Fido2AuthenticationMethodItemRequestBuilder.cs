...
namespace Microsoft.Graph.Me.Authentication.Fido2Methods.Item {
    ...
    public class Fido2AuthenticationMethodItemRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Fido2AuthenticationMethod> PatchAsync(Fido2AuthenticationMethod body, Action<Fido2AuthenticationMethodItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
