...
namespace Microsoft.Graph.Me.Authentication.SoftwareOathMethods.Item {
    ...
    public class SoftwareOathAuthenticationMethodItemRequestBuilder {
        ...
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public async Task<SoftwareOathAuthenticationMethod> PatchAsync(SoftwareOathAuthenticationMethod body, Action<SoftwareOathAuthenticationMethodItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
