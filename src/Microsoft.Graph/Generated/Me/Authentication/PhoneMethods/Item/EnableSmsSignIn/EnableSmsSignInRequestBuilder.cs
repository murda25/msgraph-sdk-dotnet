...
namespace Microsoft.Graph.Me.Authentication.PhoneMethods.Item.EnableSmsSignIn {
    ...
    public class EnableSmsSignInRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<EnableSmsSignInRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
