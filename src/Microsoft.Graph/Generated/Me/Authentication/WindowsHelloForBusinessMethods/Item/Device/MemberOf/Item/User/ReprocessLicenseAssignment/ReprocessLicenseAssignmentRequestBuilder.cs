...
namespace Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.ReprocessLicenseAssignment {
    ...
    public class ReprocessLicenseAssignmentRequestBuilder {
        ...
        public ReprocessLicenseAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.reprocessLicenseAssignment";
