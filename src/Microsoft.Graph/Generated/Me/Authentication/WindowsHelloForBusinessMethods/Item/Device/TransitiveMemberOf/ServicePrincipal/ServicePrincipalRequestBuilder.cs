using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.ServicePrincipal.Count;
...
namespace Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
