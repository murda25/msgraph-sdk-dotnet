...
namespace Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetManagedAppDiagnosticStatuses {
    ...
    public class GetManagedAppDiagnosticStatusesRequestBuilder {
        ...
        public GetManagedAppDiagnosticStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.getManagedAppDiagnosticStatuses()";
