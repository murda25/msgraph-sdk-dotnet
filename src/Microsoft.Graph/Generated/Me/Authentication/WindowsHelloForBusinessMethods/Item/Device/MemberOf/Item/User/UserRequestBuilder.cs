using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.AssignLicense;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.ChangePassword;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.CheckMemberGroups;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.CheckMemberObjects;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.ExportPersonalData;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.FindMeetingTimes;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.GetMailTips;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.GetMemberGroups;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.GetMemberObjects;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.Restore;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.SendMail;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User.WipeManagedAppRegistrationsByDeviceTag;
