using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.AssignLicense;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ChangePassword;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.CheckMemberGroups;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.CheckMemberObjects;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ExportPersonalData;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.FindMeetingTimes;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetMailTips;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetMemberGroups;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.GetMemberObjects;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.Restore;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.SendMail;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.User.WipeManagedAppRegistrationsByDeviceTag;
