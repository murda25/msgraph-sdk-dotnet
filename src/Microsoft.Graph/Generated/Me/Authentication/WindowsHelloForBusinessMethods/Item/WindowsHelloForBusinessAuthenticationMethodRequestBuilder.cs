...
namespace MicrosoftGraphSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item {
    ...
    public class WindowsHelloForBusinessAuthenticationMethodRequestBuilder {
        ...
        /// </summary>
        public WindowsHelloForBusinessAuthenticationMethodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public WindowsHelloForBusinessAuthenticationMethodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WindowsHelloForBusinessAuthenticationMethod body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
