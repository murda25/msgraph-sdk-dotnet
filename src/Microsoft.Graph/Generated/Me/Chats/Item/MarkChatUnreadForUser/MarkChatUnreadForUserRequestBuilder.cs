...
namespace Microsoft.Graph.Me.Chats.Item.MarkChatUnreadForUser {
    ...
    public class MarkChatUnreadForUserRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MarkChatUnreadForUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(MarkChatUnreadForUserPostRequestBody body, Action<MarkChatUnreadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public async Task PostAsync(MarkChatUnreadForUserPostRequestBody body, Action<MarkChatUnreadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
