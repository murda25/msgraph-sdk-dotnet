...
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.CalendarSharingMessage;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.ManagedAppProtection;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.MobileAppContentFile;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.PrintDocument;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.PrintJob;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.Ref;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.ScheduleChangeRequest;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.WindowsInformationProtection;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRange;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeFill;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeFormat;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeSort;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource.WorkbookRangeView;
...
namespace MicrosoftGraphSdk.Me.Insights.Shared.Item.Resource {
