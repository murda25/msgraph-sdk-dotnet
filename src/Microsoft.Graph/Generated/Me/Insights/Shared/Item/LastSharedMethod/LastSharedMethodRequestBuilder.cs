...
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.CalendarSharingMessage;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.ManagedAppProtection;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.MobileAppContentFile;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.PrintDocument;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.PrintJob;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.Ref;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.ScheduleChangeRequest;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.TargetedManagedAppProtection;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WindowsInformationProtection;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFill;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeFormat;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeSort;
using MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRangeView;
...
namespace MicrosoftGraphSdk.Me.Insights.Shared.Item.LastSharedMethod {
