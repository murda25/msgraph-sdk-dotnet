...
namespace Microsoft.Graph.Me.Insights.Shared {
    ...
    public class SharedRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.insights.shared.item collection</summary>
        ...
        /// </summary>
        public async Task<SharedInsightCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SharedRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<SharedInsightCollectionResponse>(requestInfo, SharedInsightCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to shared for me
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SharedInsight> PostAsync(SharedInsight body, CancellationToken cancellationToken = default, Action<SharedRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
