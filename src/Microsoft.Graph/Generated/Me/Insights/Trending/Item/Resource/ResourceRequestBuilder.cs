...
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.CalendarSharingMessage;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.ManagedAppProtection;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.MobileAppContentFile;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.PrintDocument;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.PrintJob;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.Ref;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.TargetedManagedAppProtection;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WindowsInformationProtection;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFill;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFormat;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeSort;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeView;
...
namespace MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource {
