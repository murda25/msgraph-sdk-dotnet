...
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.CellWithRowWithColumn;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.Clear;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfter;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfterWithCount;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsBefore;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsBeforeWithCount;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnWithColumn;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.Delete;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.EntireColumn;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.EntireRow;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.Insert;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.IntersectionWithAnotherRange;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.LastCell;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.LastColumn;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.LastRow;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.Merge;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsAbove;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsAboveWithCount;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsBelow;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsBelowWithCount;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.RowWithRow;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.Unmerge;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.UsedRange;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly;
using MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.VisibleView;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraphSdk.Me.Insights.Trending.Item.Resource.WorkbookRange {
