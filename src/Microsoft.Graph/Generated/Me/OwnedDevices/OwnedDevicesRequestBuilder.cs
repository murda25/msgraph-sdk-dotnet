...
namespace Microsoft.Graph.Me.OwnedDevices {
    ...
    public class OwnedDevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.ownedDevices.item collection</summary>
        ...
        public OwnedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/ownedDevices{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
