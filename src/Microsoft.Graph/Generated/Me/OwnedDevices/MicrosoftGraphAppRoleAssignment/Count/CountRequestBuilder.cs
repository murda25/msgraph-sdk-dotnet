...
namespace Microsoft.Graph.Me.OwnedDevices.MicrosoftGraphAppRoleAssignment.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/ownedDevices/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}";
