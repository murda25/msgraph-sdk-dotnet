...
namespace Microsoft.Graph.Me.CalendarGroups.Item.Calendars {
    ...
    public class CalendarsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Calendar> PostAsync(Microsoft.Graph.Models.Calendar body, CancellationToken cancellationToken = default, Action<CalendarsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
