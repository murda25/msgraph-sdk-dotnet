...
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.AllowedCalendarSharingRolesWithUser;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarPermissions;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.GetSchedule;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.SingleValueExtendedProperties;
...
namespace MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item {
    ...
    public class CalendarRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraphSdk.Models.Microsoft.Graph.Calendar body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
