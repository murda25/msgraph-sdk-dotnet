...
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Delta;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item;
...
namespace MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView {
    /// <summary>Builds and executes requests for operations under \me\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\calendarView</summary>
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendarGroups.item.calendars.item.calendarView.item collection</summary>
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
