...
namespace Microsoft.Graph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances.Item.Attachments.MicrosoftGraphCreateUploadSession {
    /// <summary>
    ...
    public class MicrosoftGraphCreateUploadSessionRequestBuilder {
        ...
        public MicrosoftGraphCreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/microsoft.graph.createUploadSession";
