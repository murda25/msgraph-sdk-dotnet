...
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Accept;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Attachments;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Calendar;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Cancel;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Decline;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.DismissReminder;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Extensions;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Forward;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.SnoozeReminder;
using MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept;
...
namespace MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}{?select}";
