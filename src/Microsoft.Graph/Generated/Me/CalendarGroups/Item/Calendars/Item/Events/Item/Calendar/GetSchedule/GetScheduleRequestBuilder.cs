...
namespace MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar.GetSchedule {
    ...
    public class GetScheduleRequestBuilder {
        ...
        public async Task<IEnumerable<MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraphSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
