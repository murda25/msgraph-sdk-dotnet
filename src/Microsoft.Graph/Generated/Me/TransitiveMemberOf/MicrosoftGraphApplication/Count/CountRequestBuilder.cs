...
namespace Microsoft.Graph.Me.TransitiveMemberOf.MicrosoftGraphApplication.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/transitiveMemberOf/microsoft.graph.application/$count{?%24search,%24filter}";
