...
namespace Microsoft.Graph.Me.TransitiveMemberOf.Item.User.ExportPersonalData {
    ...
    public class ExportPersonalDataRequestBuilder {
        ...
        public ExportPersonalDataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user/microsoft.graph.exportPersonalData";
