using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.AssignLicense;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.ChangePassword;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.CheckMemberGroups;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.CheckMemberObjects;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.ExportPersonalData;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.FindMeetingTimes;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.GetMailTips;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.GetMemberGroups;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.GetMemberObjects;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.Restore;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.SendMail;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Me.TransitiveMemberOf.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Me.TransitiveMemberOf.Item.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
