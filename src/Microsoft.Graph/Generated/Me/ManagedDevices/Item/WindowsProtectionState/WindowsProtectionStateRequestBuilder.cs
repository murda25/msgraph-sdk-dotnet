...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.WindowsProtectionState?> GetAsync(Action<WindowsProtectionStateRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.WindowsProtectionState> GetAsync(Action<WindowsProtectionStateRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.WindowsProtectionState?> PatchAsync(Microsoft.Graph.Models.WindowsProtectionState body, Action<WindowsProtectionStateRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.WindowsProtectionState> PatchAsync(Microsoft.Graph.Models.WindowsProtectionState body, Action<WindowsProtectionStateRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.WindowsProtectionState body, Action<WindowsProtectionStateRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.WindowsProtectionState body, Action<WindowsProtectionStateRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
