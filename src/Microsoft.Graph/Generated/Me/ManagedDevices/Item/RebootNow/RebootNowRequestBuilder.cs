...
namespace Microsoft.Graph.Me.ManagedDevices.Item.RebootNow {
    ...
    public class RebootNowRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RebootNowRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
