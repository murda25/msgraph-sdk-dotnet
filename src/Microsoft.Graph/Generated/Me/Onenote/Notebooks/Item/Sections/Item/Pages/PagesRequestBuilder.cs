...
namespace Microsoft.Graph.Me.Onenote.Notebooks.Item.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.onenote.notebooks.item.sections.item.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
