...
using MicrosoftGraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item;
...
namespace MicrosoftGraphSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.onenote.notebooks.item.sectionGroups.item.sections.item collection</summary>
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook_id}/sectionGroups/{sectionGroup_id}/sections{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
