...
namespace Microsoft.Graph.Me.AssignLicense {
    ...
    public class AssignLicenseRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.User> PostAsync(AssignLicensePostRequestBody body, CancellationToken cancellationToken = default, Action<AssignLicenseRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
