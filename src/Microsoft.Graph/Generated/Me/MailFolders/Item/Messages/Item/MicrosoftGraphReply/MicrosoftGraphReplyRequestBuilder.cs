...
namespace Microsoft.Graph.Me.MailFolders.Item.Messages.Item.MicrosoftGraphReply {
    /// <summary>
    ...
    public class MicrosoftGraphReplyRequestBuilder {
        ...
        public MicrosoftGraphReplyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.reply";
