...
namespace Microsoft.Graph.Me.MailFolders.Item.Messages.Item.CreateReplyAll {
    ...
    public class CreateReplyAllRequestBuilder {
        ...
        /// </summary>
        public async Task<Message> PostAsync(CreateReplyAllPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateReplyAllRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
