...
namespace Microsoft.Graph.Me.MailFolders.Item.Messages.Item.CreateReplyAll {
    ...
    public class CreateReplyAllRequestBuilder {
        ...
        public CreateReplyAllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.createReplyAll";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Message> PostAsync(CreateReplyAllPostRequestBody body, Action<CreateReplyAllRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
