using Microsoft.Graph.Me.MailFolders.Item.Messages.Item.MultiValueExtendedProperties.Count;
using Microsoft.Graph.Me.MailFolders.Item.Messages.Item.MultiValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Me.MailFolders.Item.Messages.Item.MultiValueExtendedProperties {
    /// <summary>
    ...
    public class MultiValueExtendedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MultiValueExtendedPropertiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MultiValueExtendedPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
