...
namespace Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        public CopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/copy";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(CopyPostRequestBody body, Action<CopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(CopyPostRequestBody body, Action<CopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
