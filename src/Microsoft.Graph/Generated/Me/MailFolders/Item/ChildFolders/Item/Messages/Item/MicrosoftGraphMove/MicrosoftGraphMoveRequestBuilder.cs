...
namespace Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.MicrosoftGraphMove {
    /// <summary>
    ...
    public class MicrosoftGraphMoveRequestBuilder {
        ...
        public MicrosoftGraphMoveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/microsoft.graph.move";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(MovePostRequestBody body, Action<MicrosoftGraphMoveRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(MovePostRequestBody body, Action<MicrosoftGraphMoveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
