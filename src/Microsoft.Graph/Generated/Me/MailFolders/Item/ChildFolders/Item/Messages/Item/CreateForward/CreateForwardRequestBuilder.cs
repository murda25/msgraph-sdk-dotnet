...
namespace Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBuilder {
        ...
        public CreateForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createForward";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Message?> PostAsync(CreateForwardPostRequestBody body, Action<CreateForwardRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Message> PostAsync(CreateForwardPostRequestBody body, Action<CreateForwardRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
