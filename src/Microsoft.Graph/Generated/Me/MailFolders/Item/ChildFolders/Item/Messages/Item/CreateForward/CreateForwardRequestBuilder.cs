...
namespace Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBuilder {
        ...
        /// </summary>
        public async Task<Message> PostAsync(CreateForwardPostRequestBody body, CancellationToken cancellationToken = default, Action<CreateForwardRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
