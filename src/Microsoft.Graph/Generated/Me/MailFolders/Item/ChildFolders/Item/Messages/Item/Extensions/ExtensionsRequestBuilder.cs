...
namespace Microsoft.Graph.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.mailFolders.item.childFolders.item.messages.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
