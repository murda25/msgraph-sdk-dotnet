using Microsoft.Graph.Me.CalendarView.Item.Instances.Item.SingleValueExtendedProperties.Count;
using Microsoft.Graph.Me.CalendarView.Item.Instances.Item.SingleValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Me.CalendarView.Item.Instances.Item.SingleValueExtendedProperties {
    /// <summary>
    ...
    public class SingleValueExtendedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SingleValueExtendedPropertiesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SingleValueExtendedPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
