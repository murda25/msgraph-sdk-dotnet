...
using Microsoft.Graph.Me.CalendarView.Item.MicrosoftGraphAccept;
using Microsoft.Graph.Me.CalendarView.Item.MicrosoftGraphCancel;
using Microsoft.Graph.Me.CalendarView.Item.MicrosoftGraphDecline;
using Microsoft.Graph.Me.CalendarView.Item.MicrosoftGraphDismissReminder;
using Microsoft.Graph.Me.CalendarView.Item.MicrosoftGraphForward;
using Microsoft.Graph.Me.CalendarView.Item.MicrosoftGraphSnoozeReminder;
using Microsoft.Graph.Me.CalendarView.Item.MicrosoftGraphTentativelyAccept;
using Microsoft.Graph.Me.CalendarView.Item.MultiValueExtendedProperties;
using Microsoft.Graph.Me.CalendarView.Item.SingleValueExtendedProperties;
...
namespace Microsoft.Graph.Me.CalendarView.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarView/{event%2Did}{?startDateTime*,endDateTime*,%24select}";
