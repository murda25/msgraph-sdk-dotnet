...
namespace MicrosoftGraphSdk.Me.CalendarView.Item.Attachments.Item {
    /// <summary>Builds and executes requests for operations under \me\calendarView\{event-id}\attachments\{attachment-id}</summary>
    public class AttachmentRequestBuilder {
        ...
        public AttachmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarView/{event_id}/attachments/{attachment_id}{?select,expand}";
