...
namespace Microsoft.Graph.Me.Activities.Item.HistoryItems.Item.Activity {
    ...
    public class ActivityRequestBuilder {
        ...
        /// </summary>
        public async Task<UserActivity> GetAsync(CancellationToken cancellationToken = default, Action<ActivityRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
