...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.joinedTeams.item.operations.item collection</summary>
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
