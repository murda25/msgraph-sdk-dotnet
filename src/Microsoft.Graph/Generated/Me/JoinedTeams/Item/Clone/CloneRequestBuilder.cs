...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Clone {
    ...
    public class CloneRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ClonePostRequestBody body, CancellationToken cancellationToken = default, Action<CloneRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
