...
using MicrosoftGraphSdk.Me.JoinedTeams.Item.InstalledApps.Item.TeamsApp;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.InstalledApps.Item.TeamsAppDefinition;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.InstalledApps.Item.Upgrade;
...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.InstalledApps.Item {
    ...
    public class TeamsAppInstallationItemRequestBuilder {
        ...
        public TeamsAppInstallationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/installedApps/{teamsAppInstallation_id}{?select,expand}";
