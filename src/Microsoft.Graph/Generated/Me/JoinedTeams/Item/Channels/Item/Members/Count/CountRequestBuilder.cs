...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.Members.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/channels/{channel_id}/members/$count";
