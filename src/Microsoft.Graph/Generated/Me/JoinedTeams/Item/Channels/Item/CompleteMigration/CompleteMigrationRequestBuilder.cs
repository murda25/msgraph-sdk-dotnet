...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.CompleteMigration {
    ...
    public class CompleteMigrationRequestBuilder {
        ...
        public CompleteMigrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/channels/{channel_id}/microsoft.graph.completeMigration";
