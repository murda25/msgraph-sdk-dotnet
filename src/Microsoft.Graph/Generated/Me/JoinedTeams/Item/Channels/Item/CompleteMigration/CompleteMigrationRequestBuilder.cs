...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Channels.Item.CompleteMigration {
    ...
    public class CompleteMigrationRequestBuilder {
        ...
        public CompleteMigrationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/microsoft.graph.completeMigration";
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<CompleteMigrationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
