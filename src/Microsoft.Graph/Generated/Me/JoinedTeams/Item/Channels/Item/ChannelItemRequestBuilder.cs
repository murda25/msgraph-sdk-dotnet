...
using MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.CompleteMigration;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.FilesFolder;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.Members;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.Messages;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.ProvisionEmail;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.RemoveEmail;
using MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item.Tabs;
...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.Channels.Item {
    ...
    public class ChannelItemRequestBuilder {
        ...
        public ChannelItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/channels/{channel_id}{?select,expand}";
