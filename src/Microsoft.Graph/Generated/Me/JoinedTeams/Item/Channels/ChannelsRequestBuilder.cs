...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Channels {
    ...
    public class ChannelsRequestBuilder {
        ...
        /// </summary>
        public async Task<ChannelCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ChannelsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Channel> PostAsync(Channel body, CancellationToken cancellationToken = default, Action<ChannelsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
