...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Tags {
    ...
    public class TagsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.joinedTeams.item.tags.item collection</summary>
        ...
        public TagsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/tags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
