...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.Schedule.SchedulingGroups.Item {
    ...
    public class SchedulingGroupItemRequestBuilder {
        ...
        public SchedulingGroupItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/schedule/schedulingGroups/{schedulingGroup_id}{?select}";
