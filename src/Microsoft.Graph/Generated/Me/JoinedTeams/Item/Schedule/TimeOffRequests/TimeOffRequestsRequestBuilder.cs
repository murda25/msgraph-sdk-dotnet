...
namespace Microsoft.Graph.Me.JoinedTeams.Item.Schedule.TimeOffRequests {
    ...
    public class TimeOffRequestsRequestBuilder {
        ...
        /// </summary>
        public async Task<TimeOffRequestCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TimeOffRequestsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TimeOffRequest> PostAsync(TimeOffRequest body, CancellationToken cancellationToken = default, Action<TimeOffRequestsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
