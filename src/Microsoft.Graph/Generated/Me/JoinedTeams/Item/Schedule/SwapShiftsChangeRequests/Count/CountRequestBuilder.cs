...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.Schedule.SwapShiftsChangeRequests.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/schedule/swapShiftsChangeRequests/$count";
