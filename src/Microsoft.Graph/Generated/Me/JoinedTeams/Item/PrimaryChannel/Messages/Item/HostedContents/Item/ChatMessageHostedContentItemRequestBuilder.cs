...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentItemRequestBuilder {
        ...
        public ChatMessageHostedContentItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/hostedContents/{chatMessageHostedContent_id}{?select,expand}";
