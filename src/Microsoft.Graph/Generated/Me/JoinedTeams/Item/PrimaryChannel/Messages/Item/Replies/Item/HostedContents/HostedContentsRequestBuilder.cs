...
namespace Microsoft.Graph.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.joinedTeams.item.primaryChannel.messages.item.replies.item.hostedContents.item collection</summary>
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
