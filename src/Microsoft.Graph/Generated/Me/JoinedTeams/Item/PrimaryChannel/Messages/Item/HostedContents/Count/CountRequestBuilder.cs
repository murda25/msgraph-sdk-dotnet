...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.HostedContents.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/hostedContents/$count";
