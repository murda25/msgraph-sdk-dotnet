...
namespace MicrosoftGraphSdk.Me.JoinedTeams.Item.PrimaryChannel.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ConversationMember body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
