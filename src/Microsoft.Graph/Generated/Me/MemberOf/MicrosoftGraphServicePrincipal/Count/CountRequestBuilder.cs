...
namespace Microsoft.Graph.Me.MemberOf.MicrosoftGraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/memberOf/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
