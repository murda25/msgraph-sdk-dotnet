using Microsoft.Graph.Me.MemberOf.Application;
using Microsoft.Graph.Me.MemberOf.Count;
using Microsoft.Graph.Me.MemberOf.Device;
using Microsoft.Graph.Me.MemberOf.Group;
using Microsoft.Graph.Me.MemberOf.Item;
using Microsoft.Graph.Me.MemberOf.OrgContact;
using Microsoft.Graph.Me.MemberOf.ServicePrincipal;
using Microsoft.Graph.Me.MemberOf.User;
...
namespace Microsoft.Graph.Me.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.memberOf.item collection</summary>
