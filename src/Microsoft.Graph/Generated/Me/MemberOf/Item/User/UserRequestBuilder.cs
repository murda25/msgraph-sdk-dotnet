using Microsoft.Graph.Me.MemberOf.Item.User.AssignLicense;
using Microsoft.Graph.Me.MemberOf.Item.User.ChangePassword;
using Microsoft.Graph.Me.MemberOf.Item.User.CheckMemberGroups;
using Microsoft.Graph.Me.MemberOf.Item.User.CheckMemberObjects;
using Microsoft.Graph.Me.MemberOf.Item.User.ExportPersonalData;
using Microsoft.Graph.Me.MemberOf.Item.User.FindMeetingTimes;
using Microsoft.Graph.Me.MemberOf.Item.User.GetMailTips;
using Microsoft.Graph.Me.MemberOf.Item.User.GetManagedAppDiagnosticStatuses;
using Microsoft.Graph.Me.MemberOf.Item.User.GetManagedAppPolicies;
using Microsoft.Graph.Me.MemberOf.Item.User.GetMemberGroups;
using Microsoft.Graph.Me.MemberOf.Item.User.GetMemberObjects;
using Microsoft.Graph.Me.MemberOf.Item.User.ReminderViewWithStartDateTimeWithEndDateTime;
using Microsoft.Graph.Me.MemberOf.Item.User.RemoveAllDevicesFromManagement;
using Microsoft.Graph.Me.MemberOf.Item.User.ReprocessLicenseAssignment;
using Microsoft.Graph.Me.MemberOf.Item.User.Restore;
using Microsoft.Graph.Me.MemberOf.Item.User.RevokeSignInSessions;
using Microsoft.Graph.Me.MemberOf.Item.User.SendMail;
using Microsoft.Graph.Me.MemberOf.Item.User.TranslateExchangeIds;
using Microsoft.Graph.Me.MemberOf.Item.User.WipeManagedAppRegistrationsByDeviceTag;
...
namespace Microsoft.Graph.Me.MemberOf.Item.User {
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/memberOf/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
