...
namespace Microsoft.Graph.Me.MemberOf.MicrosoftGraphOrgContact.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/memberOf/microsoft.graph.orgContact/$count{?%24search,%24filter}";
