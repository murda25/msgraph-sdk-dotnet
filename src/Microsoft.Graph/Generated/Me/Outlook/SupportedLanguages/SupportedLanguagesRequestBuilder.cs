...
namespace Microsoft.Graph.Me.Outlook.SupportedLanguages {
    ...
    public class SupportedLanguagesRequestBuilder {
        ...
        /// </summary>
        public async Task<SupportedLanguagesResponse> GetAsync(Action<SupportedLanguagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<SupportedLanguagesResponse>(requestInfo, SupportedLanguagesResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
