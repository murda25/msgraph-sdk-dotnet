...
namespace Microsoft.Graph.Me.Outlook.SupportedLanguages {
    ...
    public class SupportedLanguagesRequestBuilder {
        ...
        /// </summary>
        public async Task<SupportedLanguagesResponse> GetAsync(CancellationToken cancellationToken = default, Action<SupportedLanguagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
