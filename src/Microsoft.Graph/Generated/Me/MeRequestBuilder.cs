...
namespace Microsoft.Graph.Me {
    ...
    public class MeRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.User> GetAsync(CancellationToken cancellationToken = default, Action<MeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.User body, CancellationToken cancellationToken = default, Action<MeRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
