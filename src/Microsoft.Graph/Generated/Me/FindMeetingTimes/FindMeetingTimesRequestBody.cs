...
namespace Microsoft.Graph.Me.FindMeetingTimes {
    ...
    public class FindMeetingTimesRequestBody : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.LocationConstraint LocationConstraint { get; set; }
        ...
        public Microsoft.Graph.Models.TimeConstraint TimeConstraint { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"locationConstraint", (o,n) => { (o as FindMeetingTimesRequestBody).LocationConstraint = n.GetObjectValue<Microsoft.Graph.Models.LocationConstraint>(Microsoft.Graph.Models.LocationConstraint.CreateFromDiscriminatorValue); } },
                ...
                {"timeConstraint", (o,n) => { (o as FindMeetingTimesRequestBody).TimeConstraint = n.GetObjectValue<Microsoft.Graph.Models.TimeConstraint>(Microsoft.Graph.Models.TimeConstraint.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
