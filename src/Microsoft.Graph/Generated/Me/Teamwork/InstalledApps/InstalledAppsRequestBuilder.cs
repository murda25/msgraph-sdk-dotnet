...
namespace MicrosoftGraphSdk.Me.Teamwork.InstalledApps {
    /// <summary>Builds and executes requests for operations under \me\teamwork\installedApps</summary>
    public class InstalledAppsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UserScopeTeamsAppInstallation body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
