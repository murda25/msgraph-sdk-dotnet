...
namespace MicrosoftGraphSdk.Me.Messages.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \me\messages\{message-id}\extensions\{extension-id}</summary>
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/messages/{message_id}/extensions/{extension_id}{?select,expand}";
