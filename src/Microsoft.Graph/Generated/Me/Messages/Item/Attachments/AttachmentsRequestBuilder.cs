...
using MicrosoftGraphSdk.Me.Messages.Item.Attachments.CreateUploadSession;
using MicrosoftGraphSdk.Me.Messages.Item.Attachments.Item;
...
namespace MicrosoftGraphSdk.Me.Messages.Item.Attachments {
    /// <summary>Builds and executes requests for operations under \me\messages\{message-id}\attachments</summary>
    public class AttachmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.messages.item.attachments.item collection</summary>
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/messages/{message_id}/attachments{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
