...
namespace Microsoft.Graph.Me.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBuilder {
        ...
        /// </summary>
        public async Task<Message> PostAsync(CreateForwardPostRequestBody body, Action<CreateForwardRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
