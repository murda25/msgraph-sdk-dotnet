using Microsoft.Graph.Me.Drives.Item.Items.Item.Children.Count;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Children.Item;
...
namespace Microsoft.Graph.Me.Drives.Item.Items.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.drives.item.items.item.children.item collection</summary>
        public Microsoft.Graph.Me.Drives.Item.Items.Item.Children.Item.DriveItemItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("driveItem%2Did1", position);
            return new Microsoft.Graph.Me.Drives.Item.Items.Item.Children.Item.DriveItemItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
