...
namespace Microsoft.Graph.Me.Drives.Item.Items.Item.ListItem.Versions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions/$count{?%24search,%24filter}";
