...
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Children;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Content;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.ListItem;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Permissions;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Subscriptions;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Thumbnails;
using MicrosoftGraphSdk.Me.Drives.Item.Items.Item.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Items.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/items/{driveItem_id}{?select,expand}";
