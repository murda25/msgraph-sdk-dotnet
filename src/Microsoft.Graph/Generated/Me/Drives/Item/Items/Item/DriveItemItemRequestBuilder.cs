using Microsoft.Graph.Me.Drives.Item.Items.Item.Analytics;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Checkin;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Checkout;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Children;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Content;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Copy;
using Microsoft.Graph.Me.Drives.Item.Items.Item.CreateLink;
using Microsoft.Graph.Me.Drives.Item.Items.Item.CreateUploadSession;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Delta;
using Microsoft.Graph.Me.Drives.Item.Items.Item.DeltaWithToken;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Follow;
using Microsoft.Graph.Me.Drives.Item.Items.Item.GetActivitiesByInterval;
using Microsoft.Graph.Me.Drives.Item.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Invite;
using Microsoft.Graph.Me.Drives.Item.Items.Item.ListItem;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Permissions;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Preview;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Restore;
using Microsoft.Graph.Me.Drives.Item.Items.Item.SearchWithQ;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Subscriptions;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Thumbnails;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Unfollow;
using Microsoft.Graph.Me.Drives.Item.Items.Item.ValidatePermission;
using Microsoft.Graph.Me.Drives.Item.Items.Item.Versions;
...
namespace Microsoft.Graph.Me.Drives.Item.Items.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> GetAsync(Action<DriveItemItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.DriveItem> PatchAsync(Microsoft.Graph.Models.DriveItem body, Action<DriveItemItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
