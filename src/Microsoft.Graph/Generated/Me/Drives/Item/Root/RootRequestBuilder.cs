...
using MicrosoftGraphSdk.Me.Drives.Item.Root.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.Root.Children;
using MicrosoftGraphSdk.Me.Drives.Item.Root.Content;
using MicrosoftGraphSdk.Me.Drives.Item.Root.ListItem;
using MicrosoftGraphSdk.Me.Drives.Item.Root.Permissions;
using MicrosoftGraphSdk.Me.Drives.Item.Root.Subscriptions;
using MicrosoftGraphSdk.Me.Drives.Item.Root.Thumbnails;
using MicrosoftGraphSdk.Me.Drives.Item.Root.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Root {
    ...
    public class RootRequestBuilder {
        ...
        public RootRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/root{?select,expand}";
