...
namespace Microsoft.Graph.Me.Drives.Item.Root.ListItem.DocumentSetVersions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/documentSetVersions/$count{?%24search,%24filter}";
