using Microsoft.Graph.Me.Drives.Item.Root.ListItem.DocumentSetVersions.Item.Restore;
...
namespace Microsoft.Graph.Me.Drives.Item.Root.ListItem.DocumentSetVersions.Item {
    /// <summary>
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
