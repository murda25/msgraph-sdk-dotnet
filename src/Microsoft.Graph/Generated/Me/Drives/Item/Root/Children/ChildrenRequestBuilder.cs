using Microsoft.Graph.Me.Drives.Item.Root.Children.Count;
using Microsoft.Graph.Me.Drives.Item.Root.Children.Item;
...
namespace Microsoft.Graph.Me.Drives.Item.Root.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.drives.item.root.children.item collection</summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/root/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
