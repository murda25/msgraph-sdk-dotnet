...
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.Fields;
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.GetActivitiesByInterval;
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Bundles.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/bundles/{driveItem_id}/listItem{?select,expand}";
