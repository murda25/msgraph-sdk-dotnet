using Microsoft.Graph.Me.Drives.Item.List.Columns.Count;
using Microsoft.Graph.Me.Drives.Item.List.Columns.Item;
...
namespace Microsoft.Graph.Me.Drives.Item.List.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.drives.item.list.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
