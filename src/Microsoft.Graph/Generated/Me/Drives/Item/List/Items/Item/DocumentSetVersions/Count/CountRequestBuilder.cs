...
namespace Microsoft.Graph.Me.Drives.Item.List.Items.Item.DocumentSetVersions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/$count{?%24search,%24filter}";
