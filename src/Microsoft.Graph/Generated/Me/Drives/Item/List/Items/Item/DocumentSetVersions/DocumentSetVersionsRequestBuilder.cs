using Microsoft.Graph.Me.Drives.Item.List.Items.Item.DocumentSetVersions.Count;
using Microsoft.Graph.Me.Drives.Item.List.Items.Item.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Me.Drives.Item.List.Items.Item.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.drives.item.list.items.item.documentSetVersions.item collection</summary>
        ...
        public DocumentSetVersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
