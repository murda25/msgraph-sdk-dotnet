...
namespace Microsoft.Graph.Me.Drives.Item.List.ContentTypes.Item.ColumnPositions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnPositions/$count{?%24search,%24filter}";
