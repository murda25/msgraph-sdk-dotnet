...
namespace Microsoft.Graph.Me.Drives.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        /// </summary>
        public async Task<ContentTypeCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ContentTypesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ContentType> PostAsync(ContentType body, CancellationToken cancellationToken = default, Action<ContentTypesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
