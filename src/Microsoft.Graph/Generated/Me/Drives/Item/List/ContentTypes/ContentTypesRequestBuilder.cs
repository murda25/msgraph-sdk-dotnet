using Microsoft.Graph.Me.Drives.Item.List.ContentTypes.AddCopy;
using Microsoft.Graph.Me.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub;
using Microsoft.Graph.Me.Drives.Item.List.ContentTypes.Count;
using Microsoft.Graph.Me.Drives.Item.List.ContentTypes.GetCompatibleHubContentTypes;
using Microsoft.Graph.Me.Drives.Item.List.ContentTypes.Item;
...
namespace Microsoft.Graph.Me.Drives.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.drives.item.list.contentTypes.item collection</summary>
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<ContentTypeCollectionResponse> GetAsync(Action<ContentTypesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ContentType> PostAsync(ContentType body, Action<ContentTypesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
