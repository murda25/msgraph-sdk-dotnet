using Microsoft.Graph.Me.Drives.Item.Following.Item.Content;
...
namespace Microsoft.Graph.Me.Drives.Item.Following.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/following/{driveItem%2Did}{?%24select,%24expand}";
