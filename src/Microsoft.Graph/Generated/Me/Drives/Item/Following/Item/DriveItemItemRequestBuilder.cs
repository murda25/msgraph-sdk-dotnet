...
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Analytics;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Children;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Content;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.ListItem;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Permissions;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Subscriptions;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Thumbnails;
using MicrosoftGraphSdk.Me.Drives.Item.Following.Item.Versions;
...
namespace MicrosoftGraphSdk.Me.Drives.Item.Following.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/following/{driveItem_id}{?select,expand}";
        ...
        /// <summary>
        /// Delete navigation property following for me
        ...
        /// <summary>
        /// Update the navigation property following in me
