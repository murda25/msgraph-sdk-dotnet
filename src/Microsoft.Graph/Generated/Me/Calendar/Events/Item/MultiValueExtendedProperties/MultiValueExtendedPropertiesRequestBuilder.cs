...
using MicrosoftGraphSdk.Me.Calendar.Events.Item.MultiValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Me.Calendar.Events.Item.MultiValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\calendar\events\{event-id}\multiValueExtendedProperties</summary>
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendar.events.item.multiValueExtendedProperties.item collection</summary>
