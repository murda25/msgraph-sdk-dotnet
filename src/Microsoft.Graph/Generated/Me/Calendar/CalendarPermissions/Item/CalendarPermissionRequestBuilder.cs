...
namespace MicrosoftGraphSdk.Me.Calendar.CalendarPermissions.Item {
    /// <summary>Builds and executes requests for operations under \me\calendar\calendarPermissions\{calendarPermission-id}</summary>
    public class CalendarPermissionRequestBuilder {
        ...
        public CalendarPermissionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/calendarPermissions/{calendarPermission_id}{?select}";
