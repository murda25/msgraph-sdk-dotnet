...
using MicrosoftGraphSdk.Me.Calendar.CalendarView.Item.Extensions.Item;
...
namespace MicrosoftGraphSdk.Me.Calendar.CalendarView.Item.Extensions {
    /// <summary>Builds and executes requests for operations under \me\calendar\calendarView\{event-id}\extensions</summary>
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendar.calendarView.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/calendarView/{event_id}/extensions{?top,skip,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
