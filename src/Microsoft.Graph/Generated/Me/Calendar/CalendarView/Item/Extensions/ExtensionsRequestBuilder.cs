...
namespace Microsoft.Graph.Me.Calendar.CalendarView.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.calendar.calendarView.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/calendarView/{event%2Did}/extensions{?%24top*,%24skip*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
