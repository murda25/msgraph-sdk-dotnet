...
namespace Microsoft.Graph.Me.OwnedObjects.Item.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/ownedObjects/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
