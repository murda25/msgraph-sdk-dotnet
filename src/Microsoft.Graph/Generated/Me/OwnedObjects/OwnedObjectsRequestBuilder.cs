using Microsoft.Graph.Me.OwnedObjects.Application;
using Microsoft.Graph.Me.OwnedObjects.Count;
using Microsoft.Graph.Me.OwnedObjects.Group;
using Microsoft.Graph.Me.OwnedObjects.Item;
using Microsoft.Graph.Me.OwnedObjects.ServicePrincipal;
...
namespace Microsoft.Graph.Me.OwnedObjects {
    ...
    public class OwnedObjectsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.ownedObjects.item collection</summary>
        ...
        public OwnedObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<OwnedObjectsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
