...
namespace Microsoft.Graph.Me.OwnedObjects {
    ...
    public class OwnedObjectsRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<OwnedObjectsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
