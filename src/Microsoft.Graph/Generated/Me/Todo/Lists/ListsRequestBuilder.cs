...
namespace Microsoft.Graph.Me.Todo.Lists {
    ...
    public class ListsRequestBuilder {
        ...
        /// </summary>
        public async Task<TodoTaskListCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ListsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TodoTaskList> PostAsync(TodoTaskList body, CancellationToken cancellationToken = default, Action<ListsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
