...
namespace Microsoft.Graph.Me.Todo.Lists.Item.Tasks.Item.AttachmentSessions {
    ...
    public class AttachmentSessionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.todo.lists.item.tasks.item.attachmentSessions.item collection</summary>
        ...
        public AttachmentSessionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachmentSessions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AttachmentSession body, Action<AttachmentSessionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new AttachmentSessionsRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
        ...
        /// </summary>
        public async Task<AttachmentSessionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AttachmentSessionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AttachmentSession> PostAsync(AttachmentSession body, CancellationToken cancellationToken = default, Action<AttachmentSessionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Get attachmentSessions from me</summary>
        ...
        /// <summary>Configuration for the request such as headers, query parameters, and middleware options.</summary>
        public class AttachmentSessionsRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public IDictionary<string, string> Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new attachmentSessionsRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public AttachmentSessionsRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new Dictionary<string, string>();
            }
        }
