...
using MicrosoftGraphSdk.Me.Todo.Lists.Item.Extensions.Item;
...
namespace MicrosoftGraphSdk.Me.Todo.Lists.Item.Extensions {
    /// <summary>Builds and executes requests for operations under \me\todo\lists\{todoTaskList-id}\extensions</summary>
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.todo.lists.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/todo/lists/{todoTaskList_id}/extensions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
