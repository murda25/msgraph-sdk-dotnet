...
namespace Microsoft.Graph.Me.CreatedObjects.MicrosoftGraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/createdObjects/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
