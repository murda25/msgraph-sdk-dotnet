...
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Delta;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item;
...
namespace MicrosoftGraphSdk.Me.Calendars.Item.Events {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\events</summary>
    public class EventsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendars.item.events.item collection</summary>
        ...
        public EventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
