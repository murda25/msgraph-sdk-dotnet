using Microsoft.Graph.Me.Calendars.Item.Events.Item.MultiValueExtendedProperties.Count;
using Microsoft.Graph.Me.Calendars.Item.Events.Item.MultiValueExtendedProperties.Item;
...
using System;
namespace Microsoft.Graph.Me.Calendars.Item.Events.Item.MultiValueExtendedProperties {
    /// <summary>
    ...
    public class MultiValueExtendedPropertiesRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MultiValueExtendedPropertiesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/me/calendars/{calendar%2Did}/events/{event%2Did}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
