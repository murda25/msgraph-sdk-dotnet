...
namespace MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Attachments.Item {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\events\{event-id}\attachments\{attachment-id}</summary>
    public class AttachmentRequestBuilder {
        ...
        public AttachmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/attachments/{attachment_id}{?select,expand}";
