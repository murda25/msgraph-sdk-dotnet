using Microsoft.Graph.Me.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties.Count;
using Microsoft.Graph.Me.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties.Item;
...
namespace Microsoft.Graph.Me.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.me.calendars.item.events.item.instances.item.singleValueExtendedProperties.item collection</summary>
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
