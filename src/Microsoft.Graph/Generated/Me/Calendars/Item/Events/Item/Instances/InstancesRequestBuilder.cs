...
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Instances.Delta;
using MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Instances.Item;
...
namespace MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Instances {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\events\{event-id}\instances</summary>
    public class InstancesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendars.item.events.item.instances.item collection</summary>
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/instances{?top,skip,filter,count,orderby,select}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
