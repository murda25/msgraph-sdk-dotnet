...
namespace MicrosoftGraphSdk.Me.Calendars.Item.Events.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\events\{event-id}\extensions\{extension-id}</summary>
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/extensions/{extension_id}{?select,expand}";
