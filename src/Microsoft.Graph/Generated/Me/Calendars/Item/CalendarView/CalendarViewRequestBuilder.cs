...
using MicrosoftGraphSdk.Me.Calendars.Item.CalendarView.Delta;
using MicrosoftGraphSdk.Me.Calendars.Item.CalendarView.Item;
...
namespace MicrosoftGraphSdk.Me.Calendars.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendars.item.calendarView.item collection</summary>
