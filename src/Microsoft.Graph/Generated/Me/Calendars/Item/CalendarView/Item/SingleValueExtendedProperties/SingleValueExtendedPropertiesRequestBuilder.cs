...
using MicrosoftGraphSdk.Me.Calendars.Item.CalendarView.Item.SingleValueExtendedProperties.Item;
...
namespace MicrosoftGraphSdk.Me.Calendars.Item.CalendarView.Item.SingleValueExtendedProperties {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}\singleValueExtendedProperties</summary>
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.me.calendars.item.calendarView.item.singleValueExtendedProperties.item collection</summary>
