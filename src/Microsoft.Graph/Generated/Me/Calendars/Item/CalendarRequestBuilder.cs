...
using MicrosoftGraphSdk.Me.Calendars.Item.AllowedCalendarSharingRolesWithUser;
using MicrosoftGraphSdk.Me.Calendars.Item.CalendarPermissions;
using MicrosoftGraphSdk.Me.Calendars.Item.CalendarView;
using MicrosoftGraphSdk.Me.Calendars.Item.Events;
using MicrosoftGraphSdk.Me.Calendars.Item.GetSchedule;
using MicrosoftGraphSdk.Me.Calendars.Item.MultiValueExtendedProperties;
using MicrosoftGraphSdk.Me.Calendars.Item.SingleValueExtendedProperties;
...
namespace MicrosoftGraphSdk.Me.Calendars.Item {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}</summary>
