...
using System.IO;
using System.Linq;
namespace MicrosoftGraphSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties {
    /// <summary>Provides operations to call the getAvailableExtensionProperties method.</summary>
    public class GetAvailableExtensionPropertiesResponse : IParsable, IAdditionalDataHolder {
