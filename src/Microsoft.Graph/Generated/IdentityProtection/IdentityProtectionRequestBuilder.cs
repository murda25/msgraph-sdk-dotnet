...
namespace Microsoft.Graph.IdentityProtection {
    ...
    public class IdentityProtectionRequestBuilder {
        ...
        /// </summary>
        public async Task<IdentityProtectionRoot> GetAsync(CancellationToken cancellationToken = default, Action<IdentityProtectionRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(IdentityProtectionRoot body, CancellationToken cancellationToken = default, Action<IdentityProtectionRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
