...
namespace Microsoft.Graph.IdentityProtection {
    ...
    public class IdentityProtectionRequestBuilder {
        ...
        /// </summary>
        public async Task<IdentityProtectionRoot> GetAsync(Action<IdentityProtectionRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IdentityProtectionRoot> PatchAsync(IdentityProtectionRoot body, Action<IdentityProtectionRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
