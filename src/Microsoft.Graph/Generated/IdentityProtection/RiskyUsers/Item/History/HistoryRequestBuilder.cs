...
namespace Microsoft.Graph.IdentityProtection.RiskyUsers.Item.History {
    ...
    public class HistoryRequestBuilder {
        ...
        /// </summary>
        public async Task<RiskyUserHistoryItemCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<HistoryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RiskyUserHistoryItem> PostAsync(RiskyUserHistoryItem body, CancellationToken cancellationToken = default, Action<HistoryRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
