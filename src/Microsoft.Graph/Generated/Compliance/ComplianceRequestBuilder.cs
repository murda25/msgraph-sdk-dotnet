...
namespace Microsoft.Graph.Compliance {
    ...
    public class ComplianceRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Compliance> GetAsync(CancellationToken cancellationToken = default, Action<ComplianceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Compliance body, CancellationToken cancellationToken = default, Action<ComplianceRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
