...
namespace Microsoft.Graph.Compliance {
    ...
    public class ComplianceRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<ComplianceRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Compliance> GetAsync(Action<ComplianceRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Compliance> PatchAsync(Microsoft.Graph.Models.Compliance body, Action<ComplianceRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
