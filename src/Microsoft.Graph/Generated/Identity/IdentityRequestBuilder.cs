...
namespace Microsoft.Graph.Identity {
    ...
    public class IdentityRequestBuilder {
        ...
        /// </summary>
        public async Task<IdentityContainer> GetAsync(CancellationToken cancellationToken = default, Action<IdentityRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(IdentityContainer body, CancellationToken cancellationToken = default, Action<IdentityRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
