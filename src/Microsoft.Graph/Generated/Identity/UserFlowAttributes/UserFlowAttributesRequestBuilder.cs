...
namespace MicrosoftGraphSdk.Identity.UserFlowAttributes {
    ...
    public class UserFlowAttributesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(IdentityUserFlowAttribute body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
