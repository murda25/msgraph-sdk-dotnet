...
namespace Microsoft.Graph.Identity.B2xUserFlows.Item.Languages {
    ...
    public class LanguagesRequestBuilder {
        ...
        /// </summary>
        public async Task<UserFlowLanguageConfigurationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UserFlowLanguageConfiguration> PostAsync(UserFlowLanguageConfiguration body, CancellationToken cancellationToken = default, Action<LanguagesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
