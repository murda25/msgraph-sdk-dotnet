...
namespace MicrosoftGraphSdk.Identity.ConditionalAccess.NamedLocations {
    ...
    public class NamedLocationsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(NamedLocation body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
