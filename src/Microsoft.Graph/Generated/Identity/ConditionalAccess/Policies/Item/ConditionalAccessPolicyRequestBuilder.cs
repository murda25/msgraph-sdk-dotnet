...
namespace MicrosoftGraphSdk.Identity.ConditionalAccess.Policies.Item {
    /// <summary>Builds and executes requests for operations under \identity\conditionalAccess\policies\{conditionalAccessPolicy-id}</summary>
    public class ConditionalAccessPolicyRequestBuilder {
        ...
        /// </summary>
        public ConditionalAccessPolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ConditionalAccessPolicyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ConditionalAccessPolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
