...
namespace Microsoft.Graph.Teams {
    ...
    public class TeamsRequestBuilder {
        ...
        /// </summary>
        public async Task<TeamCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TeamsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Team> PostAsync(Microsoft.Graph.Models.Team body, CancellationToken cancellationToken = default, Action<TeamsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
