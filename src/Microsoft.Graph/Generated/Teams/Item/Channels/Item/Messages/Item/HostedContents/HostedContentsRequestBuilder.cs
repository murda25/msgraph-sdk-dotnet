...
using MicrosoftGraphSdk.Teams.Item.Channels.Item.Messages.Item.HostedContents.Item;
using System;
...
namespace MicrosoftGraphSdk.Teams.Item.Channels.Item.Messages.Item.HostedContents {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\channels\{channel-id}\messages\{chatMessage-id}\hostedContents</summary>
    public class HostedContentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.teams.item.channels.item.messages.item.hostedContents.item collection</summary>
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/channels/{channel_id}/messages/{chatMessage_id}/hostedContents{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
