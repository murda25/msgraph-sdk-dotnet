...
using Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.MicrosoftGraphSoftDelete;
using Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item.MicrosoftGraphUndoSoftDelete;
...
namespace Microsoft.Graph.Teams.Item.Channels.Item.Messages.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}";
