...
namespace Microsoft.Graph.Teams.Item.PrimaryChannel.SharedWithTeams.Item.AllowedMembers.Item {
    ...
    public class ConversationMemberItemRequestBuilder {
        ...
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers/{conversationMember%2Did}{?%24select,%24expand}";
