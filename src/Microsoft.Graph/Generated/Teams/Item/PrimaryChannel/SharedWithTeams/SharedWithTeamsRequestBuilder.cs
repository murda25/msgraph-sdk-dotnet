...
namespace Microsoft.Graph.Teams.Item.PrimaryChannel.SharedWithTeams {
    ...
    public class SharedWithTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.teams.item.primaryChannel.sharedWithTeams.item collection</summary>
        ...
        public SharedWithTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
