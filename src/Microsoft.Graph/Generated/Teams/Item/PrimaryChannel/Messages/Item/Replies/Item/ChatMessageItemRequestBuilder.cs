...
using MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item.HostedContents;
using System;
...
namespace MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies/{chatMessage_id1}{?select,expand}";
