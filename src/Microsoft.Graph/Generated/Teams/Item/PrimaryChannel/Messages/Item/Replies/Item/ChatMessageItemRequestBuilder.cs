...
using Microsoft.Graph.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item.MicrosoftGraphSoftDelete;
using Microsoft.Graph.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item.MicrosoftGraphUndoSoftDelete;
...
namespace Microsoft.Graph.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}";
