...
namespace Microsoft.Graph.Teams.Item.PrimaryChannel.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.teams.item.primaryChannel.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
