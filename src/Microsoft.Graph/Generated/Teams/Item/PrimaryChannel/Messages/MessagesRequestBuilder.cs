...
using MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Messages.Delta;
using MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Messages.Item;
using System;
...
namespace MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Messages {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\primaryChannel\messages</summary>
    public class MessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.teams.item.primaryChannel.messages.item collection</summary>
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/primaryChannel/messages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
