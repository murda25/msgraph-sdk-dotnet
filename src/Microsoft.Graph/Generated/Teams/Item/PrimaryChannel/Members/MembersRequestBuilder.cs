...
using MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Members.Add;
using MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Members.Item;
using System;
...
namespace MicrosoftGraphSdk.Teams.Item.PrimaryChannel.Members {
    ...
    public class MembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.teams.item.primaryChannel.members.item collection</summary>
