...
namespace Microsoft.Graph.Teams.Item.PrimaryChannel.Tabs {
    ...
    public class TabsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.teams.item.primaryChannel.tabs.item collection</summary>
        ...
        public TabsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/primaryChannel/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
