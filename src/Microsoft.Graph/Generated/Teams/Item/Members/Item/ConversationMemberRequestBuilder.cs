...
namespace MicrosoftGraphSdk.Teams.Item.Members.Item {
    /// <summary>Builds and executes requests for operations under \teams\{team-id}\members\{conversationMember-id}</summary>
    public class ConversationMemberRequestBuilder {
        ...
        public ConversationMemberRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team_id}/members/{conversationMember_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ConversationMemberRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
