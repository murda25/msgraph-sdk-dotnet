...
namespace Microsoft.Graph.Teams.Item.Clone {
    ...
    public class CloneRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CloneRequestBody body, Action<CloneRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
