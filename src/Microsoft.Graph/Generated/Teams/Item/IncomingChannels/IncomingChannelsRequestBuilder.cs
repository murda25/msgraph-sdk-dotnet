...
namespace Microsoft.Graph.Teams.Item.IncomingChannels {
    ...
    public class IncomingChannelsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.teams.item.incomingChannels.item collection</summary>
        ...
        public IncomingChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// </summary>
        public async Task<ChannelCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<IncomingChannelsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
