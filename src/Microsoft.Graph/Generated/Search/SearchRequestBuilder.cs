...
namespace Microsoft.Graph.Search {
    ...
    public class SearchRequestBuilder {
        ...
        /// </summary>
        public async Task<SearchEntity> GetAsync(CancellationToken cancellationToken = default, Action<SearchRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SearchEntity body, CancellationToken cancellationToken = default, Action<SearchRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
