...
using MicrosoftGraphSdk.Agreements.Item.Files.Item.Versions;
...
namespace MicrosoftGraphSdk.Agreements.Item.Files.Item {
    ...
    public class AgreementFileLocalizationRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AgreementFileLocalizationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
