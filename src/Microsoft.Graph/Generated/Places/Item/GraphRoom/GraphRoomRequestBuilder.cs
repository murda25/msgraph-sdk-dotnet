...
namespace Microsoft.Graph.Places.Item.GraphRoom {
    ...
    public class GraphRoomRequestBuilder {
        ...
        public GraphRoomRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/places/{place%2Did}/graph.room{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GraphRoomRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
