...
namespace Microsoft.Graph.Security.Alerts_v2.Item.Comments.Count {
    ...
    public class CountRequestBuilder : BaseRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/alerts_v2/{alert%2Did}/comments/$count{?%24search,%24filter}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/alerts_v2/{alert%2Did}/comments/$count{?%24search,%24filter}", rawUrl) {
        }
        /// <summary>
