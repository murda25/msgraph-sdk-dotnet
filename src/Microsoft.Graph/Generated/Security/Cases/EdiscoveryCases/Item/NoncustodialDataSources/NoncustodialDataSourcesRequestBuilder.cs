...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources.ApplyHold;
...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources.RemoveHold;
...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources {
    ...
    public class NoncustodialDataSourcesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.security.cases.ediscoveryCases.item.noncustodialDataSources.item collection</summary>
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<NoncustodialDataSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EdiscoveryNoncustodialDataSource body, Action<NoncustodialDataSourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<EdiscoveryNoncustodialDataSourceCollectionResponse> GetAsync(Action<NoncustodialDataSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<EdiscoveryNoncustodialDataSourceCollectionResponse>(requestInfo, EdiscoveryNoncustodialDataSourceCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create a new ediscoveryNoncustodialDataSource object.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EdiscoveryNoncustodialDataSource> PostAsync(EdiscoveryNoncustodialDataSource body, Action<NoncustodialDataSourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
