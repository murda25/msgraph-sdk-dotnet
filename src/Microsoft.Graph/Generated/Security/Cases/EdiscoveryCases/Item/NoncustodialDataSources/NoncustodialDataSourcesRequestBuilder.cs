...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources {
    ...
    public class NoncustodialDataSourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<EdiscoveryNoncustodialDataSourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EdiscoveryNoncustodialDataSource> PostAsync(EdiscoveryNoncustodialDataSource body, CancellationToken cancellationToken = default, Action<NoncustodialDataSourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
