...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Settings.SecurityResetToDefault {
    /// <summary>
    ...
    public class SecurityResetToDefaultRequestBuilder {
        ...
        public SecurityResetToDefaultRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityResetToDefaultRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
