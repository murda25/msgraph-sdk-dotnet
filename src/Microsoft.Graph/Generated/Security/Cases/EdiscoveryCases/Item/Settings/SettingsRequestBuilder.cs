...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Settings.ResetToDefault;
...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Settings {
    ...
    public class SettingsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(EdiscoveryCaseSettings body, Action<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EdiscoveryCaseSettings> GetAsync(CancellationToken cancellationToken = default, Action<SettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(EdiscoveryCaseSettings body, CancellationToken cancellationToken = default, Action<SettingsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
