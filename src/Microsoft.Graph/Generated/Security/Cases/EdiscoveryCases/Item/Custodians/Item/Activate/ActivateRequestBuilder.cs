...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.Activate {
    ...
    public class ActivateRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<ActivateRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
