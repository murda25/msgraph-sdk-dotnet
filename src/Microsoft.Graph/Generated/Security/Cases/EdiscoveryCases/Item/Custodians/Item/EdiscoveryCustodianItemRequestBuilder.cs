...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.Activate;
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.ApplyHold;
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.LastIndexOperation;
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.Release;
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.RemoveHold;
...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.UpdateIndex;
...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item {
    ...
    public class EdiscoveryCustodianItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<EdiscoveryCustodianItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EdiscoveryCustodian> GetAsync(CancellationToken cancellationToken = default, Action<EdiscoveryCustodianItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(EdiscoveryCustodian body, CancellationToken cancellationToken = default, Action<EdiscoveryCustodianItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
