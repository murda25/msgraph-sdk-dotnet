...
using System;
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SecurityUpdateIndex {
    /// <summary>
    ...
    public class SecurityUpdateIndexRequestBuilder : BaseRequestBuilder {
        ...
        public SecurityUpdateIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.updateIndex", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SecurityUpdateIndexRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityUpdateIndexRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.updateIndex", rawUrl) {
        }
        /// <summary>
