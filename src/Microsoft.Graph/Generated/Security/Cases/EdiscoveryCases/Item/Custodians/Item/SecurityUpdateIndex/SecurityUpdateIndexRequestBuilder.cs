...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SecurityUpdateIndex {
    ...
    public class SecurityUpdateIndexRequestBuilder {
        ...
        public SecurityUpdateIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.updateIndex";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityUpdateIndexRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
