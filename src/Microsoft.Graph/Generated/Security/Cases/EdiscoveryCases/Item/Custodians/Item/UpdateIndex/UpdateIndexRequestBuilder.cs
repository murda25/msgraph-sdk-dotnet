...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.Item.UpdateIndex {
    ...
    public class UpdateIndexRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<UpdateIndexRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
