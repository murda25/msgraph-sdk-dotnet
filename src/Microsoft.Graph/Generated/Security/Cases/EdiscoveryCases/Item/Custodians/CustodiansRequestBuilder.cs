...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.ApplyHold;
...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians.RemoveHold;
...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Custodians {
    ...
    public class CustodiansRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.security.cases.ediscoveryCases.item.custodians.item collection</summary>
        ...
        /// </summary>
        public async Task<EdiscoveryCustodianCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<CustodiansRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EdiscoveryCustodian> PostAsync(EdiscoveryCustodian body, CancellationToken cancellationToken = default, Action<CustodiansRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
