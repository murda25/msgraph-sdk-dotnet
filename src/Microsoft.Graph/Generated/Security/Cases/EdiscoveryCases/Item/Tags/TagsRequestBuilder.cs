...
using Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Tags.AsHierarchy;
...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Tags {
    ...
    public class TagsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.security.cases.ediscoveryCases.item.tags.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EdiscoveryReviewTag body, Action<TagsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<EdiscoveryReviewTagCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<TagsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EdiscoveryReviewTag> PostAsync(EdiscoveryReviewTag body, CancellationToken cancellationToken = default, Action<TagsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
