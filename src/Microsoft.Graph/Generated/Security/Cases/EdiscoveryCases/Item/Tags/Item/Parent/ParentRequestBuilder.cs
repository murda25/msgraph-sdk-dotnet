...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Tags.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        public ParentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}/parent{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<EdiscoveryReviewTag> GetAsync(CancellationToken cancellationToken = default, Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
