...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Tags.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        public async Task<EdiscoveryReviewTag> GetAsync(Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
