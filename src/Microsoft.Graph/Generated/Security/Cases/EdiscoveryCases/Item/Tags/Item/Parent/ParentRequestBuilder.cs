...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.Tags.Item.Parent {
    ...
    public class ParentRequestBuilder {
        ...
        /// </summary>
        public async Task<EdiscoveryReviewTag> GetAsync(Action<ParentRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
