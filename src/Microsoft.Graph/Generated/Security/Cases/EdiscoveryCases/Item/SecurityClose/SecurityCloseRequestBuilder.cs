...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.SecurityClose {
    /// <summary>
    /// Provides operations to call the close method.
    /// </summary>
    public class SecurityCloseRequestBuilder {
        ...
        public SecurityCloseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/security.close";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecurityCloseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
