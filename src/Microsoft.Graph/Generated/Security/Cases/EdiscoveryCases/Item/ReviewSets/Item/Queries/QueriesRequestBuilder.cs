...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.Queries {
    ...
    public class QueriesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.security.cases.ediscoveryCases.item.reviewSets.item.queries.item collection</summary>
        ...
        /// </summary>
        public async Task<EdiscoveryReviewSetQueryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<QueriesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<EdiscoveryReviewSetQueryCollectionResponse>(requestInfo, EdiscoveryReviewSetQueryCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to queries for security
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EdiscoveryReviewSetQuery> PostAsync(EdiscoveryReviewSetQuery body, CancellationToken cancellationToken = default, Action<QueriesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
