...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.MicrosoftGraphSecurityAddToReviewSet {
    ...
    public class MicrosoftGraphSecurityAddToReviewSetRequestBuilder {
        ...
        public MicrosoftGraphSecurityAddToReviewSetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSecurityAddToReviewSetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
