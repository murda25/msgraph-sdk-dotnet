...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.AddToReviewSet {
    ...
    public class AddToReviewSetRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddToReviewSetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(AddToReviewSetPostRequestBody body, Action<AddToReviewSetRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(AddToReviewSetPostRequestBody body, Action<AddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(AddToReviewSetPostRequestBody body, Action<AddToReviewSetRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(AddToReviewSetPostRequestBody body, Action<AddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
