...
namespace Microsoft.Graph.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.AddToReviewSet {
    ...
    public class AddToReviewSetRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(AddToReviewSetPostRequestBody body, Action<AddToReviewSetRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
