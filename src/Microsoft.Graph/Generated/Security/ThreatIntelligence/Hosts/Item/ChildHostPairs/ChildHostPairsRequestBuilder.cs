...
namespace Microsoft.Graph.Security.ThreatIntelligence.Hosts.Item.ChildHostPairs {
    ...
    public class ChildHostPairsRequestBuilder : BaseRequestBuilder {
        ...
        public ChildHostPairsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/childHostPairs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChildHostPairsRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<HostPairCollectionResponse?> GetAsync(Action<ChildHostPairsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<HostPairCollectionResponse> GetAsync(Action<ChildHostPairsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ChildHostPairsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ChildHostPairsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ChildHostPairsRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class ChildHostPairsRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public ChildHostPairsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ChildHostPairsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new childHostPairsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public ChildHostPairsRequestBuilderGetRequestConfiguration() {
