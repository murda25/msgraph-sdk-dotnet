...
namespace Microsoft.Graph.Security.ThreatIntelligence.Hosts.Item.ChildHostPairs.Item {
    ...
    public class HostPairItemRequestBuilder : BaseRequestBuilder {
        ...
        public HostPairItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/childHostPairs/{hostPair%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HostPairItemRequestBuilder and sets the default values.
        /// </summary>
