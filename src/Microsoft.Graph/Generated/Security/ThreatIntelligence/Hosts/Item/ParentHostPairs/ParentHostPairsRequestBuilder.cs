...
namespace Microsoft.Graph.Security.ThreatIntelligence.Hosts.Item.ParentHostPairs {
    ...
    public class ParentHostPairsRequestBuilder : BaseRequestBuilder {
        ...
        public ParentHostPairsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/parentHostPairs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ParentHostPairsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ParentHostPairsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/parentHostPairs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<HostPairCollectionResponse?> GetAsync(Action<ParentHostPairsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<HostPairCollectionResponse> GetAsync(Action<ParentHostPairsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<ParentHostPairsRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ParentHostPairsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ParentHostPairsRequestBuilderGetRequestConfiguration();
...
#nullable restore
        ...
        /// </summary>
        public class ParentHostPairsRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public ParentHostPairsRequestBuilderGetQueryParameters QueryParameters { get; set; } = new ParentHostPairsRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new parentHostPairsRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public ParentHostPairsRequestBuilderGetRequestConfiguration() {
