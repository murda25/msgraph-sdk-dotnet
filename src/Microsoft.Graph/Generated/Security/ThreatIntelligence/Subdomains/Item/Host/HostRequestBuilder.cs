...
namespace Microsoft.Graph.Security.ThreatIntelligence.Subdomains.Item.Host {
    ...
    public class HostRequestBuilder : BaseRequestBuilder {
        ...
        public HostRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/subdomains/{subdomain%2Did}/host{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HostRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HostRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/subdomains/{subdomain%2Did}/host{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
