...
namespace Microsoft.Graph.Security.ThreatIntelligence.PassiveDnsRecords.Item.Artifact {
    ...
    public class ArtifactRequestBuilder : BaseRequestBuilder {
        ...
        public ArtifactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord%2Did}/artifact{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ArtifactRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ArtifactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord%2Did}/artifact{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Security.Artifact?> GetAsync(Action<ArtifactRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Security.Artifact> GetAsync(Action<ArtifactRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.Security.Artifact>(requestInfo, Microsoft.Graph.Models.Security.Artifact.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// The artifact related to this passiveDnsRecord entry.
        /// </summary>
