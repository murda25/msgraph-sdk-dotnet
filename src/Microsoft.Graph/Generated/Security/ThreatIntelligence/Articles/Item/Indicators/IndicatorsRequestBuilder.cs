...
namespace Microsoft.Graph.Security.ThreatIntelligence.Articles.Item.Indicators {
    ...
    public class IndicatorsRequestBuilder : BaseRequestBuilder {
        ...
        public ArticleIndicatorItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("articleIndicator%2Did", position);
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/security-article-list-indicators?view=graph-rest-1.0" />
        /// </summary>
