...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Security.ThreatIntelligence?> GetAsync(Action<ThreatIntelligenceRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Security.ThreatIntelligence> GetAsync(Action<ThreatIntelligenceRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Security.ThreatIntelligence?> PatchAsync(Microsoft.Graph.Models.Security.ThreatIntelligence body, Action<ThreatIntelligenceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Security.ThreatIntelligence> PatchAsync(Microsoft.Graph.Models.Security.ThreatIntelligence body, Action<ThreatIntelligenceRequestBuilderPatchRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Security.ThreatIntelligence body, Action<ThreatIntelligenceRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(Microsoft.Graph.Models.Security.ThreatIntelligence body, Action<ThreatIntelligenceRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
