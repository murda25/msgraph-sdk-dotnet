...
namespace Microsoft.Graph.Security.SecureScoreControlProfiles.Item {
    ...
    public class SecureScoreControlProfileItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SecureScoreControlProfile body, Action<SecureScoreControlProfileItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
