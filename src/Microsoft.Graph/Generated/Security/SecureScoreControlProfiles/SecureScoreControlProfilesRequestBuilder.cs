...
namespace Microsoft.Graph.Security.SecureScoreControlProfiles {
    ...
    public class SecureScoreControlProfilesRequestBuilder {
        ...
        /// </summary>
        public async Task<SecureScoreControlProfileCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SecureScoreControlProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SecureScoreControlProfile> PostAsync(SecureScoreControlProfile body, CancellationToken cancellationToken = default, Action<SecureScoreControlProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
