...
namespace Microsoft.Graph.Security.SecureScoreControlProfiles {
    ...
    public class SecureScoreControlProfilesRequestBuilder {
        ...
        /// </summary>
        public async Task<SecureScoreControlProfileCollectionResponse> GetAsync(Action<SecureScoreControlProfilesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SecureScoreControlProfile> PostAsync(SecureScoreControlProfile body, Action<SecureScoreControlProfilesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
