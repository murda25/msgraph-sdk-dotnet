...
using Microsoft.Graph.Shares.Item.ListItem.DocumentSetVersions.Count;
using Microsoft.Graph.Shares.Item.ListItem.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Shares.Item.ListItem.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.shares.item.listItem.documentSetVersions.item collection</summary>
        ...
        public DocumentSetVersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/listItem/documentSetVersions{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
