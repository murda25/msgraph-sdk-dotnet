...
using Microsoft.Graph.Shares.Item.ListItem.Versions.Item.Fields;
using Microsoft.Graph.Shares.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Shares.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/listItem/versions/{listItemVersion%2Did}{?%24select,%24expand}";
