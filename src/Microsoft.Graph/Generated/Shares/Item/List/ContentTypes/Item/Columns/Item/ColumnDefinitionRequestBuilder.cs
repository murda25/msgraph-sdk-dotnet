...
using MicrosoftGraphSdk.Shares.Item.List.ContentTypes.Item.Columns.Item.SourceColumn;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.List.ContentTypes.Item.Columns.Item {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\contentTypes\{contentType-id}\columns\{columnDefinition-id}</summary>
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/contentTypes/{contentType_id}/columns/{columnDefinition_id}{?select,expand}";
