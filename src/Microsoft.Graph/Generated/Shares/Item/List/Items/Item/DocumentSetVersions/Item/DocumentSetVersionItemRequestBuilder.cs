...
using Microsoft.Graph.Shares.Item.List.Items.Item.DocumentSetVersions.Item.MicrosoftGraphRestore;
...
namespace Microsoft.Graph.Shares.Item.List.Items.Item.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
