...
namespace MicrosoftGraphSdk.Shares.Item.List.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        public SubscriptionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/subscriptions/{subscription_id}{?select,expand}";
