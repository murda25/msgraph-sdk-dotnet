...
using MicrosoftGraphSdk.Shares.Item.List.Columns.Item;
using System;
...
namespace MicrosoftGraphSdk.Shares.Item.List.Columns {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list\columns</summary>
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.shares.item.list.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list/columns{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
