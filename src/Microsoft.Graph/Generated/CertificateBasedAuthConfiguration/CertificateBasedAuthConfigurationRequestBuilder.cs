...
namespace Microsoft.Graph.CertificateBasedAuthConfiguration {
    ...
    public class CertificateBasedAuthConfigurationRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.CertificateBasedAuthConfiguration> PostAsync(Microsoft.Graph.Models.CertificateBasedAuthConfiguration body, Action<CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
