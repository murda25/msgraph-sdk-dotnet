...
namespace Microsoft.Graph.CertificateBasedAuthConfiguration {
    ...
    public class CertificateBasedAuthConfigurationRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.certificateBasedAuthConfiguration.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Microsoft.Graph.Models.CertificateBasedAuthConfiguration body, Action<CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.CertificateBasedAuthConfiguration> PostAsync(Microsoft.Graph.Models.CertificateBasedAuthConfiguration body, CancellationToken cancellationToken = default, Action<CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
