...
namespace Microsoft.Graph.Applications {
    ...
    public class ApplicationsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Application> PostAsync(Microsoft.Graph.Models.Application body, CancellationToken cancellationToken = default, Action<ApplicationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
