...
using Microsoft.Graph.Applications.MicrosoftGraphDelta;
using Microsoft.Graph.Applications.MicrosoftGraphGetAvailableExtensionProperties;
using Microsoft.Graph.Applications.MicrosoftGraphGetByIds;
using Microsoft.Graph.Applications.MicrosoftGraphValidateProperties;
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Microsoft.Graph.Models.Application?> PostAsync(Microsoft.Graph.Models.Application body, Action<ApplicationsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Application> PostAsync(Microsoft.Graph.Models.Application body, Action<ApplicationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
