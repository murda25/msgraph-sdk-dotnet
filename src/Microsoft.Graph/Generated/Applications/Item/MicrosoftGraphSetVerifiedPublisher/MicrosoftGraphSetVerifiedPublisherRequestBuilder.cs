...
namespace Microsoft.Graph.Applications.Item.MicrosoftGraphSetVerifiedPublisher {
    /// <summary>
    ...
    public class MicrosoftGraphSetVerifiedPublisherRequestBuilder {
        ...
        public MicrosoftGraphSetVerifiedPublisherRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSetVerifiedPublisherRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(SetVerifiedPublisherPostRequestBody body, Action<MicrosoftGraphSetVerifiedPublisherRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(SetVerifiedPublisherPostRequestBody body, Action<MicrosoftGraphSetVerifiedPublisherRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
