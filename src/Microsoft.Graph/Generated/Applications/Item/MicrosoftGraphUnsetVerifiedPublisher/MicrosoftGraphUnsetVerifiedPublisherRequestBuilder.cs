...
namespace Microsoft.Graph.Applications.Item.MicrosoftGraphUnsetVerifiedPublisher {
    /// <summary>
    ...
    public class MicrosoftGraphUnsetVerifiedPublisherRequestBuilder {
        ...
        public MicrosoftGraphUnsetVerifiedPublisherRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphUnsetVerifiedPublisherRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphUnsetVerifiedPublisherRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphUnsetVerifiedPublisherRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
