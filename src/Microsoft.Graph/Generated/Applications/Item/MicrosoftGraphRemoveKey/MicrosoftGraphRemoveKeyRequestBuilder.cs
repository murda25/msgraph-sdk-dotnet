...
namespace Microsoft.Graph.Applications.Item.MicrosoftGraphRemoveKey {
    /// <summary>
    ...
    public class MicrosoftGraphRemoveKeyRequestBuilder {
        ...
        public MicrosoftGraphRemoveKeyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphRemoveKeyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(RemoveKeyPostRequestBody body, Action<MicrosoftGraphRemoveKeyRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(RemoveKeyPostRequestBody body, Action<MicrosoftGraphRemoveKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
