...
namespace Microsoft.Graph.TenantRelationships.DelegatedAdminRelationships {
    ...
    /// </summary>
    public class DelegatedAdminRelationshipsRequestBuilder {
        ...
        public DelegatedAdminRelationshipsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DelegatedAdminRelationshipsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
