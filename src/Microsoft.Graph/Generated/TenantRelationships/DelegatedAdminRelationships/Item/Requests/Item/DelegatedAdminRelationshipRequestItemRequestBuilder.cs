...
namespace Microsoft.Graph.TenantRelationships.DelegatedAdminRelationships.Item.Requests.Item {
    ...
    public class DelegatedAdminRelationshipRequestItemRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DelegatedAdminRelationshipRequestItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task DeleteAsync(Action<DelegatedAdminRelationshipRequestItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task DeleteAsync(Action<DelegatedAdminRelationshipRequestItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
