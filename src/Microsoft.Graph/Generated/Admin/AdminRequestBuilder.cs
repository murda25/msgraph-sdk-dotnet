...
namespace Microsoft.Graph.Admin {
    ...
    public class AdminRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Admin> GetAsync(CancellationToken cancellationToken = default, Action<AdminRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Admin body, CancellationToken cancellationToken = default, Action<AdminRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
