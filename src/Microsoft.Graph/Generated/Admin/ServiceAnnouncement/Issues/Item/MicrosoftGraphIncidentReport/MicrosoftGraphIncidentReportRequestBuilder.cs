...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Issues.Item.MicrosoftGraphIncidentReport {
    /// <summary>
    ...
    public class MicrosoftGraphIncidentReportRequestBuilder {
        ...
        public MicrosoftGraphIncidentReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphIncidentReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<MicrosoftGraphIncidentReportRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<MicrosoftGraphIncidentReportRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
