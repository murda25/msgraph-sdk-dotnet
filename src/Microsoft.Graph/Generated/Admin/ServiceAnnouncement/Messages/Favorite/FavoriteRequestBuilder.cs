...
#nullable enable
        public async Task<FavoritePostResponse?> PostAsFavoritePostResponseAsync(FavoritePostRequestBody body, Action<FavoriteRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<FavoritePostResponse> PostAsFavoritePostResponseAsync(FavoritePostRequestBody body, Action<FavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
