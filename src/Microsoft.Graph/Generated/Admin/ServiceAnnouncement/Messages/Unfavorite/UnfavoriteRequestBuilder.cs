...
#nullable enable
        public async Task<UnfavoritePostResponse?> PostAsUnfavoritePostResponseAsync(UnfavoritePostRequestBody body, Action<UnfavoriteRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<UnfavoritePostResponse> PostAsUnfavoritePostResponseAsync(UnfavoritePostRequestBody body, Action<UnfavoriteRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
