...
namespace Microsoft.Graph.Admin.ServiceAnnouncement.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        /// </summary>
        public async Task<ServiceUpdateMessageCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<MessagesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ServiceUpdateMessage> PostAsync(ServiceUpdateMessage body, CancellationToken cancellationToken = default, Action<MessagesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
