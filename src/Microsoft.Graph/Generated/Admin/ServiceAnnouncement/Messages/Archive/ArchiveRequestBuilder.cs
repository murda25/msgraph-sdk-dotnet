...
#nullable enable
        public async Task<ArchivePostResponse?> PostAsArchivePostResponseAsync(ArchivePostRequestBody body, Action<ArchiveRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ArchivePostResponse> PostAsArchivePostResponseAsync(ArchivePostRequestBody body, Action<ArchiveRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
