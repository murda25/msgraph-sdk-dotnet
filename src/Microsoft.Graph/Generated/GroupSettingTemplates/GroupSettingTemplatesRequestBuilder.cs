...
namespace Microsoft.Graph.GroupSettingTemplates {
    ...
    public class GroupSettingTemplatesRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupSettingTemplateCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GroupSettingTemplatesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupSettingTemplate> PostAsync(GroupSettingTemplate body, CancellationToken cancellationToken = default, Action<GroupSettingTemplatesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
