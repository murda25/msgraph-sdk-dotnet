...
namespace MicrosoftGraphSdk.AuthenticationMethodConfigurations.Item {
    /// <summary>Builds and executes requests for operations under \authenticationMethodConfigurations\{authenticationMethodConfiguration-id}</summary>
