...
namespace Microsoft.Graph.Devices.Item.RegisteredUsers.MicrosoftGraphAppRoleAssignment.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredUsers/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}";
