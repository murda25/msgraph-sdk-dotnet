...
namespace Microsoft.Graph.Devices.Item.RegisteredUsers.Item.ServicePrincipal {
    /// <summary>
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
