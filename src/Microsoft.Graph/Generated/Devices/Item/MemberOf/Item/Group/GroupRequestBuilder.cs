...
namespace Microsoft.Graph.Devices.Item.MemberOf.Item.Group {
    ...
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.group{?%24select,%24expand}";
