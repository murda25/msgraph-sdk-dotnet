...
namespace Microsoft.Graph.Devices.Item.MemberOf.Item.Device.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.device/microsoft.graph.restore";
