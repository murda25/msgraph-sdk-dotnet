using Microsoft.Graph.Devices.Item.MemberOf.Application;
using Microsoft.Graph.Devices.Item.MemberOf.Count;
using Microsoft.Graph.Devices.Item.MemberOf.Device;
using Microsoft.Graph.Devices.Item.MemberOf.Group;
using Microsoft.Graph.Devices.Item.MemberOf.Item;
using Microsoft.Graph.Devices.Item.MemberOf.OrgContact;
using Microsoft.Graph.Devices.Item.MemberOf.ServicePrincipal;
using Microsoft.Graph.Devices.Item.MemberOf.User;
...
namespace Microsoft.Graph.Devices.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.devices.item.memberOf.item collection</summary>
