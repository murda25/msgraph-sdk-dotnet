...
namespace Microsoft.Graph.Devices.Item.MemberOf.MicrosoftGraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
