...
namespace Microsoft.Graph.Devices.Item.MemberOf.OrgContact.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/microsoft.graph.orgContact/$count{?%24search,%24filter}";
