...
namespace Microsoft.Graph.Devices.Item.MemberOf.MicrosoftGraphApplication.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/microsoft.graph.application/$count{?%24search,%24filter}";
