...
namespace MicrosoftGraphSdk.Devices.Item.RegisteredOwners.Ref {
    /// <summary>Builds and executes requests for operations under \devices\{device-id}\registeredOwners\$ref</summary>
    public class RefRequestBuilder {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device_id}/registeredOwners/$ref{?top,skip,search,filter,count,orderby}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(MicrosoftGraphSdk.Devices.Item.RegisteredOwners.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraphSdk.Devices.Item.RegisteredOwners.Ref.Ref> PostAsync(MicrosoftGraphSdk.Devices.Item.RegisteredOwners.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraphSdk.Devices.Item.RegisteredOwners.Ref.Ref>(requestInfo, responseHandler, default, cancellationToken);
        }
