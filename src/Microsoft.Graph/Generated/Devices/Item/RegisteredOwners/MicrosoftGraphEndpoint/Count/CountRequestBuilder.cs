...
namespace Microsoft.Graph.Devices.Item.RegisteredOwners.MicrosoftGraphEndpoint.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/microsoft.graph.endpoint/$count{?%24search,%24filter}";
