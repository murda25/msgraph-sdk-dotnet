...
namespace Microsoft.Graph.Devices.Item.TransitiveMemberOf.MicrosoftGraphGroup.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.group/$count{?%24search,%24filter}";
