using Microsoft.Graph.Devices.Item.TransitiveMemberOf.Application;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.Count;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.Device;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.Group;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.Item;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.OrgContact;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.ServicePrincipal;
using Microsoft.Graph.Devices.Item.TransitiveMemberOf.User;
...
namespace Microsoft.Graph.Devices.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.devices.item.transitiveMemberOf.item collection</summary>
