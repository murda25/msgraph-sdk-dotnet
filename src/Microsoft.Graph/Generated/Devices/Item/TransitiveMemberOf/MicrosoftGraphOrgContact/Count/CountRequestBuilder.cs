...
namespace Microsoft.Graph.Devices.Item.TransitiveMemberOf.MicrosoftGraphOrgContact.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.orgContact/$count{?%24search,%24filter}";
