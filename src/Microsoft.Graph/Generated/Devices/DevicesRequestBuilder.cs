...
namespace Microsoft.Graph.Devices {
    ...
    public class DevicesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.Device> PostAsync(Microsoft.Graph.Models.Device body, CancellationToken cancellationToken = default, Action<DevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
