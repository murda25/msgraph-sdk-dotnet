...
namespace MicrosoftGraphSdk.ServicePrincipals.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        /// </summary>
        public async Task<GetAvailableExtensionPropertiesResponse> PostAsync(GetAvailableExtensionPropertiesRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
