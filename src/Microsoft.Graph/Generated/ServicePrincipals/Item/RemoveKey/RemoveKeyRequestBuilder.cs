...
namespace Microsoft.Graph.ServicePrincipals.Item.RemoveKey {
    ...
    public class RemoveKeyRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RemoveKeyRequestBody body, Action<RemoveKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(RemoveKeyRequestBody body, Action<RemoveKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
