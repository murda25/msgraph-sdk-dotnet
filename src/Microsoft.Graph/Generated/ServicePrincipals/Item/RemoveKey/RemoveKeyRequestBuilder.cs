...
namespace Microsoft.Graph.ServicePrincipals.Item.RemoveKey {
    ...
    public class RemoveKeyRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RemoveKeyPostRequestBody body, CancellationToken cancellationToken = default, Action<RemoveKeyRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
