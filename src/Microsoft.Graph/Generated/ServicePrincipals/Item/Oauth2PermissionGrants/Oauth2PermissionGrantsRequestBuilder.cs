...
namespace Microsoft.Graph.ServicePrincipals.Item.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.servicePrincipals.item.oauth2PermissionGrants.item collection</summary>
        ...
        public Oauth2PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/oauth2PermissionGrants{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
