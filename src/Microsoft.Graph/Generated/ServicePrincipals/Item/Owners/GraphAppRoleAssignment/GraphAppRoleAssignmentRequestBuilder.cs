...
namespace Microsoft.Graph.ServicePrincipals.Item.Owners.GraphAppRoleAssignment {
    ...
    public class GraphAppRoleAssignmentRequestBuilder {
        ...
        public GraphAppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
