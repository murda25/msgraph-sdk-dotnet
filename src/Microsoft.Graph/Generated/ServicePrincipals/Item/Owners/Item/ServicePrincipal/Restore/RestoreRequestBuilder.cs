...
namespace Microsoft.Graph.ServicePrincipals.Item.Owners.Item.ServicePrincipal.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/{directoryObject%2Did}/microsoft.graph.servicePrincipal/microsoft.graph.restore";
