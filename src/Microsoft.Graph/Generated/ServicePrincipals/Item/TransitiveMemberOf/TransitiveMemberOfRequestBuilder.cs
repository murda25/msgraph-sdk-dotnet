...
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.Application;
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.Count;
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.Device;
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.Group;
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.Item;
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.OrgContact;
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.ServicePrincipal;
using Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf.User;
...
namespace Microsoft.Graph.ServicePrincipals.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.servicePrincipals.item.transitiveMemberOf.item collection</summary>
