...
namespace Microsoft.Graph.ServicePrincipals.Item.DelegatedPermissionClassifications {
    ...
    public class DelegatedPermissionClassificationsRequestBuilder {
        ...
        /// </summary>
        public async Task<DelegatedPermissionClassificationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedPermissionClassification> PostAsync(DelegatedPermissionClassification body, CancellationToken cancellationToken = default, Action<DelegatedPermissionClassificationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
