...
namespace Microsoft.Graph.ServicePrincipals.Item.DelegatedPermissionClassifications {
    ...
    public class DelegatedPermissionClassificationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.servicePrincipals.item.delegatedPermissionClassifications.item collection</summary>
        ...
        /// </summary>
        public DelegatedPermissionClassificationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DelegatedPermissionClassificationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DelegatedPermissionClassification body, Action<DelegatedPermissionClassificationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<DelegatedPermissionClassificationCollectionResponse> GetAsync(Action<DelegatedPermissionClassificationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<DelegatedPermissionClassificationCollectionResponse>(requestInfo, DelegatedPermissionClassificationCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to delegatedPermissionClassifications for servicePrincipals
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DelegatedPermissionClassification> PostAsync(DelegatedPermissionClassification body, Action<DelegatedPermissionClassificationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
