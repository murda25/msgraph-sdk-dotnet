...
namespace MicrosoftGraphSdk.ServicePrincipals.Item.DelegatedPermissionClassifications.Item {
    /// <summary>Builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\delegatedPermissionClassifications\{delegatedPermissionClassification-id}</summary>
    public class DelegatedPermissionClassificationRequestBuilder {
        ...
        /// </summary>
        public DelegatedPermissionClassificationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal_id}/delegatedPermissionClassifications/{delegatedPermissionClassification_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DelegatedPermissionClassificationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DelegatedPermissionClassification body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
