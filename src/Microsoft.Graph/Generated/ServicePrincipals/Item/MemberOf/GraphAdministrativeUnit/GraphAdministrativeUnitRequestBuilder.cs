...
namespace Microsoft.Graph.ServicePrincipals.Item.MemberOf.GraphAdministrativeUnit {
    ...
    public class GraphAdministrativeUnitRequestBuilder {
        ...
        public GraphAdministrativeUnitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/graph.administrativeUnit{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
