...
namespace Microsoft.Graph.ServicePrincipals.Item.OwnedObjects.MicrosoftGraphAppRoleAssignment.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}";
