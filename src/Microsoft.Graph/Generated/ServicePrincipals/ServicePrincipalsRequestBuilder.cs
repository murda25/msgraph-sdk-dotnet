...
namespace Microsoft.Graph.ServicePrincipals {
    ...
    public class ServicePrincipalsRequestBuilder {
        ...
        /// </summary>
        public async Task<ServicePrincipalCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ServicePrincipalsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.ServicePrincipal> PostAsync(Microsoft.Graph.Models.ServicePrincipal body, CancellationToken cancellationToken = default, Action<ServicePrincipalsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
