...
namespace Microsoft.Graph.Planner {
    ...
    public class PlannerRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Planner> GetAsync(CancellationToken cancellationToken = default, Action<PlannerRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Planner body, CancellationToken cancellationToken = default, Action<PlannerRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
