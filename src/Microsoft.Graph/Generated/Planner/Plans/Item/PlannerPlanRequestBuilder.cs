...
using MicrosoftGraphSdk.Planner.Plans.Item.Buckets;
using MicrosoftGraphSdk.Planner.Plans.Item.Details;
using MicrosoftGraphSdk.Planner.Plans.Item.Tasks;
using System;
...
namespace MicrosoftGraphSdk.Planner.Plans.Item {
    ...
    public class PlannerPlanRequestBuilder {
        ...
        public PlannerPlanRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/planner/plans/{plannerPlan_id}{?select,expand}";
