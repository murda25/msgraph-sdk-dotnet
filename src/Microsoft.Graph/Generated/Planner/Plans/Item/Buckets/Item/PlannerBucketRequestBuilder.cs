...
using MicrosoftGraphSdk.Planner.Plans.Item.Buckets.Item.Tasks;
using System;
...
namespace MicrosoftGraphSdk.Planner.Plans.Item.Buckets.Item {
    /// <summary>Builds and executes requests for operations under \planner\plans\{plannerPlan-id}\buckets\{plannerBucket-id}</summary>
    public class PlannerBucketRequestBuilder {
        ...
        public PlannerBucketRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/planner/plans/{plannerPlan_id}/buckets/{plannerBucket_id}{?select,expand}";
