...
using MicrosoftGraphSdk.Planner.Buckets.Item.Tasks.Item;
using System;
...
namespace MicrosoftGraphSdk.Planner.Buckets.Item.Tasks {
    /// <summary>Builds and executes requests for operations under \planner\buckets\{plannerBucket-id}\tasks</summary>
    public class TasksRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.planner.buckets.item.tasks.item collection</summary>
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/planner/buckets/{plannerBucket_id}/tasks{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
