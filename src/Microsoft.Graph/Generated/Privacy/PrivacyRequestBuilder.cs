...
namespace Microsoft.Graph.Privacy {
    ...
    public class PrivacyRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Privacy> GetAsync(CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Privacy body, CancellationToken cancellationToken = default, Action<PrivacyRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
