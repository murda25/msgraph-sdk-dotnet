...
using MicrosoftGraphSdk.Drives.Item.Special.Item.Analytics;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Children;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Content;
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Permissions;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Subscriptions;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Thumbnails;
using MicrosoftGraphSdk.Drives.Item.Special.Item.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.Special.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}{?select,expand}";
