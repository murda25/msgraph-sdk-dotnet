...
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.Fields;
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.GetActivitiesByInterval;
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.Special.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/special/{driveItem_id}/listItem{?select,expand}";
