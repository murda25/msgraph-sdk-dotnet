...
namespace Microsoft.Graph.Drives.Item.SharedWithMe {
    ...
    public class SharedWithMeResponse : IAdditionalDataHolder, IParsable {
        ...
        public List<Microsoft.Graph.Models.DriveItem> Value { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as SharedWithMeResponse).Value = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.DriveItem>(Microsoft.Graph.Models.DriveItem.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
