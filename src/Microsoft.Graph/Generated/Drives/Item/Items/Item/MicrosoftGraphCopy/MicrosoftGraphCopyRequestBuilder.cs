...
namespace Microsoft.Graph.Drives.Item.Items.Item.MicrosoftGraphCopy {
    /// <summary>
    ...
    public class MicrosoftGraphCopyRequestBuilder {
        ...
        public MicrosoftGraphCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.copy";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.DriveItem?> PostAsync(CopyPostRequestBody body, Action<MicrosoftGraphCopyRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(CopyPostRequestBody body, Action<MicrosoftGraphCopyRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
