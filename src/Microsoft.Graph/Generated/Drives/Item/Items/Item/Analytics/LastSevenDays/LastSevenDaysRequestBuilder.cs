...
namespace Microsoft.Graph.Drives.Item.Items.Item.Analytics.LastSevenDays {
    ...
    /// </summary>
    public class LastSevenDaysRequestBuilder {
        ...
        public LastSevenDaysRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/lastSevenDays{?%24select,%24expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LastSevenDaysRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
