...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.StDev_S {
    ...
    /// </summary>
    public class StDev_SRequestBuilder {
        ...
        public StDev_SRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/stDev_S";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StDev_SRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
