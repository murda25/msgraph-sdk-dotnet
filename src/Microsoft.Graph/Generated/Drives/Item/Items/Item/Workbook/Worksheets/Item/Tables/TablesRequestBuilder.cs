...
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.MicrosoftGraphAdd;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.MicrosoftGraphCount;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.MicrosoftGraphItemAtWithIndex;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        public TablesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
