...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.FisherInv {
    ...
    /// </summary>
    public class FisherInvRequestBuilder {
        ...
        public FisherInvRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/fisherInv";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FisherInvRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
