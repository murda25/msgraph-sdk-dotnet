...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/columns";
...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(ColumnsPostRequestBody body, Action<ColumnsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(ColumnsPostRequestBody body, Action<ColumnsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
