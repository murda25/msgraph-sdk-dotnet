...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.LogNorm_Inv {
    ...
    /// </summary>
    public class LogNorm_InvRequestBuilder {
        ...
        public LogNorm_InvRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/logNorm_Inv";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LogNorm_InvRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
