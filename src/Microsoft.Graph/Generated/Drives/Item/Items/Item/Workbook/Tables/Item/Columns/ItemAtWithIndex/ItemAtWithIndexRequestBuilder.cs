...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public ItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? index = default) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/itemAt(index={index})";
...
#nullable enable
        public async Task<WorkbookTableColumn?> GetAsync(Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookTableColumn> GetAsync(Action<ItemAtWithIndexRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
