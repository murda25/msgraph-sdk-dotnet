...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.PercentRank_Inc {
    ...
    /// </summary>
    public class PercentRank_IncRequestBuilder {
        ...
        public PercentRank_IncRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/percentRank_Inc";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PercentRank_IncRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
