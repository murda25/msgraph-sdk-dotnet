...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.ChiSq_Dist_RT {
    ...
    /// </summary>
    public class ChiSq_Dist_RTRequestBuilder {
        ...
        public ChiSq_Dist_RTRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/chiSq_Dist_RT";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChiSq_Dist_RTRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
