...
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.PivotTables.MicrosoftGraphRefreshAll;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Worksheets.Item.PivotTables {
    ...
    public class PivotTablesRequestBuilder {
        ...
        public MicrosoftGraphRefreshAllRequestBuilder MicrosoftGraphRefreshAll { get =>
            new MicrosoftGraphRefreshAllRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable enable
        public async Task<WorkbookPivotTableCollectionResponse?> GetAsync(Action<PivotTablesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookPivotTableCollectionResponse> GetAsync(Action<PivotTablesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<WorkbookPivotTable?> PostAsync(WorkbookPivotTable body, Action<PivotTablesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookPivotTable> PostAsync(WorkbookPivotTable body, Action<PivotTablesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
