...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Functions.Lookup {
    ...
    public class LookupRequestBuilder {
        ...
        public LookupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/lookup";
...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(LookupPostRequestBody body, Action<LookupRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(LookupPostRequestBody body, Action<LookupRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
