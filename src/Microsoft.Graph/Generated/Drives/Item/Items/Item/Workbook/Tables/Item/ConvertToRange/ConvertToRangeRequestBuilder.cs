...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.ConvertToRange {
    ...
    public class ConvertToRangeRequestBuilder {
        ...
        public ConvertToRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/convertToRange";
...
#nullable enable
        public async Task<WorkbookRange?> PostAsync(Action<ConvertToRangeRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookRange> PostAsync(Action<ConvertToRangeRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
