...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.RefreshSession {
    ...
    public class RefreshSessionRequestBuilder {
        ...
        public RefreshSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/refreshSession";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RefreshSessionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
