...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.Rows.MicrosoftGraphItemAtWithIndex {
    /// <summary>
    ...
    public class MicrosoftGraphItemAtWithIndexRequestBuilder {
        ...
        public MicrosoftGraphItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? index = default) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/microsoft.graph.itemAt(index={index})";
...
#nullable enable
        public async Task<WorkbookTableRow?> GetAsync(Action<MicrosoftGraphItemAtWithIndexRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookTableRow> GetAsync(Action<MicrosoftGraphItemAtWithIndexRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
