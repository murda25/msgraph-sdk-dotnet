...
#nullable enable
        public async Task<WorkbookFunctionResult?> PostAsync(CumIPmtPostRequestBody body, Action<CumIPmtRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WorkbookFunctionResult> PostAsync(CumIPmtPostRequestBody body, Action<CumIPmtRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
