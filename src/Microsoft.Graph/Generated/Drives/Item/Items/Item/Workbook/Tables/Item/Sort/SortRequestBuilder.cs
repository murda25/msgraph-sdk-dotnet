using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.Sort.MicrosoftGraphApply;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.Sort.MicrosoftGraphClear;
using Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.Sort.MicrosoftGraphReapply;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.Workbook.Tables.Item.Sort {
    ...
    public class SortRequestBuilder {
        ...
        public SortRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/sort{?%24select,%24expand}";
