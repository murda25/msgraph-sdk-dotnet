...
namespace MicrosoftGraphSdk.Drives.Item.Items.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        public GetActivitiesByIntervalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/items/{driveItem_id}/listItem/microsoft.graph.getActivitiesByInterval()";
