...
namespace Microsoft.Graph.Drives.Item.Items.Item.ListItem.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/fields{?%24select,%24expand}";
