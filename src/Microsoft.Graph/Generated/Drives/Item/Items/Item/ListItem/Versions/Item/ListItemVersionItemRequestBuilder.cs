using Microsoft.Graph.Drives.Item.Items.Item.ListItem.Versions.Item.Fields;
using Microsoft.Graph.Drives.Item.Items.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Drives.Item.Items.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions/{listItemVersion%2Did}{?%24select,%24expand}";
