...
namespace Microsoft.Graph.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/documentSetVersions/$count{?%24search,%24filter}";
