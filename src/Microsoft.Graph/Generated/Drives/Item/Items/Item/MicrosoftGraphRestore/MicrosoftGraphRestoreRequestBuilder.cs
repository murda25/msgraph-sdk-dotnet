...
namespace Microsoft.Graph.Drives.Item.Items.Item.MicrosoftGraphRestore {
    /// <summary>
    ...
    public class MicrosoftGraphRestoreRequestBuilder {
        ...
        public MicrosoftGraphRestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.restore";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.DriveItem?> PostAsync(RestorePostRequestBody body, Action<MicrosoftGraphRestoreRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.DriveItem> PostAsync(RestorePostRequestBody body, Action<MicrosoftGraphRestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(RestorePostRequestBody body, Action<MicrosoftGraphRestoreRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(RestorePostRequestBody body, Action<MicrosoftGraphRestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
