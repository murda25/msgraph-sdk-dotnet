...
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Analytics;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Children;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Content;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.ListItem;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Permissions;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Subscriptions;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Thumbnails;
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.Bundles.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}{?select,expand}";
