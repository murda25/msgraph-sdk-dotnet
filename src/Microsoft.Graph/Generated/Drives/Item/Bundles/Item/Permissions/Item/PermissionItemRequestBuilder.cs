...
using MicrosoftGraphSdk.Drives.Item.Bundles.Item.Permissions.Item.Grant;
...
namespace MicrosoftGraphSdk.Drives.Item.Bundles.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/bundles/{driveItem_id}/permissions/{permission_id}{?select,expand}";
