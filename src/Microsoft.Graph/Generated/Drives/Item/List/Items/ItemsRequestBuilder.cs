...
using MicrosoftGraphSdk.Drives.Item.List.Items.Count;
using MicrosoftGraphSdk.Drives.Item.List.Items.Item;
...
namespace MicrosoftGraphSdk.Drives.Item.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drives.item.list.items.item collection</summary>
