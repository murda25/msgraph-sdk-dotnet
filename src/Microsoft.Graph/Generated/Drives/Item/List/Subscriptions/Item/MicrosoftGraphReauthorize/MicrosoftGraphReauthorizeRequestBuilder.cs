...
namespace Microsoft.Graph.Drives.Item.List.Subscriptions.Item.MicrosoftGraphReauthorize {
    /// <summary>
    ...
    public class MicrosoftGraphReauthorizeRequestBuilder {
        ...
        public MicrosoftGraphReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
