...
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.Fields;
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.GetActivitiesByInterval;
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.Following.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}/listItem{?select,expand}";
