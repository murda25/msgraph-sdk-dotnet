...
using MicrosoftGraphSdk.Drives.Item.Following.Item.Content;
...
namespace MicrosoftGraphSdk.Drives.Item.Following.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\following\{driveItem-id}</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/following/{driveItem_id}{?select,expand}";
