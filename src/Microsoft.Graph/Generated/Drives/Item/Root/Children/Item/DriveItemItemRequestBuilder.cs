using Microsoft.Graph.Drives.Item.Root.Children.Item.Content;
...
namespace Microsoft.Graph.Drives.Item.Root.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root/children/{driveItem%2Did}{?%24select,%24expand}";
