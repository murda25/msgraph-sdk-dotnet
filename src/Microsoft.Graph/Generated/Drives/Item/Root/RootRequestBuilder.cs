...
using MicrosoftGraphSdk.Drives.Item.Root.Analytics;
using MicrosoftGraphSdk.Drives.Item.Root.Children;
using MicrosoftGraphSdk.Drives.Item.Root.Content;
using MicrosoftGraphSdk.Drives.Item.Root.ListItem;
using MicrosoftGraphSdk.Drives.Item.Root.Permissions;
using MicrosoftGraphSdk.Drives.Item.Root.Subscriptions;
using MicrosoftGraphSdk.Drives.Item.Root.Thumbnails;
using MicrosoftGraphSdk.Drives.Item.Root.Versions;
...
namespace MicrosoftGraphSdk.Drives.Item.Root {
    ...
    public class RootRequestBuilder {
        ...
        public RootRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/root{?select,expand}";
