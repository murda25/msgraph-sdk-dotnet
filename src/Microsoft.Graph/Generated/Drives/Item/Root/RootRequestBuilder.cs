using Microsoft.Graph.Drives.Item.Root.Analytics;
using Microsoft.Graph.Drives.Item.Root.Checkin;
using Microsoft.Graph.Drives.Item.Root.Checkout;
using Microsoft.Graph.Drives.Item.Root.Children;
using Microsoft.Graph.Drives.Item.Root.Content;
using Microsoft.Graph.Drives.Item.Root.Copy;
using Microsoft.Graph.Drives.Item.Root.CreateLink;
using Microsoft.Graph.Drives.Item.Root.CreateUploadSession;
using Microsoft.Graph.Drives.Item.Root.Delta;
using Microsoft.Graph.Drives.Item.Root.DeltaWithToken;
using Microsoft.Graph.Drives.Item.Root.Follow;
using Microsoft.Graph.Drives.Item.Root.GetActivitiesByInterval;
using Microsoft.Graph.Drives.Item.Root.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Drives.Item.Root.Invite;
using Microsoft.Graph.Drives.Item.Root.ListItem;
using Microsoft.Graph.Drives.Item.Root.Permissions;
using Microsoft.Graph.Drives.Item.Root.Preview;
using Microsoft.Graph.Drives.Item.Root.Restore;
using Microsoft.Graph.Drives.Item.Root.SearchWithQ;
using Microsoft.Graph.Drives.Item.Root.Subscriptions;
using Microsoft.Graph.Drives.Item.Root.Thumbnails;
using Microsoft.Graph.Drives.Item.Root.Unfollow;
using Microsoft.Graph.Drives.Item.Root.ValidatePermission;
using Microsoft.Graph.Drives.Item.Root.Versions;
...
namespace Microsoft.Graph.Drives.Item.Root {
    ...
    public class RootRequestBuilder {
        ...
        public RootRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root{?%24select,%24expand}";
