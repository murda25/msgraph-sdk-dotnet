...
namespace Microsoft.Graph.GroupSettings {
    ...
    public class GroupSettingsRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupSettingCollectionResponse> GetAsync(Action<GroupSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupSetting> PostAsync(GroupSetting body, Action<GroupSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Retrieve a list of tenant-level or group-specific group settings objects.</summary>
