...
namespace Microsoft.Graph.GroupSettings {
    ...
    public class GroupSettingsRequestBuilder {
        ...
        /// </summary>
        public async Task<GroupSettingCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<GroupSettingsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<GroupSetting> PostAsync(GroupSetting body, CancellationToken cancellationToken = default, Action<GroupSettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
