...
namespace Microsoft.Graph.Communications.OnlineMeetings.Item.AttendanceReports.Item {
    ...
    public class MeetingAttendanceReportItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MeetingAttendanceReport> GetAsync(CancellationToken cancellationToken = default, Action<MeetingAttendanceReportItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MeetingAttendanceReport body, CancellationToken cancellationToken = default, Action<MeetingAttendanceReportItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
