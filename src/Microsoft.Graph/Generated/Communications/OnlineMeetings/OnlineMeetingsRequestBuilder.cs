...
namespace Microsoft.Graph.Communications.OnlineMeetings {
    ...
    public class OnlineMeetingsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.communications.onlineMeetings.item collection</summary>
        ...
        public OnlineMeetingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/onlineMeetings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
