...
namespace Microsoft.Graph.Communications {
    ...
    public class CommunicationsRequestBuilder {
        ...
        /// </summary>
        public async Task<CloudCommunications> GetAsync(CancellationToken cancellationToken = default, Action<CommunicationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(CloudCommunications body, CancellationToken cancellationToken = default, Action<CommunicationsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
