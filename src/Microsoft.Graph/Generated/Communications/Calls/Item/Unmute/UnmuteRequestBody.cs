...
namespace Microsoft.Graph.Communications.Calls.Item.Unmute {
    ...
    public class UnmuteRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static UnmuteRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"clientContext", (o,n) => { (o as UnmuteRequestBody).ClientContext = n.GetStringValue(); } },
            };
        }
        /// <summary>
