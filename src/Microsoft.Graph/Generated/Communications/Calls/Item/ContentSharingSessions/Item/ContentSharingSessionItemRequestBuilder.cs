...
namespace Microsoft.Graph.Communications.Calls.Item.ContentSharingSessions.Item {
    ...
    public class ContentSharingSessionItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ContentSharingSession body, Action<ContentSharingSessionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
