...
namespace Microsoft.Graph.Communications.Calls.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.communications.calls.item.operations.item collection</summary>
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/calls/{call%2Did}/operations{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <summary>Get operations from communications</summary>
