...
namespace MicrosoftGraphSdk.Communications.Calls.Item.Participants {
    ...
    public class ParticipantsRequestBuilder {
        ...
        /// </summary>
        public async Task<ParticipantCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
