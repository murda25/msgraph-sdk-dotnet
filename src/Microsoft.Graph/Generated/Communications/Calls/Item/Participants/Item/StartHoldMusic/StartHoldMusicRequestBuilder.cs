...
namespace Microsoft.Graph.Communications.Calls.Item.Participants.Item.StartHoldMusic {
    ...
    public class StartHoldMusicRequestBuilder {
        ...
        /// </summary>
        public async Task<StartHoldMusicOperation> PostAsync(StartHoldMusicPostRequestBody body, CancellationToken cancellationToken = default, Action<StartHoldMusicRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            ...
            return await RequestAdapter.SendAsync<StartHoldMusicOperation>(requestInfo, StartHoldMusicOperation.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
