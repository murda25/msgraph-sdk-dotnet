...
namespace Microsoft.Graph.Communications.Calls.Item.Participants.Item.StartHoldMusic {
    ...
    public class StartHoldMusicRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(StartHoldMusicRequestBody body, Action<StartHoldMusicRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<StartHoldMusicOperation> PostAsync(StartHoldMusicRequestBody body, Action<StartHoldMusicRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
