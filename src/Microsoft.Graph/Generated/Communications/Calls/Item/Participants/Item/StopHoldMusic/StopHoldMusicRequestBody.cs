...
namespace Microsoft.Graph.Communications.Calls.Item.Participants.Item.StopHoldMusic {
    ...
    public class StopHoldMusicRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static StopHoldMusicRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
