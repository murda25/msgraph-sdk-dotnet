...
namespace Microsoft.Graph.Communications.Calls.Item.MicrosoftGraphChangeScreenSharingRole {
    /// <summary>
    ...
    public class MicrosoftGraphChangeScreenSharingRoleRequestBuilder {
        ...
        public MicrosoftGraphChangeScreenSharingRoleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphChangeScreenSharingRoleRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(ChangeScreenSharingRolePostRequestBody body, Action<MicrosoftGraphChangeScreenSharingRoleRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ChangeScreenSharingRolePostRequestBody body, Action<MicrosoftGraphChangeScreenSharingRoleRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
