...
namespace Microsoft.Graph.Communications.CallRecords.GetDirectRoutingCallsWithFromDateTimeWithToDateTime {
    ...
    public class GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder {
        ...
        /// </summary>
        public async Task<GetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
