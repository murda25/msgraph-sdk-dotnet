...
namespace Microsoft.Graph.Communications.CallRecords.GetDirectRoutingCallsWithFromDateTimeWithToDateTime {
    ...
    public class GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder {
        ...
        public async Task<GetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse> GetAsync(Action<GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// </summary>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToGetRequestInformation(Action<GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// Invoke function getDirectRoutingCalls
        /// </summary>
        public class GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetQueryParameters {
        ...
        public class GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration {
            ...
            public GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetQueryParameters QueryParameters { get; set; } = new GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetQueryParameters();
            /// <summary>
