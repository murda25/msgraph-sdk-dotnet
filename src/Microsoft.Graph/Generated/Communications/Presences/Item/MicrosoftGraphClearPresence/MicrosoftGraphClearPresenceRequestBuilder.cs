...
namespace Microsoft.Graph.Communications.Presences.Item.MicrosoftGraphClearPresence {
    /// <summary>
    ...
    public class MicrosoftGraphClearPresenceRequestBuilder {
        ...
        public MicrosoftGraphClearPresenceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphClearPresenceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(ClearPresencePostRequestBody body, Action<MicrosoftGraphClearPresenceRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ClearPresencePostRequestBody body, Action<MicrosoftGraphClearPresenceRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
