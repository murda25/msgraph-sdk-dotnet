...
namespace Microsoft.Graph.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OAuth2PermissionGrant> PostAsync(OAuth2PermissionGrant body, CancellationToken cancellationToken = default, Action<Oauth2PermissionGrantsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
