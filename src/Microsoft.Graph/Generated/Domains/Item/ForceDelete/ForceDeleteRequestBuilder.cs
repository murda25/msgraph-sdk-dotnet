...
namespace Microsoft.Graph.Domains.Item.ForceDelete {
    ...
    public class ForceDeleteRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ForceDeletePostRequestBody body, CancellationToken cancellationToken = default, Action<ForceDeleteRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
