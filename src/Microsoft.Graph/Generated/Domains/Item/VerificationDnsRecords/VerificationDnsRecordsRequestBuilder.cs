...
namespace Microsoft.Graph.Domains.Item.VerificationDnsRecords {
    ...
    public class VerificationDnsRecordsRequestBuilder {
        ...
        /// </summary>
        public async Task<DomainDnsRecordCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<VerificationDnsRecordsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DomainDnsRecord> PostAsync(DomainDnsRecord body, CancellationToken cancellationToken = default, Action<VerificationDnsRecordsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
