...
namespace Microsoft.Graph.Models {
    public class ObjectIdentity : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public string IssuerAssignedId {
            get { return BackingStore?.Get<string>(nameof(IssuerAssignedId)); }
            set { BackingStore?.Set(nameof(IssuerAssignedId), value); }
        }
        ...
        public string SignInType {
            get { return BackingStore?.Get<string>(nameof(SignInType)); }
            set { BackingStore?.Set(nameof(SignInType), value); }
        }
        /// <summary>
