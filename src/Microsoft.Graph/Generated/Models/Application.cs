...
namespace Microsoft.Graph.Models {
    public class Application : DirectoryObject, IParsable {
        ...
        public Microsoft.Graph.Models.OptionalClaims OptionalClaims { get; set; }
        ...
        public Microsoft.Graph.Models.ParentalControlSettings ParentalControlSettings { get; set; }
        ...
        public List<Microsoft.Graph.Models.RequiredResourceAccess> RequiredResourceAccess { get; set; }
        ...
        public Microsoft.Graph.Models.VerifiedPublisher VerifiedPublisher { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"addIns", (o,n) => { (o as Application).AddIns = n.GetCollectionOfObjectValues<AddIn>(AddIn.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"optionalClaims", (o,n) => { (o as Application).OptionalClaims = n.GetObjectValue<Microsoft.Graph.Models.OptionalClaims>(Microsoft.Graph.Models.OptionalClaims.CreateFromDiscriminatorValue); } },
                ...
                {"parentalControlSettings", (o,n) => { (o as Application).ParentalControlSettings = n.GetObjectValue<Microsoft.Graph.Models.ParentalControlSettings>(Microsoft.Graph.Models.ParentalControlSettings.CreateFromDiscriminatorValue); } },
                ...
                {"requiredResourceAccess", (o,n) => { (o as Application).RequiredResourceAccess = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.RequiredResourceAccess>(Microsoft.Graph.Models.RequiredResourceAccess.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"verifiedPublisher", (o,n) => { (o as Application).VerifiedPublisher = n.GetObjectValue<Microsoft.Graph.Models.VerifiedPublisher>(Microsoft.Graph.Models.VerifiedPublisher.CreateFromDiscriminatorValue); } },
