...
namespace Microsoft.Graph.Models {
    public class ServicePrincipal : DirectoryObject, IParsable {
        ...
        public Microsoft.Graph.Models.SamlSingleSignOnSettings SamlSingleSignOnSettings { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"oauth2PermissionScopes", (o,n) => { (o as ServicePrincipal).Oauth2PermissionScopes = n.GetCollectionOfObjectValues<PermissionScope>(PermissionScope.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"samlSingleSignOnSettings", (o,n) => { (o as ServicePrincipal).SamlSingleSignOnSettings = n.GetObjectValue<Microsoft.Graph.Models.SamlSingleSignOnSettings>(Microsoft.Graph.Models.SamlSingleSignOnSettings.CreateFromDiscriminatorValue); } },
