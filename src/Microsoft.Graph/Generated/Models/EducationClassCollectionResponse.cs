...
namespace Microsoft.Graph.Models {
    public class EducationClassCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EducationClass> Value {
            get { return BackingStore?.Get<List<EducationClass>>(nameof(Value)); }
