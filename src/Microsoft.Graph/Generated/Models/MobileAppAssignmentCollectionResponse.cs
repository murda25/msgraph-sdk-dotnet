...
namespace Microsoft.Graph.Models {
    public class MobileAppAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MobileAppAssignment> Value {
            get { return BackingStore?.Get<List<MobileAppAssignment>>(nameof(Value)); }
