...
namespace Microsoft.Graph.Models {
    public class DeviceComplianceScheduledActionForRuleCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceComplianceScheduledActionForRule> Value {
            get { return BackingStore?.Get<List<DeviceComplianceScheduledActionForRule>>(nameof(Value)); }
