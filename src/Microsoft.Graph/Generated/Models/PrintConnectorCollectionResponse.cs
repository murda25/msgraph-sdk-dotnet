...
namespace Microsoft.Graph.Models {
    public class PrintConnectorCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PrintConnector> Value {
            get { return BackingStore?.Get<List<PrintConnector>>(nameof(Value)); }
