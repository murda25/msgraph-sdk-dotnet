...
namespace Microsoft.Graph.Models.CallRecords {
    public class Endpoint : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.CallRecords.UserAgent UserAgent { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"userAgent", (o,n) => { (o as Endpoint).UserAgent = n.GetObjectValue<Microsoft.Graph.Models.CallRecords.UserAgent>(Microsoft.Graph.Models.CallRecords.UserAgent.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
