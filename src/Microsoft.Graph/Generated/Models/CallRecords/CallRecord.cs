...
namespace Microsoft.Graph.Models.CallRecords {
    public class CallRecord : Entity, IParsable {
        ...
        public Microsoft.Graph.Models.IdentitySet Organizer { get; set; }
        /// <summary>List of distinct identities involved in the call.</summary>
        public List<Microsoft.Graph.Models.IdentitySet> Participants { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"organizer", (o,n) => { (o as CallRecord).Organizer = n.GetObjectValue<Microsoft.Graph.Models.IdentitySet>(Microsoft.Graph.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                {"participants", (o,n) => { (o as CallRecord).Participants = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.IdentitySet>(Microsoft.Graph.Models.IdentitySet.CreateFromDiscriminatorValue).ToList(); } },
