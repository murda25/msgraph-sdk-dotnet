...
namespace Microsoft.Graph.Models {
    public class ChatMessageHostedContentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ChatMessageHostedContent> Value {
            get { return BackingStore?.Get<List<ChatMessageHostedContent>>(nameof(Value)); }
