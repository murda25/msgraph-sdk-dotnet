...
namespace Microsoft.Graph.Models {
    public class ChatMessageHostedContentCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ChatMessageHostedContentCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ChatMessageHostedContentCollectionResponse).Value = n.GetCollectionOfObjectValues<ChatMessageHostedContent>(ChatMessageHostedContent.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
