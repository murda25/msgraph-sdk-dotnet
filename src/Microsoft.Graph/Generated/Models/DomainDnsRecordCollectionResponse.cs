...
namespace Microsoft.Graph.Models {
    public class DomainDnsRecordCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static DomainDnsRecordCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DomainDnsRecordCollectionResponse).Value = n.GetCollectionOfObjectValues<DomainDnsRecord>(DomainDnsRecord.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
