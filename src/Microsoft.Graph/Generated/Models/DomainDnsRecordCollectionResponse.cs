...
namespace Microsoft.Graph.Models {
    public class DomainDnsRecordCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DomainDnsRecord> Value {
            get { return BackingStore?.Get<List<DomainDnsRecord>>(nameof(Value)); }
