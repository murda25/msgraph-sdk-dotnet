...
namespace Microsoft.Graph.Models {
    public class AccessPackageAssignmentRequestCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessPackageAssignmentRequest> Value {
            get { return BackingStore?.Get<List<AccessPackageAssignmentRequest>>(nameof(Value)); }
