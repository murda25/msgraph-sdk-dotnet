...
namespace Microsoft.Graph.Models {
    public class Recipient : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.EmailAddress EmailAddress { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"emailAddress", (o,n) => { (o as Recipient).EmailAddress = n.GetObjectValue<Microsoft.Graph.Models.EmailAddress>(Microsoft.Graph.Models.EmailAddress.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
