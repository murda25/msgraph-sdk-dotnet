...
namespace Microsoft.Graph.Models {
    public class InferenceClassificationOverrideCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<InferenceClassificationOverride> Value {
            get { return BackingStore?.Get<List<InferenceClassificationOverride>>(nameof(Value)); }
