    ...
    public class ItemActivityStat : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"incompleteData", (o,n) => { (o as ItemActivityStat).IncompleteData = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.IncompleteData>(MicrosoftGraphSdk.Models.Microsoft.Graph.IncompleteData.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.IncompleteData>("incompleteData", IncompleteData);
