    ...
    public class SharedInsight : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"resourceReference", (o,n) => { (o as SharedInsight).ResourceReference = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceReference>(MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceReference.CreateFromDiscriminatorValue); } },
                {"resourceVisualization", (o,n) => { (o as SharedInsight).ResourceVisualization = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceVisualization>(MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceVisualization.CreateFromDiscriminatorValue); } },
