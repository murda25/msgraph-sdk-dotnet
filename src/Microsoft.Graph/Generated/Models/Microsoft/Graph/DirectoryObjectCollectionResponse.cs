...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class DirectoryObjectCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static DirectoryObjectCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DirectoryObjectCollectionResponse).Value = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
