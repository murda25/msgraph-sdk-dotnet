...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class AppConsentRequestCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static AppConsentRequestCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as AppConsentRequestCollectionResponse).Value = n.GetCollectionOfObjectValues<AppConsentRequest>(AppConsentRequest.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
