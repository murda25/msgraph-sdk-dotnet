...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class UsedInsightCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        /// </summary>
        public static UsedInsightCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UsedInsightCollectionResponse).Value = n.GetCollectionOfObjectValues<UsedInsight>(UsedInsight.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
