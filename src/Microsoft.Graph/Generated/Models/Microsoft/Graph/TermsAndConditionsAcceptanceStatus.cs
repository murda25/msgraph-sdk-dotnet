    ...
    public class TermsAndConditionsAcceptanceStatus : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"termsAndConditions", (o,n) => { (o as TermsAndConditionsAcceptanceStatus).TermsAndConditions = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.TermsAndConditions>(); } },
