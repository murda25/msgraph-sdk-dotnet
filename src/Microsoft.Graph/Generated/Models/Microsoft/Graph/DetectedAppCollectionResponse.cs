...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class DetectedAppCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as DetectedAppCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as DetectedAppCollectionResponse).Value = n.GetCollectionOfObjectValues<DetectedApp>(DetectedApp.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
