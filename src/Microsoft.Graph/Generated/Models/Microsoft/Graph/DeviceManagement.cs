...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class DeviceManagement : Entity, IParsable {
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceCategory> DeviceCategories { get; set; }
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.RoleDefinition> RoleDefinitions { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"applePushNotificationCertificate", (o,n) => { (o as DeviceManagement).ApplePushNotificationCertificate = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ApplePushNotificationCertificate>(); } },
                ...
                {"deviceCategories", (o,n) => { (o as DeviceManagement).DeviceCategories = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceCategory>().ToList(); } },
                ...
                {"deviceCompliancePolicyDeviceStateSummary", (o,n) => { (o as DeviceManagement).DeviceCompliancePolicyDeviceStateSummary = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceCompliancePolicyDeviceStateSummary>(); } },
                ...
                {"managedDeviceOverview", (o,n) => { (o as DeviceManagement).ManagedDeviceOverview = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ManagedDeviceOverview>(); } },
                ...
                {"roleDefinitions", (o,n) => { (o as DeviceManagement).RoleDefinitions = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.RoleDefinition>().ToList(); } },
                {"settings", (o,n) => { (o as DeviceManagement).Settings = n.GetObjectValue<DeviceManagementSettings>(); } },
                {"softwareUpdateStatusSummary", (o,n) => { (o as DeviceManagement).SoftwareUpdateStatusSummary = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.SoftwareUpdateStatusSummary>(); } },
                ...
                {"termsAndConditions", (o,n) => { (o as DeviceManagement).TermsAndConditions = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.TermsAndConditions>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.DeviceCategory>("deviceCategories", DeviceCategories);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.RoleDefinition>("roleDefinitions", RoleDefinitions);
