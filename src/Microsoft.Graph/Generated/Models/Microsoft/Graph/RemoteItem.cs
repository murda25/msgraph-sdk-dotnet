...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class RemoteItem : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"file", (o,n) => { (o as RemoteItem).File = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.File>(MicrosoftGraphSdk.Models.Microsoft.Graph.File.CreateFromDiscriminatorValue); } },
                {"fileSystemInfo", (o,n) => { (o as RemoteItem).FileSystemInfo = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.FileSystemInfo>(MicrosoftGraphSdk.Models.Microsoft.Graph.FileSystemInfo.CreateFromDiscriminatorValue); } },
                {"folder", (o,n) => { (o as RemoteItem).Folder = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Folder>(MicrosoftGraphSdk.Models.Microsoft.Graph.Folder.CreateFromDiscriminatorValue); } },
                {"id", (o,n) => { (o as RemoteItem).Id = n.GetStringValue(); } },
                {"image", (o,n) => { (o as RemoteItem).Image = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Image>(MicrosoftGraphSdk.Models.Microsoft.Graph.Image.CreateFromDiscriminatorValue); } },
                ...
                {"package", (o,n) => { (o as RemoteItem).Package = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Package>(MicrosoftGraphSdk.Models.Microsoft.Graph.Package.CreateFromDiscriminatorValue); } },
