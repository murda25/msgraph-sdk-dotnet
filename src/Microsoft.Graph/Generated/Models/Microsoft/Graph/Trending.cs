    ...
    public class Trending : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"resource", (o,n) => { (o as Trending).Resource = n.GetObjectValue<Entity>(Entity.CreateFromDiscriminatorValue); } },
                {"resourceReference", (o,n) => { (o as Trending).ResourceReference = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceReference>(MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceReference.CreateFromDiscriminatorValue); } },
                {"resourceVisualization", (o,n) => { (o as Trending).ResourceVisualization = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceVisualization>(MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceVisualization.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceReference>("resourceReference", ResourceReference);
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.ResourceVisualization>("resourceVisualization", ResourceVisualization);
