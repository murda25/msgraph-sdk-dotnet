...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class SubjectRightsRequestDetail : IParsable {
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.KeyValuePair> InsightCounts { get; set; }
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.KeyValuePair> ProductItemCounts { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"insightCounts", (o,n) => { (o as SubjectRightsRequestDetail).InsightCounts = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.KeyValuePair>().ToList(); } },
                ...
                {"productItemCounts", (o,n) => { (o as SubjectRightsRequestDetail).ProductItemCounts = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.KeyValuePair>().ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.KeyValuePair>("insightCounts", InsightCounts);
            writer.WriteLongValue("itemCount", ItemCount);
            writer.WriteLongValue("itemNeedReview", ItemNeedReview);
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.KeyValuePair>("productItemCounts", ProductItemCounts);
