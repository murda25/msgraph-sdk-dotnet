    ...
    public class WindowsHelloForBusinessAuthenticationMethod : AuthenticationMethod, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"device", (o,n) => { (o as WindowsHelloForBusinessAuthenticationMethod).Device = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Device>(MicrosoftGraphSdk.Models.Microsoft.Graph.Device.CreateFromDiscriminatorValue); } },
