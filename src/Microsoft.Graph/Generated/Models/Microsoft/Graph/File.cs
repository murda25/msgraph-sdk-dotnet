...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class File : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"hashes", (o,n) => { (o as File).Hashes = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Hashes>(MicrosoftGraphSdk.Models.Microsoft.Graph.Hashes.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.Hashes>("hashes", Hashes);
