...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class SecureScoreControlProfile : Entity, IParsable {
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.ComplianceInformation> ComplianceInformation { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"complianceInformation", (o,n) => { (o as SecureScoreControlProfile).ComplianceInformation = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.ComplianceInformation>(MicrosoftGraphSdk.Models.Microsoft.Graph.ComplianceInformation.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.ComplianceInformation>("complianceInformation", ComplianceInformation);
