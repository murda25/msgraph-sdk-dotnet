...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class PolicyRoot : Entity, IParsable {
        ...
        public MicrosoftGraphSdk.Models.Microsoft.Graph.AuthorizationPolicy AuthorizationPolicy { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"adminConsentRequestPolicy", (o,n) => { (o as PolicyRoot).AdminConsentRequestPolicy = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AdminConsentRequestPolicy>(); } },
                {"authenticationFlowsPolicy", (o,n) => { (o as PolicyRoot).AuthenticationFlowsPolicy = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AuthenticationFlowsPolicy>(); } },
                {"authenticationMethodsPolicy", (o,n) => { (o as PolicyRoot).AuthenticationMethodsPolicy = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AuthenticationMethodsPolicy>(); } },
                {"authorizationPolicy", (o,n) => { (o as PolicyRoot).AuthorizationPolicy = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AuthorizationPolicy>(); } },
                ...
                {"identitySecurityDefaultsEnforcementPolicy", (o,n) => { (o as PolicyRoot).IdentitySecurityDefaultsEnforcementPolicy = n.GetObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.IdentitySecurityDefaultsEnforcementPolicy>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraphSdk.Models.Microsoft.Graph.AuthorizationPolicy>("authorizationPolicy", AuthorizationPolicy);
