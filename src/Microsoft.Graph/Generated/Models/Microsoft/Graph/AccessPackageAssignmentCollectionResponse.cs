...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class AccessPackageAssignmentCollectionResponse : IParsable, IAdditionalDataHolder {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as AccessPackageAssignmentCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as AccessPackageAssignmentCollectionResponse).Value = n.GetCollectionOfObjectValues<AccessPackageAssignment>(AccessPackageAssignment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
