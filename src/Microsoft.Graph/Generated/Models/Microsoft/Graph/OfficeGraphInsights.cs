...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    ...
    public class OfficeGraphInsights : Entity, IParsable {
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.Trending> Trending { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"trending", (o,n) => { (o as OfficeGraphInsights).Trending = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.Trending>(MicrosoftGraphSdk.Models.Microsoft.Graph.Trending.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.Trending>("trending", Trending);
