...
namespace MicrosoftGraphSdk.Models.Microsoft.Graph {
    public class Print : IParsable {
        ...
        public List<MicrosoftGraphSdk.Models.Microsoft.Graph.Printer> Printers { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"printers", (o,n) => { (o as Print).Printers = n.GetCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.Printer>().ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraphSdk.Models.Microsoft.Graph.Printer>("printers", Printers);
