...
namespace Microsoft.Graph.Models {
    public class LicenseDetailsCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<LicenseDetails> Value {
            get { return BackingStore?.Get<List<LicenseDetails>>(nameof(Value)); }
