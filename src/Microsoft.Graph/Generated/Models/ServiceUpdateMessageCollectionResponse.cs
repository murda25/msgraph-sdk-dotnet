...
namespace Microsoft.Graph.Models {
    public class ServiceUpdateMessageCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ServiceUpdateMessage> Value {
            get { return BackingStore?.Get<List<ServiceUpdateMessage>>(nameof(Value)); }
