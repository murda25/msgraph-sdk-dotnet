...
namespace Microsoft.Graph.Models {
    public class UnifiedRoleAssignmentScheduleRequestCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedRoleAssignmentScheduleRequest> Value {
            get { return BackingStore?.Get<List<UnifiedRoleAssignmentScheduleRequest>>(nameof(Value)); }
