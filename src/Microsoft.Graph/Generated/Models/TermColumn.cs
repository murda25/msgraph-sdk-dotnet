...
namespace Microsoft.Graph.Models {
    public class TermColumn : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.TermStore.Set TermSet { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"termSet", (o,n) => { (o as TermColumn).TermSet = n.GetObjectValue<Microsoft.Graph.Models.TermStore.Set>(Microsoft.Graph.Models.TermStore.Set.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
