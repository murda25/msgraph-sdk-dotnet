...
namespace Microsoft.Graph.Models {
    public class CalendarGroupCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static CalendarGroupCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as CalendarGroupCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as CalendarGroupCollectionResponse).Value = n.GetCollectionOfObjectValues<CalendarGroup>(CalendarGroup.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
