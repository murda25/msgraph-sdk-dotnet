...
namespace Microsoft.Graph.Models {
    public class RoleAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RoleAssignment> Value {
            get { return BackingStore?.Get<List<RoleAssignment>>(nameof(Value)); }
