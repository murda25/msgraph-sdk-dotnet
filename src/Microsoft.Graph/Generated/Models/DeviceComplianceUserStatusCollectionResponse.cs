...
namespace Microsoft.Graph.Models {
    public class DeviceComplianceUserStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceComplianceUserStatus> Value {
            get { return BackingStore?.Get<List<DeviceComplianceUserStatus>>(nameof(Value)); }
