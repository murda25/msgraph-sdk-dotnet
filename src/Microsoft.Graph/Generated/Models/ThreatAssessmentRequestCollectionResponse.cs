...
namespace Microsoft.Graph.Models {
    public class ThreatAssessmentRequestCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ThreatAssessmentRequest> Value {
            get { return BackingStore?.Get<List<ThreatAssessmentRequest>>(nameof(Value)); }
