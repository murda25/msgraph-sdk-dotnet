...
namespace Microsoft.Graph.Models {
    public class SecureScoreControlProfile : Entity, IParsable {
        ...
        public List<Microsoft.Graph.Models.ComplianceInformation> ComplianceInformation { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"complianceInformation", (o,n) => { (o as SecureScoreControlProfile).ComplianceInformation = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ComplianceInformation>(Microsoft.Graph.Models.ComplianceInformation.CreateFromDiscriminatorValue).ToList(); } },
