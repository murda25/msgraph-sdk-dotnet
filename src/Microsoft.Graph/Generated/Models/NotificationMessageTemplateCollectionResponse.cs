...
namespace Microsoft.Graph.Models {
    public class NotificationMessageTemplateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<NotificationMessageTemplate> Value {
            get { return BackingStore?.Get<List<NotificationMessageTemplate>>(nameof(Value)); }
