    ...
    public class MicrosoftAuthenticatorAuthenticationMethod : AuthenticationMethod, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"device", (o,n) => { (o as MicrosoftAuthenticatorAuthenticationMethod).Device = n.GetObjectValue<Microsoft.Graph.Models.Device>(Microsoft.Graph.Models.Device.CreateFromDiscriminatorValue); } },
