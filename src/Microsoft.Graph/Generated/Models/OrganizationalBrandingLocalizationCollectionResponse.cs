...
namespace Microsoft.Graph.Models {
    public class OrganizationalBrandingLocalizationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OrganizationalBrandingLocalization> Value {
            get { return BackingStore?.Get<List<OrganizationalBrandingLocalization>>(nameof(Value)); }
