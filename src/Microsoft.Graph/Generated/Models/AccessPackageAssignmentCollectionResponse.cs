...
namespace Microsoft.Graph.Models {
    public class AccessPackageAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessPackageAssignment> Value {
            get { return BackingStore?.Get<List<AccessPackageAssignment>>(nameof(Value)); }
