...
namespace Microsoft.Graph.Models {
    public class DeviceComplianceDeviceStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceComplianceDeviceStatus> Value {
            get { return BackingStore?.Get<List<DeviceComplianceDeviceStatus>>(nameof(Value)); }
