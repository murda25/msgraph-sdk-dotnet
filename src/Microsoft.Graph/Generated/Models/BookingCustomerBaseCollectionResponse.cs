...
namespace Microsoft.Graph.Models {
    public class BookingCustomerBaseCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<BookingCustomerBase> Value {
            get { return BackingStore?.Get<List<BookingCustomerBase>>(nameof(Value)); }
