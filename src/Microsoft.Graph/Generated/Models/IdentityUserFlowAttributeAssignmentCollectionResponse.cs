...
namespace Microsoft.Graph.Models {
    public class IdentityUserFlowAttributeAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<IdentityUserFlowAttributeAssignment> Value {
            get { return BackingStore?.Get<List<IdentityUserFlowAttributeAssignment>>(nameof(Value)); }
