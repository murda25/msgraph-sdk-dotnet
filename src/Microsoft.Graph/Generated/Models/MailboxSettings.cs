...
namespace Microsoft.Graph.Models {
    public class MailboxSettings : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.AutomaticRepliesSetting AutomaticRepliesSetting { get; set; }
        ...
        public Microsoft.Graph.Models.DelegateMeetingMessageDeliveryOptions? DelegateMeetingMessageDeliveryOptions { get; set; }
        ...
        public Microsoft.Graph.Models.UserPurpose? UserPurpose { get; set; }
        /// <summary>The days of the week and hours in a specific time zone that the user works.</summary>
        public Microsoft.Graph.Models.WorkingHours WorkingHours { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"automaticRepliesSetting", (o,n) => { (o as MailboxSettings).AutomaticRepliesSetting = n.GetObjectValue<Microsoft.Graph.Models.AutomaticRepliesSetting>(Microsoft.Graph.Models.AutomaticRepliesSetting.CreateFromDiscriminatorValue); } },
                ...
                {"workingHours", (o,n) => { (o as MailboxSettings).WorkingHours = n.GetObjectValue<Microsoft.Graph.Models.WorkingHours>(Microsoft.Graph.Models.WorkingHours.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
