...
namespace Microsoft.Graph.Models {
    public class UnifiedRoleDefinitionCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static UnifiedRoleDefinitionCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UnifiedRoleDefinitionCollectionResponse).Value = n.GetCollectionOfObjectValues<UnifiedRoleDefinition>(UnifiedRoleDefinition.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
