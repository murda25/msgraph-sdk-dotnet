...
namespace Microsoft.Graph.Models {
    public class RequiredResourceAccess : IAdditionalDataHolder, IParsable {
        ...
        public List<Microsoft.Graph.Models.ResourceAccess> ResourceAccess { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"resourceAccess", (o,n) => { (o as RequiredResourceAccess).ResourceAccess = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ResourceAccess>(Microsoft.Graph.Models.ResourceAccess.CreateFromDiscriminatorValue).ToList(); } },
