...
namespace Microsoft.Graph.Models {
    public class IdentityGovernance : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.EntitlementManagement EntitlementManagement { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"entitlementManagement", (o,n) => { (o as IdentityGovernance).EntitlementManagement = n.GetObjectValue<Microsoft.Graph.Models.EntitlementManagement>(Microsoft.Graph.Models.EntitlementManagement.CreateFromDiscriminatorValue); } },
