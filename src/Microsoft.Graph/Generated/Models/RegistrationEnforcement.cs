    ...
    public class RegistrationEnforcement : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"authenticationMethodsRegistrationCampaign", (o,n) => { (o as RegistrationEnforcement).AuthenticationMethodsRegistrationCampaign = n.GetObjectValue<Microsoft.Graph.Models.AuthenticationMethodsRegistrationCampaign>(Microsoft.Graph.Models.AuthenticationMethodsRegistrationCampaign.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
