...
namespace Microsoft.Graph.Models {
    public class DeviceConfigurationStateCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceConfigurationState> Value {
            get { return BackingStore?.Get<List<DeviceConfigurationState>>(nameof(Value)); }
