...
namespace Microsoft.Graph.Models {
    public class ItemActivityStat : Entity, IParsable {
        ...
        public Microsoft.Graph.Models.IncompleteData IncompleteData { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"incompleteData", (o,n) => { (o as ItemActivityStat).IncompleteData = n.GetObjectValue<Microsoft.Graph.Models.IncompleteData>(Microsoft.Graph.Models.IncompleteData.CreateFromDiscriminatorValue); } },
