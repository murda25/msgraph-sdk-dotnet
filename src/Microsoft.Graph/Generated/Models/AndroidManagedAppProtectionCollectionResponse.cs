...
namespace Microsoft.Graph.Models {
    public class AndroidManagedAppProtectionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AndroidManagedAppProtection> Value {
            get { return BackingStore?.Get<List<AndroidManagedAppProtection>>(nameof(Value)); }
