...
namespace Microsoft.Graph.Models {
    public class SignInLocation : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.GeoCoordinates GeoCoordinates { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"geoCoordinates", (o,n) => { (o as SignInLocation).GeoCoordinates = n.GetObjectValue<Microsoft.Graph.Models.GeoCoordinates>(Microsoft.Graph.Models.GeoCoordinates.CreateFromDiscriminatorValue); } },
