...
namespace Microsoft.Graph.Models {
    public class EducationRubricCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EducationRubric> Value {
            get { return BackingStore?.Get<List<EducationRubric>>(nameof(Value)); }
