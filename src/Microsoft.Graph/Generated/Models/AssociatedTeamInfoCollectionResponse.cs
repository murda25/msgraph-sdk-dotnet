...
namespace Microsoft.Graph.Models {
    public class AssociatedTeamInfoCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AssociatedTeamInfo> Value {
            get { return BackingStore?.Get<List<AssociatedTeamInfo>>(nameof(Value)); }
