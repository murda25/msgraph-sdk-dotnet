...
namespace Microsoft.Graph.Models {
    public class DeviceConfigurationCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static DeviceConfigurationCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as DeviceConfigurationCollectionResponse).Value = n.GetCollectionOfObjectValues<DeviceConfiguration>(DeviceConfiguration.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
