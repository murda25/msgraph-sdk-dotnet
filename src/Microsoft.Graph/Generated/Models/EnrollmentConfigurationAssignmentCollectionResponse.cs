...
namespace Microsoft.Graph.Models {
    public class EnrollmentConfigurationAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EnrollmentConfigurationAssignment> Value {
            get { return BackingStore?.Get<List<EnrollmentConfigurationAssignment>>(nameof(Value)); }
