...
namespace Microsoft.Graph.Models {
    public class ManagedDevice : Entity, IParsable {
        ...
        public Microsoft.Graph.Models.ComplianceState? ComplianceState { get; set; }
        /// <summary>ConfigrMgr client enabled features. This property is read-only.</summary>
        public Microsoft.Graph.Models.ConfigurationManagerClientEnabledFeatures ConfigurationManagerClientEnabledFeatures { get; set; }
        ...
        public Microsoft.Graph.Models.DeviceCategory DeviceCategory { get; set; }
        ...
        public Microsoft.Graph.Models.DeviceEnrollmentType? DeviceEnrollmentType { get; set; }
        /// <summary>The device health attestation state. This property is read-only.</summary>
        public Microsoft.Graph.Models.DeviceHealthAttestationState DeviceHealthAttestationState { get; set; }
        ...
        public Microsoft.Graph.Models.DeviceRegistrationState? DeviceRegistrationState { get; set; }
        ...
        public Microsoft.Graph.Models.ManagedDeviceOwnerType? ManagedDeviceOwnerType { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"configurationManagerClientEnabledFeatures", (o,n) => { (o as ManagedDevice).ConfigurationManagerClientEnabledFeatures = n.GetObjectValue<Microsoft.Graph.Models.ConfigurationManagerClientEnabledFeatures>(Microsoft.Graph.Models.ConfigurationManagerClientEnabledFeatures.CreateFromDiscriminatorValue); } },
                ...
                {"deviceCategory", (o,n) => { (o as ManagedDevice).DeviceCategory = n.GetObjectValue<Microsoft.Graph.Models.DeviceCategory>(Microsoft.Graph.Models.DeviceCategory.CreateFromDiscriminatorValue); } },
                ...
                {"deviceHealthAttestationState", (o,n) => { (o as ManagedDevice).DeviceHealthAttestationState = n.GetObjectValue<Microsoft.Graph.Models.DeviceHealthAttestationState>(Microsoft.Graph.Models.DeviceHealthAttestationState.CreateFromDiscriminatorValue); } },
