...
namespace Microsoft.Graph.Models {
    public class User : DirectoryObject, IParsable {
        ...
        public Microsoft.Graph.Models.Authentication Authentication { get; set; }
        ...
        public List<Microsoft.Graph.Models.Calendar> Calendars { get; set; }
        ...
        public Microsoft.Graph.Models.EmployeeOrgData EmployeeOrgData { get; set; }
        ...
        public Microsoft.Graph.Models.InferenceClassification InferenceClassification { get; set; }
        ...
        public List<Microsoft.Graph.Models.LicenseDetails> LicenseDetails { get; set; }
        ...
        public Microsoft.Graph.Models.MailboxSettings MailboxSettings { get; set; }
        ...
        public Microsoft.Graph.Models.OnPremisesExtensionAttributes OnPremisesExtensionAttributes { get; set; }
        ...
        public Microsoft.Graph.Models.Presence Presence { get; set; }
        ...
        public Microsoft.Graph.Models.Todo Todo { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"authentication", (o,n) => { (o as User).Authentication = n.GetObjectValue<Microsoft.Graph.Models.Authentication>(Microsoft.Graph.Models.Authentication.CreateFromDiscriminatorValue); } },
                ...
                {"calendar", (o,n) => { (o as User).Calendar = n.GetObjectValue<Microsoft.Graph.Models.Calendar>(Microsoft.Graph.Models.Calendar.CreateFromDiscriminatorValue); } },
                ...
                {"calendars", (o,n) => { (o as User).Calendars = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Calendar>(Microsoft.Graph.Models.Calendar.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"drive", (o,n) => { (o as User).Drive = n.GetObjectValue<Microsoft.Graph.Models.Drive>(Microsoft.Graph.Models.Drive.CreateFromDiscriminatorValue); } },
                {"drives", (o,n) => { (o as User).Drives = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Drive>(Microsoft.Graph.Models.Drive.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"employeeOrgData", (o,n) => { (o as User).EmployeeOrgData = n.GetObjectValue<Microsoft.Graph.Models.EmployeeOrgData>(Microsoft.Graph.Models.EmployeeOrgData.CreateFromDiscriminatorValue); } },
                ...
                {"inferenceClassification", (o,n) => { (o as User).InferenceClassification = n.GetObjectValue<Microsoft.Graph.Models.InferenceClassification>(Microsoft.Graph.Models.InferenceClassification.CreateFromDiscriminatorValue); } },
                ...
                {"licenseDetails", (o,n) => { (o as User).LicenseDetails = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.LicenseDetails>(Microsoft.Graph.Models.LicenseDetails.CreateFromDiscriminatorValue).ToList(); } },
                {"mail", (o,n) => { (o as User).Mail = n.GetStringValue(); } },
                {"mailboxSettings", (o,n) => { (o as User).MailboxSettings = n.GetObjectValue<Microsoft.Graph.Models.MailboxSettings>(Microsoft.Graph.Models.MailboxSettings.CreateFromDiscriminatorValue); } },
                ...
                {"onenote", (o,n) => { (o as User).Onenote = n.GetObjectValue<Microsoft.Graph.Models.Onenote>(Microsoft.Graph.Models.Onenote.CreateFromDiscriminatorValue); } },
                ...
                {"onPremisesExtensionAttributes", (o,n) => { (o as User).OnPremisesExtensionAttributes = n.GetObjectValue<Microsoft.Graph.Models.OnPremisesExtensionAttributes>(Microsoft.Graph.Models.OnPremisesExtensionAttributes.CreateFromDiscriminatorValue); } },
                ...
                {"passwordProfile", (o,n) => { (o as User).PasswordProfile = n.GetObjectValue<Microsoft.Graph.Models.PasswordProfile>(Microsoft.Graph.Models.PasswordProfile.CreateFromDiscriminatorValue); } },
                ...
                {"todo", (o,n) => { (o as User).Todo = n.GetObjectValue<Microsoft.Graph.Models.Todo>(Microsoft.Graph.Models.Todo.CreateFromDiscriminatorValue); } },
