...
namespace Microsoft.Graph.Models {
    public class ScopedRoleMembershipCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ScopedRoleMembership> Value {
            get { return BackingStore?.Get<List<ScopedRoleMembership>>(nameof(Value)); }
