...
namespace Microsoft.Graph.Models {
    public class AgreementFileVersionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AgreementFileVersion> Value {
            get { return BackingStore?.Get<List<AgreementFileVersion>>(nameof(Value)); }
