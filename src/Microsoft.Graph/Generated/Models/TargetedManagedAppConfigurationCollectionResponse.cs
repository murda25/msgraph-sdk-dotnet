...
namespace Microsoft.Graph.Models {
    public class TargetedManagedAppConfigurationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TargetedManagedAppConfiguration> Value {
            get { return BackingStore?.Get<List<TargetedManagedAppConfiguration>>(nameof(Value)); }
