...
namespace Microsoft.Graph.Models {
    public class TargetedManagedAppConfigurationCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static TargetedManagedAppConfigurationCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TargetedManagedAppConfigurationCollectionResponse).Value = n.GetCollectionOfObjectValues<TargetedManagedAppConfiguration>(TargetedManagedAppConfiguration.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
