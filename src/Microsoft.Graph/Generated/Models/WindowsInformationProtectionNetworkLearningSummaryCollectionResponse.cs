...
namespace Microsoft.Graph.Models {
    public class WindowsInformationProtectionNetworkLearningSummaryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<WindowsInformationProtectionNetworkLearningSummary> Value {
            get { return BackingStore?.Get<List<WindowsInformationProtectionNetworkLearningSummary>>(nameof(Value)); }
