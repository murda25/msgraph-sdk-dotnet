...
namespace Microsoft.Graph.Models {
    public class SectionGroupCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as SectionGroupCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as SectionGroupCollectionResponse).Value = n.GetCollectionOfObjectValues<SectionGroup>(SectionGroup.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
