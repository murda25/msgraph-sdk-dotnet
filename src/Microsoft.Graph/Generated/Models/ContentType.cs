...
namespace Microsoft.Graph.Models {
    public class ContentType : Entity, IParsable {
        ...
        public Microsoft.Graph.Models.DocumentSet DocumentSet { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"documentSet", (o,n) => { (o as ContentType).DocumentSet = n.GetObjectValue<Microsoft.Graph.Models.DocumentSet>(Microsoft.Graph.Models.DocumentSet.CreateFromDiscriminatorValue); } },
