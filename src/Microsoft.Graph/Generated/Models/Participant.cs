...
namespace Microsoft.Graph.Models {
    public class Participant : Entity, IParsable {
        ...
        public Microsoft.Graph.Models.RecordingInfo RecordingInfo { get; set; }
        /// <summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"recordingInfo", (o,n) => { (o as Participant).RecordingInfo = n.GetObjectValue<Microsoft.Graph.Models.RecordingInfo>(Microsoft.Graph.Models.RecordingInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
