...
namespace Microsoft.Graph.Models {
    public class ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ManagedDeviceMobileAppConfigurationAssignment> Value {
            get { return BackingStore?.Get<List<ManagedDeviceMobileAppConfigurationAssignment>>(nameof(Value)); }
