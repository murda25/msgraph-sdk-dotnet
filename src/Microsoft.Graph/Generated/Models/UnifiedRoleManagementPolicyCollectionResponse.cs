...
namespace Microsoft.Graph.Models {
    public class UnifiedRoleManagementPolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedRoleManagementPolicy> Value {
            get { return BackingStore?.Get<List<UnifiedRoleManagementPolicy>>(nameof(Value)); }
