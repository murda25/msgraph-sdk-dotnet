...
namespace Microsoft.Graph.Models {
    public class OpenShiftChangeRequestCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OpenShiftChangeRequest> Value {
            get { return BackingStore?.Get<List<OpenShiftChangeRequest>>(nameof(Value)); }
