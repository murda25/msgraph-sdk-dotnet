...
namespace Microsoft.Graph.Models.TermStore {
    public class Relation : Entity, IParsable {
        ...
        public Microsoft.Graph.Models.TermStore.Set Set { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"set", (o,n) => { (o as Relation).Set = n.GetObjectValue<Microsoft.Graph.Models.TermStore.Set>(Microsoft.Graph.Models.TermStore.Set.CreateFromDiscriminatorValue); } },
