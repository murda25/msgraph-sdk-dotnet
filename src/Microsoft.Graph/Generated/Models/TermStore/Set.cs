...
namespace Microsoft.Graph.Models.TermStore {
    public class Set : Entity, IParsable {
        ...
        public List<Microsoft.Graph.Models.KeyValue> Properties { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"properties", (o,n) => { (o as Set).Properties = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.KeyValue>(Microsoft.Graph.Models.KeyValue.CreateFromDiscriminatorValue).ToList(); } },
