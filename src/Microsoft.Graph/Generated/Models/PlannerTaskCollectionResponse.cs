...
namespace Microsoft.Graph.Models {
    public class PlannerTaskCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PlannerTask> Value {
            get { return BackingStore?.Get<List<PlannerTask>>(nameof(Value)); }
        ...
        /// </summary>
        public static PlannerTaskCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
