...
namespace Microsoft.Graph.Models {
    public class FileSecurityState : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.FileHash FileHash { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"fileHash", (o,n) => { (o as FileSecurityState).FileHash = n.GetObjectValue<Microsoft.Graph.Models.FileHash>(Microsoft.Graph.Models.FileHash.CreateFromDiscriminatorValue); } },
