...
namespace Microsoft.Graph.Models {
    public class AccessPackageCatalogCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AccessPackageCatalog> Value {
            get { return BackingStore?.Get<List<AccessPackageCatalog>>(nameof(Value)); }
