...
namespace Microsoft.Graph.Models {
    public class GroupLifecyclePolicyCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static GroupLifecyclePolicyCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as GroupLifecyclePolicyCollectionResponse).Value = n.GetCollectionOfObjectValues<GroupLifecyclePolicy>(GroupLifecyclePolicy.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
