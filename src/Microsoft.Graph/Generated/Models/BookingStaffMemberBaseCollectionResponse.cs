...
namespace Microsoft.Graph.Models {
    public class BookingStaffMemberBaseCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<BookingStaffMemberBase> Value {
            get { return BackingStore?.Get<List<BookingStaffMemberBase>>(nameof(Value)); }
