    ...
    public class BookingStaffMemberBaseCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as BookingStaffMemberBaseCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as BookingStaffMemberBaseCollectionResponse).Value = n.GetCollectionOfObjectValues<BookingStaffMemberBase>(BookingStaffMemberBase.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
