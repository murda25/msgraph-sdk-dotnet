...
namespace Microsoft.Graph.Models {
    public class Quota : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.StoragePlanInformation StoragePlanInformation { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"storagePlanInformation", (o,n) => { (o as Quota).StoragePlanInformation = n.GetObjectValue<Microsoft.Graph.Models.StoragePlanInformation>(Microsoft.Graph.Models.StoragePlanInformation.CreateFromDiscriminatorValue); } },
