...
namespace Microsoft.Graph.Models {
    public class AlertCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"@odata.nextLink", (o,n) => { (o as AlertCollectionResponse).NextLink = n.GetStringValue(); } },
                {"value", (o,n) => { (o as AlertCollectionResponse).Value = n.GetCollectionOfObjectValues<Alert>(Alert.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
