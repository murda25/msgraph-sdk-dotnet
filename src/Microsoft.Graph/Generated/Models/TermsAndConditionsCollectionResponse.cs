...
namespace Microsoft.Graph.Models {
    public class TermsAndConditionsCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TermsAndConditions> Value {
            get { return BackingStore?.Get<List<TermsAndConditions>>(nameof(Value)); }
