...
namespace Microsoft.Graph.Models {
    public class TokenIssuancePolicyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TokenIssuancePolicy> Value {
            get { return BackingStore?.Get<List<TokenIssuancePolicy>>(nameof(Value)); }
