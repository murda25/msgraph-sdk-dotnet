...
namespace Microsoft.Graph.Models.ODataErrors {
    public class MainError : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.ODataErrors.InnerError Innererror { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"innererror", (o,n) => { (o as MainError).Innererror = n.GetObjectValue<Microsoft.Graph.Models.ODataErrors.InnerError>(Microsoft.Graph.Models.ODataErrors.InnerError.CreateFromDiscriminatorValue); } },
