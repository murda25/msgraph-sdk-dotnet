...
namespace Microsoft.Graph.Models {
    public class InternalDomainFederationCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<InternalDomainFederation> Value {
            get { return BackingStore?.Get<List<InternalDomainFederation>>(nameof(Value)); }
