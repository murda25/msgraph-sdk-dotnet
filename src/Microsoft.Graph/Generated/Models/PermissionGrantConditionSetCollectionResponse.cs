...
namespace Microsoft.Graph.Models {
    public class PermissionGrantConditionSetCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<PermissionGrantConditionSet> Value {
            get { return BackingStore?.Get<List<PermissionGrantConditionSet>>(nameof(Value)); }
