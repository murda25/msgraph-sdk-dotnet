...
namespace Microsoft.Graph.Models {
    public class AudioRoutingGroupCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AudioRoutingGroup> Value {
            get { return BackingStore?.Get<List<AudioRoutingGroup>>(nameof(Value)); }
