...
namespace Microsoft.Graph.Models {
    public class ProvisioningObjectSummary : Entity, IParsable {
        ...
        public Microsoft.Graph.Models.ProvisioningAction? ProvisioningAction { get; set; }
        /// <summary>Details of provisioning status.</summary>
        public Microsoft.Graph.Models.ProvisioningStatusInfo ProvisioningStatusInfo { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"provisioningStatusInfo", (o,n) => { (o as ProvisioningObjectSummary).ProvisioningStatusInfo = n.GetObjectValue<Microsoft.Graph.Models.ProvisioningStatusInfo>(Microsoft.Graph.Models.ProvisioningStatusInfo.CreateFromDiscriminatorValue); } },
