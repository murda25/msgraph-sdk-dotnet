...
namespace Microsoft.Graph.Models {
    public class TemporaryAccessPassAuthenticationMethodCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<TemporaryAccessPassAuthenticationMethod> Value {
            get { return BackingStore?.Get<List<TemporaryAccessPassAuthenticationMethod>>(nameof(Value)); }
