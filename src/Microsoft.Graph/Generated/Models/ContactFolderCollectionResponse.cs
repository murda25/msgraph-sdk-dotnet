...
namespace Microsoft.Graph.Models {
    public class ContactFolderCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ContactFolder> Value {
            get { return BackingStore?.Get<List<ContactFolder>>(nameof(Value)); }
        ...
        /// </summary>
        public static ContactFolderCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
