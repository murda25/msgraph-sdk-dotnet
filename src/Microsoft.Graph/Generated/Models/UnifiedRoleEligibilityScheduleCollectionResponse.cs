...
namespace Microsoft.Graph.Models {
    public class UnifiedRoleEligibilityScheduleCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedRoleEligibilitySchedule> Value {
            get { return BackingStore?.Get<List<UnifiedRoleEligibilitySchedule>>(nameof(Value)); }
