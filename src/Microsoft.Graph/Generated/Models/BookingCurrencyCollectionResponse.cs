...
namespace Microsoft.Graph.Models {
    public class BookingCurrencyCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<BookingCurrency> Value {
            get { return BackingStore?.Get<List<BookingCurrency>>(nameof(Value)); }
