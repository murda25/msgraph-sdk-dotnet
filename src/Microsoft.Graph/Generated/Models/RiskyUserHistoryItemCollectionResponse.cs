...
namespace Microsoft.Graph.Models {
    public class RiskyUserHistoryItemCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RiskyUserHistoryItem> Value {
            get { return BackingStore?.Get<List<RiskyUserHistoryItem>>(nameof(Value)); }
