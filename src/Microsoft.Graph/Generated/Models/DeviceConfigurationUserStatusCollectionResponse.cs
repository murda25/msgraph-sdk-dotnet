...
namespace Microsoft.Graph.Models {
    public class DeviceConfigurationUserStatusCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceConfigurationUserStatus> Value {
            get { return BackingStore?.Get<List<DeviceConfigurationUserStatus>>(nameof(Value)); }
