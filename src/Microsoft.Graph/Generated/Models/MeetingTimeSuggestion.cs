...
namespace Microsoft.Graph.Models {
    public class MeetingTimeSuggestion : IAdditionalDataHolder, IParsable {
        ...
        public List<Microsoft.Graph.Models.AttendeeAvailability> AttendeeAvailability { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"attendeeAvailability", (o,n) => { (o as MeetingTimeSuggestion).AttendeeAvailability = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.AttendeeAvailability>(Microsoft.Graph.Models.AttendeeAvailability.CreateFromDiscriminatorValue).ToList(); } },
