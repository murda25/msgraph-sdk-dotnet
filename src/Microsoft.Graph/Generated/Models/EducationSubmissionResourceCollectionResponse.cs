...
namespace Microsoft.Graph.Models {
    public class EducationSubmissionResourceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<EducationSubmissionResource> Value {
            get { return BackingStore?.Get<List<EducationSubmissionResource>>(nameof(Value)); }
