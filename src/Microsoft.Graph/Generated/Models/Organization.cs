...
namespace Microsoft.Graph.Models {
    public class Organization : DirectoryObject, IParsable {
        ...
        public List<Microsoft.Graph.Models.CertificateBasedAuthConfiguration> CertificateBasedAuthConfiguration { get; set; }
        ...
        public Microsoft.Graph.Models.PrivacyProfile PrivacyProfile { get; set; }
        /// <summary>Not nullable.</summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"certificateBasedAuthConfiguration", (o,n) => { (o as Organization).CertificateBasedAuthConfiguration = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.CertificateBasedAuthConfiguration>(Microsoft.Graph.Models.CertificateBasedAuthConfiguration.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"privacyProfile", (o,n) => { (o as Organization).PrivacyProfile = n.GetObjectValue<Microsoft.Graph.Models.PrivacyProfile>(Microsoft.Graph.Models.PrivacyProfile.CreateFromDiscriminatorValue); } },
