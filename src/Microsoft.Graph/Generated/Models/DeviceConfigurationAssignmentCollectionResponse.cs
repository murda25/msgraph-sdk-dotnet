...
namespace Microsoft.Graph.Models {
    public class DeviceConfigurationAssignmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<DeviceConfigurationAssignment> Value {
            get { return BackingStore?.Get<List<DeviceConfigurationAssignment>>(nameof(Value)); }
