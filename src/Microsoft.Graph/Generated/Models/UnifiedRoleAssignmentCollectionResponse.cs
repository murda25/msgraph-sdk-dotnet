...
namespace Microsoft.Graph.Models {
    public class UnifiedRoleAssignmentCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static UnifiedRoleAssignmentCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as UnifiedRoleAssignmentCollectionResponse).Value = n.GetCollectionOfObjectValues<UnifiedRoleAssignment>(UnifiedRoleAssignment.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
