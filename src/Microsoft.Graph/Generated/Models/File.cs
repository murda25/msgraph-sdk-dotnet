...
namespace Microsoft.Graph.Models {
    public class File : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.Hashes Hashes { get; set; }
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"hashes", (o,n) => { (o as File).Hashes = n.GetObjectValue<Microsoft.Graph.Models.Hashes>(Microsoft.Graph.Models.Hashes.CreateFromDiscriminatorValue); } },
