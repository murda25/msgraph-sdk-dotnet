...
namespace Microsoft.Graph.Models {
    public class MeetingAttendanceReportCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<MeetingAttendanceReport> Value {
            get { return BackingStore?.Get<List<MeetingAttendanceReport>>(nameof(Value)); }
