...
namespace Microsoft.Graph.Models.ExternalConnectors {
    public class ExternalConnectionCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<ExternalConnection> Value {
            get { return BackingStore?.Get<List<ExternalConnection>>(nameof(Value)); }
