...
namespace Microsoft.Graph.Models.ExternalConnectors {
    public class ExternalItem : Entity, IParsable {
        ...
        public List<Microsoft.Graph.Models.ExternalConnectors.Acl> Acl { get; set; }
        ...
        public Microsoft.Graph.Models.ExternalConnectors.Properties Properties { get; set; }
        /// <summary>
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"acl", (o,n) => { (o as ExternalItem).Acl = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.ExternalConnectors.Acl>(Microsoft.Graph.Models.ExternalConnectors.Acl.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"properties", (o,n) => { (o as ExternalItem).Properties = n.GetObjectValue<Microsoft.Graph.Models.ExternalConnectors.Properties>(Microsoft.Graph.Models.ExternalConnectors.Properties.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
