...
namespace Microsoft.Graph.Models {
    public class Admin : IAdditionalDataHolder, IParsable {
        ...
        public Microsoft.Graph.Models.ServiceAnnouncement ServiceAnnouncement { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"serviceAnnouncement", (o,n) => { (o as Admin).ServiceAnnouncement = n.GetObjectValue<Microsoft.Graph.Models.ServiceAnnouncement>(Microsoft.Graph.Models.ServiceAnnouncement.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
