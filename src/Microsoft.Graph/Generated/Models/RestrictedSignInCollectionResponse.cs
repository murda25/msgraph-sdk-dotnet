...
namespace Microsoft.Graph.Models {
    public class RestrictedSignInCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<RestrictedSignIn> Value {
            get { return BackingStore?.Get<List<RestrictedSignIn>>(nameof(Value)); }
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"value", n => { Value = n.GetCollectionOfObjectValues<RestrictedSignIn>(RestrictedSignIn.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
