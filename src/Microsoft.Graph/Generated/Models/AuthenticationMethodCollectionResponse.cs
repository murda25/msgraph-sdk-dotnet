...
namespace Microsoft.Graph.Models {
    public class AuthenticationMethodCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<AuthenticationMethod> Value {
            get { return BackingStore?.Get<List<AuthenticationMethod>>(nameof(Value)); }
