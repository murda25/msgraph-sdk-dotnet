...
namespace Microsoft.Graph.Models {
    public class AuthenticationMethodCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static AuthenticationMethodCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as AuthenticationMethodCollectionResponse).Value = n.GetCollectionOfObjectValues<AuthenticationMethod>(AuthenticationMethod.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
