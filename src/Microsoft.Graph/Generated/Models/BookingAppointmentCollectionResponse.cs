...
namespace Microsoft.Graph.Models {
    public class BookingAppointmentCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<BookingAppointment> Value {
            get { return BackingStore?.Get<List<BookingAppointment>>(nameof(Value)); }
