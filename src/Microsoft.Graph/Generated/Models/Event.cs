...
namespace Microsoft.Graph.Models {
    public class Event : OutlookItem, IParsable {
        ...
        public Microsoft.Graph.Models.Location Location { get; set; }
        /// <summary>The locations property</summary>
        public List<Microsoft.Graph.Models.Location> Locations { get; set; }
        ...
        public Microsoft.Graph.Models.Sensitivity? Sensitivity { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"calendar", (o,n) => { (o as Event).Calendar = n.GetObjectValue<Microsoft.Graph.Models.Calendar>(Microsoft.Graph.Models.Calendar.CreateFromDiscriminatorValue); } },
                ...
                {"location", (o,n) => { (o as Event).Location = n.GetObjectValue<Microsoft.Graph.Models.Location>(Microsoft.Graph.Models.Location.CreateFromDiscriminatorValue); } },
                {"locations", (o,n) => { (o as Event).Locations = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Location>(Microsoft.Graph.Models.Location.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"responseStatus", (o,n) => { (o as Event).ResponseStatus = n.GetObjectValue<Microsoft.Graph.Models.ResponseStatus>(Microsoft.Graph.Models.ResponseStatus.CreateFromDiscriminatorValue); } },
