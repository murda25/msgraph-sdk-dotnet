...
namespace Microsoft.Graph.Models {
    ...
    public class Event : OutlookItem, IParsable {
        ...
        public string ICalUId {
            get { return BackingStore?.Get<string>(nameof(ICalUId)); }
            set { BackingStore?.Set(nameof(ICalUId), value); }
        }
        ...
        public List<Microsoft.Graph.Models.Location> Locations {
            get { return BackingStore?.Get<List<Microsoft.Graph.Models.Location>>(nameof(Locations)); }
        ...
        public Microsoft.Graph.Models.ResponseStatus ResponseStatus {
            get { return BackingStore?.Get<Microsoft.Graph.Models.ResponseStatus>(nameof(ResponseStatus)); }
