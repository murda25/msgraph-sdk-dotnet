...
namespace Microsoft.Graph.Models {
    public class UnifiedRoleEligibilityScheduleInstanceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<UnifiedRoleEligibilityScheduleInstance> Value {
            get { return BackingStore?.Get<List<UnifiedRoleEligibilityScheduleInstance>>(nameof(Value)); }
