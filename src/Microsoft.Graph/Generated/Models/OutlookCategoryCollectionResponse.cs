...
namespace Microsoft.Graph.Models {
    public class OutlookCategoryCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<OutlookCategory> Value {
            get { return BackingStore?.Get<List<OutlookCategory>>(nameof(Value)); }
