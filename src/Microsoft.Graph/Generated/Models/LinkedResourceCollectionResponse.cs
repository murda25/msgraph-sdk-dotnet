...
namespace Microsoft.Graph.Models {
    public class LinkedResourceCollectionResponse : IAdditionalDataHolder, IBackedModel, IParsable {
        ...
        public List<LinkedResource> Value {
            get { return BackingStore?.Get<List<LinkedResource>>(nameof(Value)); }
