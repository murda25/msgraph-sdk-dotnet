...
namespace Microsoft.Graph.Models {
    public class WindowsAutopilotDeviceIdentityCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static WindowsAutopilotDeviceIdentityCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as WindowsAutopilotDeviceIdentityCollectionResponse).Value = n.GetCollectionOfObjectValues<WindowsAutopilotDeviceIdentity>(WindowsAutopilotDeviceIdentity.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
