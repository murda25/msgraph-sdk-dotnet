...
namespace MicrosoftGraphSdk.SubscribedSkus.Item {
    ...
    public class SubscribedSkuRequestBuilder {
        ...
        /// </summary>
        public SubscribedSkuRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SubscribedSkuRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
