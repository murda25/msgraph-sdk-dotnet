...
namespace Microsoft.Graph.SubscribedSkus {
    ...
    public class SubscribedSkusRequestBuilder {
        ...
        /// </summary>
        public async Task<SubscribedSkuCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubscribedSkusRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SubscribedSku> PostAsync(SubscribedSku body, CancellationToken cancellationToken = default, Action<SubscribedSkusRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
