...
namespace Microsoft.Graph.AppCatalogs.TeamsApps.Item.AppDefinitions.Item {
    ...
    public class TeamsAppDefinitionItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.TeamsAppDefinition> GetAsync(CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.TeamsAppDefinition body, CancellationToken cancellationToken = default, Action<TeamsAppDefinitionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
