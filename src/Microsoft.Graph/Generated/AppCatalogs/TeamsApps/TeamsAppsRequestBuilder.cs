...
namespace Microsoft.Graph.AppCatalogs.TeamsApps {
    ...
    public class TeamsAppsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.TeamsApp> PostAsync(Microsoft.Graph.Models.TeamsApp body, CancellationToken cancellationToken = default, Action<TeamsAppsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
