...
using MicrosoftGraphSdk.Drive.Items.Item.Content;
...
namespace MicrosoftGraphSdk.Drive.Items.Item {
    /// <summary>Builds and executes requests for operations under \drive\items\{driveItem-id}</summary>
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem_id}{?select,expand}";
