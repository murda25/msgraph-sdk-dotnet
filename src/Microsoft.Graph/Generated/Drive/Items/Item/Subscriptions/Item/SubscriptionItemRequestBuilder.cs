using Microsoft.Graph.Drive.Items.Item.Subscriptions.Item.Reauthorize;
...
namespace Microsoft.Graph.Drive.Items.Item.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/subscriptions/{subscription%2Did}{?%24select,%24expand}";
