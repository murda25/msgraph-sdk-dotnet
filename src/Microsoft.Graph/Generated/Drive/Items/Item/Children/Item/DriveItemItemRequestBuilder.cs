using Microsoft.Graph.Drive.Items.Item.Children.Item.Content;
...
namespace Microsoft.Graph.Drive.Items.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}";
