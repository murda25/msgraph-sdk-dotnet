using Microsoft.Graph.Drive.Items.Item.Children.Count;
using Microsoft.Graph.Drive.Items.Item.Children.Item;
...
namespace Microsoft.Graph.Drive.Items.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.items.item.children.item collection</summary>
        public Microsoft.Graph.Drive.Items.Item.Children.Item.DriveItemItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("driveItem%2Did1", position);
            return new Microsoft.Graph.Drive.Items.Item.Children.Item.DriveItemItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
