using Microsoft.Graph.Drive.Items.Item.ListItem.Versions.Item.Fields;
using Microsoft.Graph.Drive.Items.Item.ListItem.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Drive.Items.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/versions/{listItemVersion%2Did}{?%24select,%24expand}";
