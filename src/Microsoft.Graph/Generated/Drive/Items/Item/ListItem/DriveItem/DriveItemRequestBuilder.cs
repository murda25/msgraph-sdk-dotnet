using Microsoft.Graph.Drive.Items.Item.ListItem.DriveItem.Content;
...
namespace Microsoft.Graph.Drive.Items.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/driveItem{?%24select,%24expand}";
