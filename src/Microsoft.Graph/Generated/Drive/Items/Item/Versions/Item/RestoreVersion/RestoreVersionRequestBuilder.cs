...
namespace Microsoft.Graph.Drive.Items.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}/microsoft.graph.restoreVersion";
