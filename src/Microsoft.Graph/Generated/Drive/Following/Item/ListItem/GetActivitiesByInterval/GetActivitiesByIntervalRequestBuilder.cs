...
namespace MicrosoftGraphSdk.Drive.Following.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        public GetActivitiesByIntervalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/listItem/microsoft.graph.getActivitiesByInterval()";
