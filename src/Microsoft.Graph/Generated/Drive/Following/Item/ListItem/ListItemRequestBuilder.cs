...
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.Analytics;
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.DriveItem;
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.Fields;
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.GetActivitiesByInterval;
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.Following.Item.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drive.Following.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/listItem{?select,expand}";
