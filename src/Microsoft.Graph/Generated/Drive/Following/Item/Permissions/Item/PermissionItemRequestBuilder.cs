...
using MicrosoftGraphSdk.Drive.Following.Item.Permissions.Item.Grant;
...
namespace MicrosoftGraphSdk.Drive.Following.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/following/{driveItem_id}/permissions/{permission_id}{?select,expand}";
