...
namespace MicrosoftGraphSdk.Drive.List {
    ...
    public class ListRequestBuilder {
        ...
        public MicrosoftGraphSdk.Drive.List.Drive.DriveRequestBuilder Drive { get =>
            new MicrosoftGraphSdk.Drive.List.Drive.DriveRequestBuilder(PathParameters, RequestAdapter);
        }
