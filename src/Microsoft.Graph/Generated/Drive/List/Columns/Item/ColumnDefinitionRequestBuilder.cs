...
using MicrosoftGraphSdk.Drive.List.Columns.Item.SourceColumn;
...
namespace MicrosoftGraphSdk.Drive.List.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public ColumnDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/columns/{columnDefinition_id}{?select,expand}";
