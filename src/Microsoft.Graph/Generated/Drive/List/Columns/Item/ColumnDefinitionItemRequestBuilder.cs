using Microsoft.Graph.Drive.List.Columns.Item.SourceColumn;
...
namespace Microsoft.Graph.Drive.List.Columns.Item {
    ...
    public class ColumnDefinitionItemRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/columns/{columnDefinition%2Did}{?%24select,%24expand}";
