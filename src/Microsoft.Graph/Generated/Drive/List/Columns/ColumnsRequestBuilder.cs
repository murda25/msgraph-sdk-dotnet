using Microsoft.Graph.Drive.List.Columns.Count;
using Microsoft.Graph.Drive.List.Columns.Item;
...
namespace Microsoft.Graph.Drive.List.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.list.columns.item collection</summary>
