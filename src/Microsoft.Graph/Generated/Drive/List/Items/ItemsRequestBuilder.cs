using Microsoft.Graph.Drive.List.Items.Count;
using Microsoft.Graph.Drive.List.Items.Item;
...
namespace Microsoft.Graph.Drive.List.Items {
    ...
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.list.items.item collection</summary>
