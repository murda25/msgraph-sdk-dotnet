...
using MicrosoftGraphSdk.Drive.List.Items.Item.Analytics;
using MicrosoftGraphSdk.Drive.List.Items.Item.DriveItem;
using MicrosoftGraphSdk.Drive.List.Items.Item.Fields;
using MicrosoftGraphSdk.Drive.List.Items.Item.GetActivitiesByInterval;
using MicrosoftGraphSdk.Drive.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.List.Items.Item.Versions;
...
namespace MicrosoftGraphSdk.Drive.List.Items.Item {
