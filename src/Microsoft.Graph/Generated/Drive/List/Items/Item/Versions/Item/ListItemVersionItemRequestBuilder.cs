using Microsoft.Graph.Drive.List.Items.Item.Versions.Item.Fields;
using Microsoft.Graph.Drive.List.Items.Item.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Drive.List.Items.Item.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}";
