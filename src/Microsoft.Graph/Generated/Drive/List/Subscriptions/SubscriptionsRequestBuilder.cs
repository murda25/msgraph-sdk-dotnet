using Microsoft.Graph.Drive.List.Subscriptions.Count;
using Microsoft.Graph.Drive.List.Subscriptions.Item;
...
namespace Microsoft.Graph.Drive.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.list.subscriptions.item collection</summary>
