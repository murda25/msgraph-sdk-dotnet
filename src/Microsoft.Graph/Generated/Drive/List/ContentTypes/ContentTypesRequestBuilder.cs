using Microsoft.Graph.Drive.List.ContentTypes.AddCopy;
using Microsoft.Graph.Drive.List.ContentTypes.AddCopyFromContentTypeHub;
using Microsoft.Graph.Drive.List.ContentTypes.Count;
using Microsoft.Graph.Drive.List.ContentTypes.GetCompatibleHubContentTypes;
using Microsoft.Graph.Drive.List.ContentTypes.Item;
...
namespace Microsoft.Graph.Drive.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.list.contentTypes.item collection</summary>
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
