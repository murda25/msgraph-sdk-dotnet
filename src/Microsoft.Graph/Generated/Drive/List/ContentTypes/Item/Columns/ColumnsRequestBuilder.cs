using Microsoft.Graph.Drive.List.ContentTypes.Item.Columns.Count;
using Microsoft.Graph.Drive.List.ContentTypes.Item.Columns.Item;
...
namespace Microsoft.Graph.Drive.List.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.list.contentTypes.item.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
