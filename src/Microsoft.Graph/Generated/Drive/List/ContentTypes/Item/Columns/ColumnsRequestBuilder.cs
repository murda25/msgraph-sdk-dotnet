...
using MicrosoftGraphSdk.Drive.List.ContentTypes.Item.Columns.Item;
...
namespace MicrosoftGraphSdk.Drive.List.ContentTypes.Item.Columns {
    /// <summary>Builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\columns</summary>
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.drive.list.contentTypes.item.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType_id}/columns{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
