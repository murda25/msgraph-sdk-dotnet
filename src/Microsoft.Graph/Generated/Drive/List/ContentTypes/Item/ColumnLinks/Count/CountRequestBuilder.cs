...
namespace Microsoft.Graph.Drive.List.ContentTypes.Item.ColumnLinks.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columnLinks/$count{?%24search,%24filter}";
