...
namespace Microsoft.Graph.Drive.List.ContentTypes.Item.ColumnPositions.Item {
    ...
    public class ColumnDefinitionItemRequestBuilder {
        ...
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columnPositions/{columnDefinition%2Did}{?%24select,%24expand}";
