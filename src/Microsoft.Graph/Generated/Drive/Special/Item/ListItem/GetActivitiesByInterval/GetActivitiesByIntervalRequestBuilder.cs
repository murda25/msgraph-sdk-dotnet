...
namespace MicrosoftGraphSdk.Drive.Special.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        public GetActivitiesByIntervalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/listItem/microsoft.graph.getActivitiesByInterval()";
