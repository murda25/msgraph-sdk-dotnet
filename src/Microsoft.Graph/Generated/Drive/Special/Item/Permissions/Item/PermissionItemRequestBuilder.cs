...
using MicrosoftGraphSdk.Drive.Special.Item.Permissions.Item.Grant;
...
namespace MicrosoftGraphSdk.Drive.Special.Item.Permissions.Item {
    ...
    public class PermissionItemRequestBuilder {
        ...
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/special/{driveItem_id}/permissions/{permission_id}{?select,expand}";
