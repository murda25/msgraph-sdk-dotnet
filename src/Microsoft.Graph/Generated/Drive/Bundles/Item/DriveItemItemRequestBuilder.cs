...
using MicrosoftGraphSdk.Drive.Bundles.Item.Analytics;
using MicrosoftGraphSdk.Drive.Bundles.Item.Children;
using MicrosoftGraphSdk.Drive.Bundles.Item.Content;
using MicrosoftGraphSdk.Drive.Bundles.Item.ListItem;
using MicrosoftGraphSdk.Drive.Bundles.Item.Permissions;
using MicrosoftGraphSdk.Drive.Bundles.Item.Subscriptions;
using MicrosoftGraphSdk.Drive.Bundles.Item.Thumbnails;
using MicrosoftGraphSdk.Drive.Bundles.Item.Versions;
...
namespace MicrosoftGraphSdk.Drive.Bundles.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem_id}{?select,expand}";
