using Microsoft.Graph.Drive.Bundles.Item.Content;
...
namespace Microsoft.Graph.Drive.Bundles.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/bundles/{driveItem%2Did}{?%24select,%24expand}";
