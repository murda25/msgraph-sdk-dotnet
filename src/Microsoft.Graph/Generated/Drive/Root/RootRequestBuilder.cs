using Microsoft.Graph.Drive.Root.Analytics;
using Microsoft.Graph.Drive.Root.Checkin;
using Microsoft.Graph.Drive.Root.Checkout;
using Microsoft.Graph.Drive.Root.Children;
using Microsoft.Graph.Drive.Root.Content;
using Microsoft.Graph.Drive.Root.Copy;
using Microsoft.Graph.Drive.Root.CreateLink;
using Microsoft.Graph.Drive.Root.CreateUploadSession;
using Microsoft.Graph.Drive.Root.Delta;
using Microsoft.Graph.Drive.Root.DeltaWithToken;
using Microsoft.Graph.Drive.Root.Follow;
using Microsoft.Graph.Drive.Root.GetActivitiesByInterval;
using Microsoft.Graph.Drive.Root.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Drive.Root.Invite;
using Microsoft.Graph.Drive.Root.ListItem;
using Microsoft.Graph.Drive.Root.Permissions;
using Microsoft.Graph.Drive.Root.Preview;
using Microsoft.Graph.Drive.Root.Restore;
using Microsoft.Graph.Drive.Root.SearchWithQ;
using Microsoft.Graph.Drive.Root.Subscriptions;
using Microsoft.Graph.Drive.Root.Thumbnails;
using Microsoft.Graph.Drive.Root.Unfollow;
using Microsoft.Graph.Drive.Root.ValidatePermission;
using Microsoft.Graph.Drive.Root.Versions;
