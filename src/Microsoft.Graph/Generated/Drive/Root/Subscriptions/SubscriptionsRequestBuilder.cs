using Microsoft.Graph.Drive.Root.Subscriptions.Count;
using Microsoft.Graph.Drive.Root.Subscriptions.Item;
...
namespace Microsoft.Graph.Drive.Root.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.root.subscriptions.item collection</summary>
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
