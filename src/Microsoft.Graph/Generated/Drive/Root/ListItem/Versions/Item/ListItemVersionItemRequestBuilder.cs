using Microsoft.Graph.Drive.Root.ListItem.Versions.Item.Fields;
using Microsoft.Graph.Drive.Root.ListItem.Versions.Item.RestoreVersion;
...
namespace Microsoft.Graph.Drive.Root.ListItem.Versions.Item {
    /// <summary>
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/listItem/versions/{listItemVersion%2Did}{?%24select,%24expand}";
