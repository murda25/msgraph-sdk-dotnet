using Microsoft.Graph.Drive.Root.ListItem.DocumentSetVersions.Count;
using Microsoft.Graph.Drive.Root.ListItem.DocumentSetVersions.Item;
...
namespace Microsoft.Graph.Drive.Root.ListItem.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.drive.root.listItem.documentSetVersions.item collection</summary>
        ...
        public DocumentSetVersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
