...
using MicrosoftGraphSdk.Drive.Root.ListItem.Analytics;
using MicrosoftGraphSdk.Drive.Root.ListItem.DriveItem;
using MicrosoftGraphSdk.Drive.Root.ListItem.Fields;
using MicrosoftGraphSdk.Drive.Root.ListItem.GetActivitiesByInterval;
using MicrosoftGraphSdk.Drive.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Drive.Root.ListItem.Versions;
...
namespace MicrosoftGraphSdk.Drive.Root.ListItem {
