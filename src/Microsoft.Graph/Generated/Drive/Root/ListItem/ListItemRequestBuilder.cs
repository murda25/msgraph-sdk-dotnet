using Microsoft.Graph.Drive.Root.ListItem.Analytics;
using Microsoft.Graph.Drive.Root.ListItem.DocumentSetVersions;
using Microsoft.Graph.Drive.Root.ListItem.DriveItem;
using Microsoft.Graph.Drive.Root.ListItem.Fields;
using Microsoft.Graph.Drive.Root.ListItem.GetActivitiesByInterval;
using Microsoft.Graph.Drive.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using Microsoft.Graph.Drive.Root.ListItem.Versions;
...
namespace Microsoft.Graph.Drive.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/listItem{?%24select,%24expand}";
