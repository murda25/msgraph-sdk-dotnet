...
namespace Microsoft.Graph.Chats.Item.MicrosoftGraphMarkChatUnreadForUser {
    /// <summary>
    ...
    public class MicrosoftGraphMarkChatUnreadForUserRequestBuilder {
        ...
        public MicrosoftGraphMarkChatUnreadForUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/chats/{chat%2Did}/microsoft.graph.markChatUnreadForUser";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphMarkChatUnreadForUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(MarkChatUnreadForUserPostRequestBody body, Action<MicrosoftGraphMarkChatUnreadForUserRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(MarkChatUnreadForUserPostRequestBody body, Action<MicrosoftGraphMarkChatUnreadForUserRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
