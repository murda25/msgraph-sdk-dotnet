...
namespace Microsoft.Graph.Chats.Item.PinnedMessages.Item.Message {
    ...
    public class MessageRequestBuilder {
        ...
        public MessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}/message{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<ChatMessage> GetAsync(Action<MessageRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <summary>Get message from chats</summary>
