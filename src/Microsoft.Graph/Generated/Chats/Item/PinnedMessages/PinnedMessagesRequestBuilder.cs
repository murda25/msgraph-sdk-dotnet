...
namespace Microsoft.Graph.Chats.Item.PinnedMessages {
    ...
    public class PinnedMessagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.chats.item.pinnedMessages.item collection</summary>
        ...
        public PinnedMessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/chats/{chat%2Did}/pinnedMessages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
