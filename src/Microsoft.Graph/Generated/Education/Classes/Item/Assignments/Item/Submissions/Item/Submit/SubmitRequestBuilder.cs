...
namespace Microsoft.Graph.Education.Classes.Item.Assignments.Item.Submissions.Item.Submit {
    ...
    public class SubmitRequestBuilder {
        ...
        public SubmitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/microsoft.graph.submit";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SubmitRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task<EducationSubmission> PostAsync(CancellationToken cancellationToken = default, Action<SubmitRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
