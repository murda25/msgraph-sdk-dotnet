...
namespace Microsoft.Graph.Education.Classes.Item.Assignments.Item.Submissions.Item.SubmittedResources {
    ...
    public class SubmittedResourcesRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationSubmissionResourceCollectionResponse> GetAsync(Action<SubmittedResourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSubmissionResource> PostAsync(EducationSubmissionResource body, Action<SubmittedResourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
