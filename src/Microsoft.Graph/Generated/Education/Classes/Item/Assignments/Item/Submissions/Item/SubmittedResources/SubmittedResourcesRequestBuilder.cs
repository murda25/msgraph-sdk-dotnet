...
namespace Microsoft.Graph.Education.Classes.Item.Assignments.Item.Submissions.Item.SubmittedResources {
    ...
    public class SubmittedResourcesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EducationSubmissionResource body, Action<SubmittedResourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<EducationSubmissionResourceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<SubmittedResourcesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationSubmissionResource> PostAsync(EducationSubmissionResource body, CancellationToken cancellationToken = default, Action<SubmittedResourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
