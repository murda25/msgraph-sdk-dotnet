...
namespace Microsoft.Graph.Education.Classes.Item.Assignments.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationAssignment> PostAsync(CancellationToken cancellationToken = default, Action<SetUpResourcesFolderRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
