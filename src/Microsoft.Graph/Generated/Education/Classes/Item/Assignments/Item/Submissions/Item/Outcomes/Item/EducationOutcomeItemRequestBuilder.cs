...
namespace Microsoft.Graph.Education.Classes.Item.Assignments.Item.Submissions.Item.Outcomes.Item {
    ...
    public class EducationOutcomeItemRequestBuilder {
        ...
        public EducationOutcomeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/outcomes/{educationOutcome%2Did}{?%24select,%24expand}";
