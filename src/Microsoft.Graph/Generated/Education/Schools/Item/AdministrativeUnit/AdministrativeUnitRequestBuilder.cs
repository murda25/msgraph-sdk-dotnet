...
namespace Microsoft.Graph.Education.Schools.Item.AdministrativeUnit {
    ...
    public class AdministrativeUnitRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.AdministrativeUnit> GetAsync(CancellationToken cancellationToken = default, Action<AdministrativeUnitRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
