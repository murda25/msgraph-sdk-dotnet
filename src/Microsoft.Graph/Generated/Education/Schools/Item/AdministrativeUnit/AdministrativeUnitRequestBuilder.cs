...
namespace Microsoft.Graph.Education.Schools.Item.AdministrativeUnit {
    ...
    public class AdministrativeUnitRequestBuilder {
        ...
        public AdministrativeUnitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/schools/{educationSchool_id}/administrativeUnit{?select,expand}";
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.AdministrativeUnit> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
