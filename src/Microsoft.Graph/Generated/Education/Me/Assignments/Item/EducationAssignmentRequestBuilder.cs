...
namespace MicrosoftGraphSdk.Education.Me.Assignments.Item {
    /// <summary>Builds and executes requests for operations under \education\me\assignments\{educationAssignment-id}</summary>
    public class EducationAssignmentRequestBuilder {
        ...
        public EducationAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/me/assignments/{educationAssignment_id}{?select,expand}";
