...
namespace Microsoft.Graph.Education.Users.Item.Rubrics {
    ...
    public class RubricsRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationRubricCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RubricsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationRubric> PostAsync(EducationRubric body, CancellationToken cancellationToken = default, Action<RubricsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
