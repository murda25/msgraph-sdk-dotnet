...
namespace Microsoft.Graph.Education.Users.Item.TaughtClasses.Item {
    ...
    public class EducationClassItemRequestBuilder {
        ...
        public EducationClassItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/users/{educationUser%2Did}/taughtClasses/{educationClass%2Did}{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<EducationClass> GetAsync(CancellationToken cancellationToken = default, Action<EducationClassItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
