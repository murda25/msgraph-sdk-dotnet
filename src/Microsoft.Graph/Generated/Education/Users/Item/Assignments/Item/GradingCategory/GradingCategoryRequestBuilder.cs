...
namespace Microsoft.Graph.Education.Users.Item.Assignments.Item.GradingCategory {
    ...
    public class GradingCategoryRequestBuilder : BaseRequestBuilder {
        ...
        public GradingCategoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/gradingCategory{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GradingCategoryRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GradingCategoryRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/gradingCategory{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
