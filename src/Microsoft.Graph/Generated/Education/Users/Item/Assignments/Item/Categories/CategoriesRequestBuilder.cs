...
using Microsoft.Graph.Education.Users.Item.Assignments.Item.Categories.MicrosoftGraphDelta;
...
namespace Microsoft.Graph.Education.Users.Item.Assignments.Item.Categories {
    ...
    public class CategoriesRequestBuilder {
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
