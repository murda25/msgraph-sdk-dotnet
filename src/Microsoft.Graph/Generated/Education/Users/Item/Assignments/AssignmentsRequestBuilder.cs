...
namespace MicrosoftGraphSdk.Education.Users.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationAssignmentCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
