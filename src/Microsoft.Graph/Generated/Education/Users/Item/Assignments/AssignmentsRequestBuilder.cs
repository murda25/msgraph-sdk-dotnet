...
namespace Microsoft.Graph.Education.Users.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// </summary>
        public async Task<EducationAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationAssignment> PostAsync(EducationAssignment body, CancellationToken cancellationToken = default, Action<AssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
