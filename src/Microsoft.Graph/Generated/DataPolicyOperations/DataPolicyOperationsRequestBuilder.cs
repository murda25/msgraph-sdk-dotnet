...
namespace Microsoft.Graph.DataPolicyOperations {
    ...
    public class DataPolicyOperationsRequestBuilder {
        ...
        /// </summary>
        public async Task<DataPolicyOperationCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DataPolicyOperationsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DataPolicyOperation> PostAsync(DataPolicyOperation body, CancellationToken cancellationToken = default, Action<DataPolicyOperationsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
