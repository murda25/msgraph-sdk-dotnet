...
namespace Microsoft.Graph.Solutions {
    ...
    public class SolutionsRequestBuilder {
        ...
        /// </summary>
        public async Task<SolutionsRoot> GetAsync(CancellationToken cancellationToken = default, Action<SolutionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SolutionsRoot body, CancellationToken cancellationToken = default, Action<SolutionsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
