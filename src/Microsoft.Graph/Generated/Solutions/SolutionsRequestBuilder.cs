...
namespace Microsoft.Graph.Solutions {
    ...
    public class SolutionsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<SolutionsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<SolutionsRoot> GetAsync(Action<SolutionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SolutionsRoot> PatchAsync(SolutionsRoot body, Action<SolutionsRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
