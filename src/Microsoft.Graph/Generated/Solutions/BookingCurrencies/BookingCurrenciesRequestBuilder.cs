...
namespace Microsoft.Graph.Solutions.BookingCurrencies {
    ...
    public class BookingCurrenciesRequestBuilder {
        ...
        /// </summary>
        public async Task<BookingCurrencyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<BookingCurrenciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingCurrency> PostAsync(BookingCurrency body, CancellationToken cancellationToken = default, Action<BookingCurrenciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
