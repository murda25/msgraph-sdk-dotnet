...
namespace Microsoft.Graph.Solutions.BookingBusinesses.Item.StaffMembers {
    ...
    public class StaffMembersRequestBuilder {
        ...
        /// </summary>
        public async Task<BookingStaffMemberBaseCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingStaffMemberBase> PostAsync(BookingStaffMemberBase body, CancellationToken cancellationToken = default, Action<StaffMembersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
