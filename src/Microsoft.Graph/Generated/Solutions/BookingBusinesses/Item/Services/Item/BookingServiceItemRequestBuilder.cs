...
namespace MicrosoftGraphSdk.Solutions.BookingBusinesses.Item.Services.Item {
    ...
    public class BookingServiceItemRequestBuilder {
        ...
        public async Task<BookingService> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<BookingService>(requestInfo, BookingService.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// All the services offered by this business. Read-only. Nullable.
        /// <param name="body"></param>
