...
namespace Microsoft.Graph.Solutions.BookingBusinesses.Item.Services {
    ...
    public class ServicesRequestBuilder {
        ...
        /// </summary>
        public async Task<BookingServiceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ServicesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingService> PostAsync(BookingService body, CancellationToken cancellationToken = default, Action<ServicesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
