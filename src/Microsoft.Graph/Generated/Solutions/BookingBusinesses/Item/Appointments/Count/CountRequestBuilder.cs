...
namespace MicrosoftGraphSdk.Solutions.BookingBusinesses.Item.Appointments.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness_id}/appointments/$count";
