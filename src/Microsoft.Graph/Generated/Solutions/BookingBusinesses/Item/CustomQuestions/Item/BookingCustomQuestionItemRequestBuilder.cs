...
namespace Microsoft.Graph.Solutions.BookingBusinesses.Item.CustomQuestions.Item {
    ...
    public class BookingCustomQuestionItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(BookingCustomQuestion body, Action<BookingCustomQuestionItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
