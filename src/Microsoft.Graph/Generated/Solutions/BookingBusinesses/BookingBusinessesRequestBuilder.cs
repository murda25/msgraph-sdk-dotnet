...
namespace Microsoft.Graph.Solutions.BookingBusinesses {
    ...
    public class BookingBusinessesRequestBuilder {
        ...
        /// </summary>
        public async Task<BookingBusinessCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<BookingBusinessesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingBusiness> PostAsync(BookingBusiness body, CancellationToken cancellationToken = default, Action<BookingBusinessesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
