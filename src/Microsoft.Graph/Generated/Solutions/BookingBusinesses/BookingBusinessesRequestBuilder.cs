...
namespace MicrosoftGraphSdk.Solutions.BookingBusinesses {
    ...
    public class BookingBusinessesRequestBuilder {
        ...
        /// </summary>
        public async Task<BookingBusinessCollectionResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
