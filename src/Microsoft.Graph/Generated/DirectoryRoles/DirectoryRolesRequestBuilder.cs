...
namespace Microsoft.Graph.DirectoryRoles {
    ...
    public class DirectoryRolesRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryRoleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DirectoryRolesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DirectoryRole> PostAsync(DirectoryRole body, CancellationToken cancellationToken = default, Action<DirectoryRolesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
