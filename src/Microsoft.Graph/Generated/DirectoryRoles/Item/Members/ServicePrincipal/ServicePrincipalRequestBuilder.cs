using Microsoft.Graph.DirectoryRoles.Item.Members.ServicePrincipal.Count;
...
namespace Microsoft.Graph.DirectoryRoles.Item.Members.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
