using Microsoft.Graph.DirectoryRoles.Item.Members.Group.Count;
...
namespace Microsoft.Graph.DirectoryRoles.Item.Members.Group {
    /// <summary>
    ...
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
