...
namespace Microsoft.Graph.ApplicationTemplates.Item {
    ...
    public class ApplicationTemplateItemRequestBuilder {
        ...
        /// </summary>
        public ApplicationTemplateItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ApplicationTemplateItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreateDeleteRequestInformation(Action<ApplicationTemplateItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ApplicationTemplateItemRequestBuilderDeleteRequestConfiguration();
        ...
        public RequestInformation CreatePatchRequestInformation(ApplicationTemplate body, Action<ApplicationTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new ApplicationTemplateItemRequestBuilderPatchRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
        ...
        /// </summary>
        public async Task DeleteAsync(Action<ApplicationTemplateItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApplicationTemplate> GetAsync(Action<ApplicationTemplateItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ApplicationTemplate body, Action<ApplicationTemplateItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// <summary>Get entity from applicationTemplates by key</summary>
