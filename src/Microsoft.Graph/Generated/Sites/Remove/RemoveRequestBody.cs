...
namespace Microsoft.Graph.Sites.Remove {
    ...
    public class RemoveRequestBody : IAdditionalDataHolder, IParsable {
        ...
        public List<Microsoft.Graph.Models.Site> Value { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as RemoveRequestBody).Value = n.GetCollectionOfObjectValues<Microsoft.Graph.Models.Site>(Microsoft.Graph.Models.Site.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
