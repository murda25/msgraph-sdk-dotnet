...
namespace Microsoft.Graph.Sites.Item.GetApplicableContentTypesForListWithListId {
    ...
    public class GetApplicableContentTypesForListWithListIdRequestBuilder {
        ...
        /// </summary>
        public async Task<GetApplicableContentTypesForListWithListIdResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetApplicableContentTypesForListWithListIdRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
