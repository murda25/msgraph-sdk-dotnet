...
namespace MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item.Relations.Item.FromTerm {
    ...
    public class FromTermRequestBuilder {
        ...
        public FromTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms/{term_id}/children/{term_id1}/relations/{relation_id}/fromTerm{?select,expand}";
