...
using MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Item.Relations;
using MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Item.Set;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/children/{term_id1}{?select,expand}";
