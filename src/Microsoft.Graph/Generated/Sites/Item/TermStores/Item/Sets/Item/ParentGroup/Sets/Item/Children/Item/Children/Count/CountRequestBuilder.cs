...
namespace MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/children/$count";
