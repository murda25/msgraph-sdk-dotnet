...
using MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.Relations.Count;
using MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStores.Item.Sets.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.termStores.item.sets.item.relations.item collection</summary>
