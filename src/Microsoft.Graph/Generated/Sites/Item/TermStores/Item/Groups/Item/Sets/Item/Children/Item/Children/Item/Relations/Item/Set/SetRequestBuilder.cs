...
namespace Microsoft.Graph.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children.Item.Relations.Item.Set {
    ...
    public class SetRequestBuilder {
        ...
        public SetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/children/{term_id}/children/{term_id1}/relations/{relation_id}/set{?select,expand}";
