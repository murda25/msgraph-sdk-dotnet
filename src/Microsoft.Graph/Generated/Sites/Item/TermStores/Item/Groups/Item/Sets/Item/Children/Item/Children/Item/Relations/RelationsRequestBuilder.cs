...
using MicrosoftGraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children.Item.Relations.Count;
using MicrosoftGraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.termStores.item.groups.item.sets.item.children.item.children.item.relations.item collection</summary>
