...
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Analytics;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.DriveItem;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Fields;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.Versions;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item {
    ...
    public class ListItemItemRequestBuilder {
        ...
        /// </summary>
        public GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval(string startDateTime, string interval, string endDateTime) {
            if(string.IsNullOrEmpty(endDateTime)) throw new ArgumentNullException(nameof(endDateTime));
            if(string.IsNullOrEmpty(interval)) throw new ArgumentNullException(nameof(interval));
            if(string.IsNullOrEmpty(startDateTime)) throw new ArgumentNullException(nameof(startDateTime));
            return new GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder(PathParameters, RequestAdapter, startDateTime, interval, endDateTime);
        }
        /// <summary>
        /// All items contained in the list.
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
