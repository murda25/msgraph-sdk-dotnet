...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval.GetActivitiesByInterval>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraphSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval.GetActivitiesByInterval>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
