...
using MicrosoftGraphSdk.Sites.Item.Lists.Item.Columns.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.Columns {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\columns</summary>
    public class ColumnsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.lists.item.columns.item collection</summary>
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/columns{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
