...
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.MicrosoftGraphAssociateWithHubSites;
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.MicrosoftGraphCopyToDefaultContentLocation;
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.MicrosoftGraphIsPublished;
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.MicrosoftGraphPublish;
using Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item.MicrosoftGraphUnpublish;
...
namespace Microsoft.Graph.Sites.Item.Lists.Item.ContentTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder {
        ...
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}{?%24select,%24expand}";
