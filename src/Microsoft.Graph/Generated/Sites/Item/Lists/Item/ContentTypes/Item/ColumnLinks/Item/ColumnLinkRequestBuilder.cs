...
namespace MicrosoftGraphSdk.Sites.Item.Lists.Item.ContentTypes.Item.ColumnLinks.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\lists\{list-id}\contentTypes\{contentType-id}\columnLinks\{columnLink-id}</summary>
    public class ColumnLinkRequestBuilder {
        ...
        public ColumnLinkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/lists/{list_id}/contentTypes/{contentType_id}/columnLinks/{columnLink_id}{?select,expand}";
