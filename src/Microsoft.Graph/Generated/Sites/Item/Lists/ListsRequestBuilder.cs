...
using MicrosoftGraphSdk.Sites.Item.Lists.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Lists {
    ...
    public class ListsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.lists.item collection</summary>
