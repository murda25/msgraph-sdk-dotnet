...
namespace Microsoft.Graph.Sites.Item.Drives {
    ...
    public class DrivesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.sites.item.drives.item collection</summary>
        ...
        public DrivesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/drives{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
