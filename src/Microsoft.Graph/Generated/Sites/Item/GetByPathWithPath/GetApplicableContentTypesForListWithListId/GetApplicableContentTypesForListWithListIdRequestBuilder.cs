...
namespace Microsoft.Graph.Sites.Item.GetByPathWithPath.GetApplicableContentTypesForListWithListId {
    ...
    public class GetApplicableContentTypesForListWithListIdRequestBuilder : BaseRequestBuilder {
        ...
        public GetApplicableContentTypesForListWithListIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string listId = "") : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getApplicableContentTypesForList(listId='{listId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GetApplicableContentTypesForListWithListIdRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getApplicableContentTypesForList(listId='{listId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
