...
namespace Microsoft.Graph.Sites.Item.GetByPathWithPath.GetByPathWithPath1.LastModifiedByUser {
    ...
    public class LastModifiedByUserRequestBuilder : BaseRequestBuilder {
        ...
        public LastModifiedByUserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/lastModifiedByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LastModifiedByUserRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LastModifiedByUserRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/lastModifiedByUser{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
