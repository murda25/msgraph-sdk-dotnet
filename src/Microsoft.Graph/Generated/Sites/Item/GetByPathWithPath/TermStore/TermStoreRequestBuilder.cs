...
namespace Microsoft.Graph.Sites.Item.GetByPathWithPath.TermStore {
    ...
    public class TermStoreRequestBuilder : BaseRequestBuilder {
        ...
        public TermStoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/termStore{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TermStoreRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TermStoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/termStore{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
