...
namespace Microsoft.Graph.Sites.Item.GetByPathWithPath {
    ...
    public class GetByPathWithPathRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Site> GetAsync(CancellationToken cancellationToken = default, Action<GetByPathWithPathRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
