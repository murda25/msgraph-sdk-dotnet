...
namespace Microsoft.Graph.Sites.Item.GetByPathWithPath {
    ...
    public class GetByPathWithPathRequestBuilder {
        ...
        public GetByPathWithPathRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string path = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')";
...
#nullable enable
        public async Task<Microsoft.Graph.Models.Site?> GetAsync(Action<GetByPathWithPathRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Microsoft.Graph.Models.Site> GetAsync(Action<GetByPathWithPathRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
