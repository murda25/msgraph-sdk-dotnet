...
namespace Microsoft.Graph.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Item.Relations.Item.ToTerm {
    ...
    public class ToTermRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/children/{term_id1}/relations/{relation_id}/toTerm{?select,expand}";
