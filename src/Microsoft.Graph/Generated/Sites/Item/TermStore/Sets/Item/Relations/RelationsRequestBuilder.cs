...
using MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.Relations.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStore.Sets.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.termStore.sets.item.relations.item collection</summary>
