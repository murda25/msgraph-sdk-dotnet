...
namespace Microsoft.Graph.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms {
    ...
    public class TermsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.sites.item.termStore.groups.item.sets.item.terms.item collection</summary>
        ...
        public TermsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms{?%24top*,%24skip*,%24search*,%24filter*,%24count*,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
