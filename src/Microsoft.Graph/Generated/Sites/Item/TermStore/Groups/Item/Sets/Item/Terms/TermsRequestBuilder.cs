...
using MicrosoftGraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms {
    ...
    public class TermsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.termStore.groups.item.sets.item.terms.item collection</summary>
