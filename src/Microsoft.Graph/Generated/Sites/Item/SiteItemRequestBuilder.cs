...
namespace Microsoft.Graph.Sites.Item {
    ...
    public class SiteItemRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.Site> GetAsync(CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.Site body, CancellationToken cancellationToken = default, Action<SiteItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
