...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Pages.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\pages\{onenotePage-id}</summary>
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/pages/{onenotePage_id}{?select,expand}";
