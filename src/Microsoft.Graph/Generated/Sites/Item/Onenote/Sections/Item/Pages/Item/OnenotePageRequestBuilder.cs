...
using MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.Content;
using MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.CopyToSection;
using MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.OnenotePatchContent;
using MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.ParentSection;
using MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item.Preview;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Sections.Item.Pages.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\sections\{onenoteSection-id}\pages\{onenotePage-id}</summary>
    public class OnenotePageRequestBuilder {
        ...
        public OnenotePageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/sections/{onenoteSection_id}/pages/{onenotePage_id}{?select,expand}";
