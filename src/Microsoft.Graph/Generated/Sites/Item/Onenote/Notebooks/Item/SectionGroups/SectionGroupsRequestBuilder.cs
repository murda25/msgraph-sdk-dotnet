...
using MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.sites.item.onenote.notebooks.item.sectionGroups.item collection</summary>
