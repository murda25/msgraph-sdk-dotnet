...
namespace Microsoft.Graph.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.sites.item.onenote.notebooks.item.sections.item.pages.item collection</summary>
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
