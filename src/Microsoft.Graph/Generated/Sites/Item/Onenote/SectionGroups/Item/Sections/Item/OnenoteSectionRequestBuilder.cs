...
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToSectionGroup;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentSectionGroup;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}\sections\{onenoteSection-id}</summary>
    public class OnenoteSectionRequestBuilder {
        ...
        public OnenoteSectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}/sections/{onenoteSection_id}{?select,expand}";
