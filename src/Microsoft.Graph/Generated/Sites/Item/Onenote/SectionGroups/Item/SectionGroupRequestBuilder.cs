...
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.ParentNotebook;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.ParentSectionGroup;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.SectionGroups;
using MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item.Sections;
using System;
...
namespace MicrosoftGraphSdk.Sites.Item.Onenote.SectionGroups.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\onenote\sectionGroups\{sectionGroup-id}</summary>
    public class SectionGroupRequestBuilder {
        ...
        public SectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/onenote/sectionGroups/{sectionGroup_id}{?select,expand}";
