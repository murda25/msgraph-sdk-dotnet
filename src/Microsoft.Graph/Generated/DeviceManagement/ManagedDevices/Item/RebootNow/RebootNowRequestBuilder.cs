...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.RebootNow {
    ...
    public class RebootNowRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<RebootNowRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
