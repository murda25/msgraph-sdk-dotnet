...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.RemoteLock {
    ...
    public class RemoteLockRequestBuilder {
        ...
        public RemoteLockRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/microsoft.graph.remoteLock";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<RemoteLockRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(Action<RemoteLockRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
