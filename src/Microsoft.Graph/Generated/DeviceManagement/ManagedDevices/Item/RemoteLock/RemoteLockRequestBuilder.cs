...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.RemoteLock {
    ...
    public class RemoteLockRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<RemoteLockRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
