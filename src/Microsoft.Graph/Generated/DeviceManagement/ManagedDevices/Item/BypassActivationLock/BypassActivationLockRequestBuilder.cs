...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.BypassActivationLock {
    ...
    public class BypassActivationLockRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<BypassActivationLockRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
