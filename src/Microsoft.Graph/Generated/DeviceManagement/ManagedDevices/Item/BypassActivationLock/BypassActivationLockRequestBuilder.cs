...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.BypassActivationLock {
    ...
    public class BypassActivationLockRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<BypassActivationLockRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
