...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.BypassActivationLock {
    ...
    public class BypassActivationLockRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public async Task PostAsync(Action<BypassActivationLockRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
