...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates {
    ...
    public class DeviceCompliancePolicyStatesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<DeviceCompliancePolicyStateCollectionResponse> GetAsync(Action<DeviceCompliancePolicyStatesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<DeviceCompliancePolicyState> PostAsync(DeviceCompliancePolicyState body, Action<DeviceCompliancePolicyStatesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
