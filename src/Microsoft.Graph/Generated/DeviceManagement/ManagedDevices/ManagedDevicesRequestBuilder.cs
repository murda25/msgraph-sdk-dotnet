...
using MicrosoftGraphSdk.DeviceManagement.ManagedDevices.Count;
using MicrosoftGraphSdk.DeviceManagement.ManagedDevices.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.deviceManagement.managedDevices.item collection</summary>
        ...
        /// </summary>
        public async Task<ManagedDeviceCollectionResponse> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedDevice> PostAsync(ManagedDevice body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
