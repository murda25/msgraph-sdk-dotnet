...
namespace Microsoft.Graph.DeviceManagement.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        /// </summary>
        public async Task<ManagedDeviceCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ManagedDevicesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedDevice> PostAsync(ManagedDevice body, CancellationToken cancellationToken = default, Action<ManagedDevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
