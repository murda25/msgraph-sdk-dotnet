...
namespace Microsoft.Graph.DeviceManagement.TelecomExpenseManagementPartners.Item {
    ...
    public class TelecomExpenseManagementPartnerItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<TelecomExpenseManagementPartnerItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TelecomExpenseManagementPartner> GetAsync(Action<TelecomExpenseManagementPartnerItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TelecomExpenseManagementPartner> PatchAsync(TelecomExpenseManagementPartner body, Action<TelecomExpenseManagementPartnerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
