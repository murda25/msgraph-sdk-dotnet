...
namespace Microsoft.Graph.DeviceManagement.TelecomExpenseManagementPartners.Item {
    ...
    public class TelecomExpenseManagementPartnerItemRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(TelecomExpenseManagementPartner body, Action<TelecomExpenseManagementPartnerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
