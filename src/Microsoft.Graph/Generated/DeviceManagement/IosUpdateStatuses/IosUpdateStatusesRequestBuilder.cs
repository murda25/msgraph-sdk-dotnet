...
namespace MicrosoftGraphSdk.DeviceManagement.IosUpdateStatuses {
    ...
    public class IosUpdateStatusesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(IosUpdateDeviceStatus body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
