...
namespace Microsoft.Graph.DeviceManagement.VerifyWindowsEnrollmentAutoDiscoveryWithDomainName {
    ...
    public class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder {
        ...
        /// </summary>
        public async Task<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse> GetAsync(CancellationToken cancellationToken = default, Action<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
