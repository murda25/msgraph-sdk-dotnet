...
namespace Microsoft.Graph.DeviceManagement.GetEffectivePermissionsWithScope {
    ...
    public class GetEffectivePermissionsWithScopeRequestBuilder {
        ...
        /// </summary>
        public async Task<GetEffectivePermissionsWithScopeResponse> GetAsync(Action<GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetEffectivePermissionsWithScopeResponse>(requestInfo, GetEffectivePermissionsWithScopeResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
