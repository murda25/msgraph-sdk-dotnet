...
namespace Microsoft.Graph.DeviceManagement.GetEffectivePermissionsWithScope {
    ...
    public class GetEffectivePermissionsWithScopeRequestBuilder {
        ...
        /// </summary>
        public async Task<GetEffectivePermissionsWithScopeResponse> GetAsync(CancellationToken cancellationToken = default, Action<GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
