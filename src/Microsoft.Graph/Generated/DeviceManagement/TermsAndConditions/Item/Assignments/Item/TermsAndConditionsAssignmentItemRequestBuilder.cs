...
namespace Microsoft.Graph.DeviceManagement.TermsAndConditions.Item.Assignments.Item {
    ...
    public class TermsAndConditionsAssignmentItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<TermsAndConditionsAssignmentItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TermsAndConditionsAssignment> GetAsync(CancellationToken cancellationToken = default, Action<TermsAndConditionsAssignmentItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(TermsAndConditionsAssignment body, CancellationToken cancellationToken = default, Action<TermsAndConditionsAssignmentItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
