...
namespace Microsoft.Graph.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses.Item.TermsAndConditions {
    ...
    public class TermsAndConditionsRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.TermsAndConditions> GetAsync(CancellationToken cancellationToken = default, Action<TermsAndConditionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
