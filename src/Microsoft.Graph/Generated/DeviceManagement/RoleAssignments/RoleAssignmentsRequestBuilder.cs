...
using MicrosoftGraphSdk.DeviceManagement.RoleAssignments.Item;
...
namespace MicrosoftGraphSdk.DeviceManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeviceAndAppManagementRoleAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceAndAppManagementRoleAssignment> PostAsync(DeviceAndAppManagementRoleAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
