...
namespace Microsoft.Graph.DeviceManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder {
        ...
        /// </summary>
        public async Task<DeviceAndAppManagementRoleAssignmentCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleAssignmentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceAndAppManagementRoleAssignment> PostAsync(DeviceAndAppManagementRoleAssignment body, CancellationToken cancellationToken = default, Action<RoleAssignmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
