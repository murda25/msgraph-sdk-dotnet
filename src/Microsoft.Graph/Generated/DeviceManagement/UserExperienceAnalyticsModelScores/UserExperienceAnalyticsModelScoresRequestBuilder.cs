...
namespace Microsoft.Graph.DeviceManagement.UserExperienceAnalyticsModelScores {
    ...
    public class UserExperienceAnalyticsModelScoresRequestBuilder : BaseRequestBuilder {
        ...
        public UserExperienceAnalyticsModelScoresItemRequestBuilder this[string position] { get {
            ...
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("userExperienceAnalyticsModelScores%2Did", position);
...
#nullable restore
        ...
        public async Task<Microsoft.Graph.Models.UserExperienceAnalyticsModelScores> PostAsync(Microsoft.Graph.Models.UserExperienceAnalyticsModelScores body, Action<UserExperienceAnalyticsModelScoresRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Microsoft.Graph.Models.UserExperienceAnalyticsModelScores>(requestInfo, Microsoft.Graph.Models.UserExperienceAnalyticsModelScores.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// User experience analytics model scores
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<UserExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<UserExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new UserExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.UserExperienceAnalyticsModelScores body, Action<UserExperienceAnalyticsModelScoresRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Microsoft.Graph.Models.UserExperienceAnalyticsModelScores body, Action<UserExperienceAnalyticsModelScoresRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new UserExperienceAnalyticsModelScoresRequestBuilderPostRequestConfiguration();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
            }
...
#nullable restore
        ...
        /// </summary>
        public class UserExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>Request query parameters</summary>
            public UserExperienceAnalyticsModelScoresRequestBuilderGetQueryParameters QueryParameters { get; set; } = new UserExperienceAnalyticsModelScoresRequestBuilderGetQueryParameters();
            /// <summary>
            /// Instantiates a new userExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public UserExperienceAnalyticsModelScoresRequestBuilderGetRequestConfiguration() {
        ...
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        public class UserExperienceAnalyticsModelScoresRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new userExperienceAnalyticsModelScoresRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public UserExperienceAnalyticsModelScoresRequestBuilderPostRequestConfiguration() {
                Options = new List<IRequestOption>();
                Headers = new RequestHeaders();
            }
        }
