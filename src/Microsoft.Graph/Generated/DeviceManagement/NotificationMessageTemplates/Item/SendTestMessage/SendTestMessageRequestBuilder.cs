...
namespace Microsoft.Graph.DeviceManagement.NotificationMessageTemplates.Item.SendTestMessage {
    ...
    public class SendTestMessageRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SendTestMessageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Action<SendTestMessageRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<SendTestMessageRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
