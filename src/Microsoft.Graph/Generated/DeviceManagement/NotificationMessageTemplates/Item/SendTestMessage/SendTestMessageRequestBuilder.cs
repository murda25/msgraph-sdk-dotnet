...
namespace Microsoft.Graph.DeviceManagement.NotificationMessageTemplates.Item.SendTestMessage {
    ...
    public class SendTestMessageRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<SendTestMessageRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
