...
namespace Microsoft.Graph.DeviceManagement.NotificationMessageTemplates.Item.MicrosoftGraphSendTestMessage {
    /// <summary>
    ...
    public class MicrosoftGraphSendTestMessageRequestBuilder {
        ...
        public MicrosoftGraphSendTestMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphSendTestMessageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphSendTestMessageRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphSendTestMessageRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
