...
namespace MicrosoftGraphSdk.DeviceManagement.NotificationMessageTemplates {
    ...
    public class NotificationMessageTemplatesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(NotificationMessageTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
