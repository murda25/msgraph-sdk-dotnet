...
namespace Microsoft.Graph.DeviceManagement.DeviceManagementPartners.Item.MicrosoftGraphTerminate {
    /// <summary>
    ...
    public class MicrosoftGraphTerminateRequestBuilder {
        ...
        public MicrosoftGraphTerminateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphTerminateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphTerminateRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphTerminateRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
