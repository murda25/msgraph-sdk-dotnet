...
namespace Microsoft.Graph.DeviceManagement.RemoteAssistancePartners.Item {
    ...
    public class RemoteAssistancePartnerItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RemoteAssistancePartner> GetAsync(CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(RemoteAssistancePartner body, CancellationToken cancellationToken = default, Action<RemoteAssistancePartnerItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
