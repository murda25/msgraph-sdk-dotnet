...
namespace Microsoft.Graph.DeviceManagement.RemoteAssistancePartners.Item.MicrosoftGraphDisconnect {
    /// <summary>
    ...
    public class MicrosoftGraphDisconnectRequestBuilder {
        ...
        public MicrosoftGraphDisconnectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphDisconnectRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task PostAsync(Action<MicrosoftGraphDisconnectRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Action<MicrosoftGraphDisconnectRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
