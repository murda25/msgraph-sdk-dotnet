...
namespace Microsoft.Graph.DeviceManagement.RemoteAssistancePartners.Item.BeginOnboarding {
    ...
    public class BeginOnboardingRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(Action<BeginOnboardingRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
