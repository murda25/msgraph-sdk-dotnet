...
namespace Microsoft.Graph.DeviceManagement.RemoteAssistancePartners.Item.BeginOnboarding {
    ...
    public class BeginOnboardingRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancellationToken cancellationToken = default, Action<BeginOnboardingRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
