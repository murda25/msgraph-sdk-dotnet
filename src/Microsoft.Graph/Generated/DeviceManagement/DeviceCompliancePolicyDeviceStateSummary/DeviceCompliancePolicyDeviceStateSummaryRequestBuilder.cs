...
namespace Microsoft.Graph.DeviceManagement.DeviceCompliancePolicyDeviceStateSummary {
    ...
    public class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(CancellationToken cancellationToken = default, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.DeviceCompliancePolicyDeviceStateSummary> GetAsync(CancellationToken cancellationToken = default, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.DeviceCompliancePolicyDeviceStateSummary body, CancellationToken cancellationToken = default, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
