...
namespace Microsoft.Graph.DeviceManagement {
    ...
    public class DeviceManagementRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.DeviceManagement> GetAsync(CancellationToken cancellationToken = default, Action<DeviceManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.DeviceManagement body, CancellationToken cancellationToken = default, Action<DeviceManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
