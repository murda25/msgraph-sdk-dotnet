...
using MicrosoftGraphSdk.DeviceManagement.ExchangeConnectors.Item.Sync;
...
namespace MicrosoftGraphSdk.DeviceManagement.ExchangeConnectors.Item {
    ...
    public class DeviceManagementExchangeConnectorRequestBuilder {
        ...
        /// </summary>
        public DeviceManagementExchangeConnectorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DeviceManagementExchangeConnectorRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
