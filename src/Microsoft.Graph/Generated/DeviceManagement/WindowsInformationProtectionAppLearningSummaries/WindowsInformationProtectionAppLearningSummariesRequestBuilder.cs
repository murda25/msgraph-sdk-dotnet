...
namespace Microsoft.Graph.DeviceManagement.WindowsInformationProtectionAppLearningSummaries {
    ...
    public class WindowsInformationProtectionAppLearningSummariesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.deviceManagement.windowsInformationProtectionAppLearningSummaries.item collection</summary>
        ...
        /// </summary>
        public async Task<WindowsInformationProtectionAppLearningSummaryCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<WindowsInformationProtectionAppLearningSummariesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>> {
                {"4XX", ODataError.CreateFromDiscriminatorValue},
                {"5XX", ODataError.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<WindowsInformationProtectionAppLearningSummaryCollectionResponse>(requestInfo, WindowsInformationProtectionAppLearningSummaryCollectionResponse.CreateFromDiscriminatorValue, responseHandler, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to windowsInformationProtectionAppLearningSummaries for deviceManagement
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<WindowsInformationProtectionAppLearningSummary> PostAsync(WindowsInformationProtectionAppLearningSummary body, CancellationToken cancellationToken = default, Action<WindowsInformationProtectionAppLearningSummariesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
