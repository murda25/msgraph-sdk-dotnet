...
namespace Microsoft.Graph.DeviceManagement.WindowsInformationProtectionAppLearningSummaries {
    ...
    public class WindowsInformationProtectionAppLearningSummariesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<WindowsInformationProtectionAppLearningSummary> PostAsync(WindowsInformationProtectionAppLearningSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
