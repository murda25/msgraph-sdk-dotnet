...
namespace Microsoft.Graph.DeviceManagement.Reports.GetCachedReport {
    ...
    public class GetCachedReportRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetCachedReportPostRequestBody body, Action<GetCachedReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetCachedReportPostRequestBody body, CancellationToken cancellationToken = default, Action<GetCachedReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
