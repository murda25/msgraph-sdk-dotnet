...
namespace Microsoft.Graph.DeviceManagement.Reports.GetCachedReport {
    ...
    public class GetCachedReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetCachedReportPostRequestBody body, Action<GetCachedReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
