...
namespace Microsoft.Graph.DeviceManagement.Reports.GetReportFilters {
    ...
    public class GetReportFiltersResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public GetReportFiltersResponse() {
        ...
        /// </summary>
        public static GetReportFiltersResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetReportFiltersResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
