...
namespace Microsoft.Graph.DeviceManagement.Reports.MicrosoftGraphGetPolicyNonComplianceReport {
    /// <summary>
    ...
    public class MicrosoftGraphGetPolicyNonComplianceReportRequestBuilder {
        ...
        public MicrosoftGraphGetPolicyNonComplianceReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MicrosoftGraphGetPolicyNonComplianceReportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
...
#nullable enable
        public async Task<Stream?> PostAsync(GetPolicyNonComplianceReportPostRequestBody body, Action<MicrosoftGraphGetPolicyNonComplianceReportRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> PostAsync(GetPolicyNonComplianceReportPostRequestBody body, Action<MicrosoftGraphGetPolicyNonComplianceReportRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
