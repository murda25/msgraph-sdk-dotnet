...
namespace Microsoft.Graph.DeviceManagement.Reports.GetPolicyNonComplianceMetadata {
    ...
    public class GetPolicyNonComplianceMetadataRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetPolicyNonComplianceMetadataPostRequestBody body, CancellationToken cancellationToken = default, Action<GetPolicyNonComplianceMetadataRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
