...
namespace Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.UserStatuses.Item {
    ...
    public class DeviceComplianceUserStatusItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<DeviceComplianceUserStatusItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceComplianceUserStatus> GetAsync(Action<DeviceComplianceUserStatusItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceComplianceUserStatus> PatchAsync(DeviceComplianceUserStatus body, Action<DeviceComplianceUserStatusItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
