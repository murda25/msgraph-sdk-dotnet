...
namespace Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.ScheduleActionsForRules {
    ...
    public class ScheduleActionsForRulesRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ScheduleActionsForRulesRequestBody body, Action<ScheduleActionsForRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
