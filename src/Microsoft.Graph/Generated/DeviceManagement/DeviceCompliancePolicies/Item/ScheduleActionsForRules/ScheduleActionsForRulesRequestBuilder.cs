...
#nullable enable
        public async Task PostAsync(ScheduleActionsForRulesPostRequestBody body, Action<ScheduleActionsForRulesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(ScheduleActionsForRulesPostRequestBody body, Action<ScheduleActionsForRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
