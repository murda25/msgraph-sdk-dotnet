...
namespace Microsoft.Graph.DeviceManagement.DeviceCompliancePolicies.Item.ScheduleActionsForRules {
    ...
    public class ScheduleActionsForRulesRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ScheduleActionsForRulesPostRequestBody body, CancellationToken cancellationToken = default, Action<ScheduleActionsForRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
