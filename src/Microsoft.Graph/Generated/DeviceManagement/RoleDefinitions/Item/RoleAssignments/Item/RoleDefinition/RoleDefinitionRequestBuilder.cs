...
namespace Microsoft.Graph.DeviceManagement.RoleDefinitions.Item.RoleAssignments.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.RoleDefinition> GetAsync(Action<RoleDefinitionRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
