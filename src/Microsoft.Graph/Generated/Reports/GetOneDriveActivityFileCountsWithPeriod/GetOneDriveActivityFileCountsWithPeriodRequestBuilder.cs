...
namespace Microsoft.Graph.Reports.GetOneDriveActivityFileCountsWithPeriod {
    ...
    public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOneDriveActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
