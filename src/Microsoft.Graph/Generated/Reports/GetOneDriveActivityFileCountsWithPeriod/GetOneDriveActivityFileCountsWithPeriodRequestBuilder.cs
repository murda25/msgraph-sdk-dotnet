...
namespace Microsoft.Graph.Reports.GetOneDriveActivityFileCountsWithPeriod {
    ...
    public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder {
        ...
        public GetOneDriveActivityFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getOneDriveActivityFileCounts(period='{period}')";
