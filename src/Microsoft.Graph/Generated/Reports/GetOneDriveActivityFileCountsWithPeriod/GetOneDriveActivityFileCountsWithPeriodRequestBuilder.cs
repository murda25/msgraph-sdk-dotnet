...
namespace Microsoft.Graph.Reports.GetOneDriveActivityFileCountsWithPeriod {
    /// <summary>Provides operations to call the getOneDriveActivityFileCounts method.</summary>
    public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetOneDriveActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOneDriveActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
