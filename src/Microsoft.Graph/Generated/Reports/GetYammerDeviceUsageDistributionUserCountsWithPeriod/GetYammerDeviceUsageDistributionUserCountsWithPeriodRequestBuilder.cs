...
namespace Microsoft.Graph.Reports.GetYammerDeviceUsageDistributionUserCountsWithPeriod {
    ...
    public class GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
