...
namespace Microsoft.Graph.Reports.GetOffice365ActiveUserCountsWithPeriod {
    ...
    public class GetOffice365ActiveUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActiveUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
