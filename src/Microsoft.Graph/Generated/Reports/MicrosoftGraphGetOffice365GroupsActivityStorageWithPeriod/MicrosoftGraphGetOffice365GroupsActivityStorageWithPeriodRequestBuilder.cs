...
namespace Microsoft.Graph.Reports.MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriod {
    /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
