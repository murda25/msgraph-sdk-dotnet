...
namespace Microsoft.Graph.Reports.GetOneDriveUsageFileCountsWithPeriod {
    ...
    public class GetOneDriveUsageFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOneDriveUsageFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
