...
namespace Microsoft.Graph.Reports.GetOneDriveUsageFileCountsWithPeriod {
    ...
    public class GetOneDriveUsageFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOneDriveUsageFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
