...
namespace Microsoft.Graph.Reports.GetOneDriveUsageFileCountsWithPeriod {
    ...
    public class GetOneDriveUsageFileCountsWithPeriodRequestBuilder {
        ...
        public GetOneDriveUsageFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getOneDriveUsageFileCounts(period='{period}')";
