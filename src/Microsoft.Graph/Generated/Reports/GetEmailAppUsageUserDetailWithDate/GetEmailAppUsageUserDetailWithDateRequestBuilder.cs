...
namespace Microsoft.Graph.Reports.GetEmailAppUsageUserDetailWithDate {
    ...
    public class GetEmailAppUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
