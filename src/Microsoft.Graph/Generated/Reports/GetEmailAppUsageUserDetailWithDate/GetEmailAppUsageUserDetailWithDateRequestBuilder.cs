...
namespace Microsoft.Graph.Reports.GetEmailAppUsageUserDetailWithDate {
    ...
    public class GetEmailAppUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetEmailAppUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
