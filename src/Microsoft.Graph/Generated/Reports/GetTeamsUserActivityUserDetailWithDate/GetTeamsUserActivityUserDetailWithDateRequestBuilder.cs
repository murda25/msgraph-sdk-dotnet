...
namespace Microsoft.Graph.Reports.GetTeamsUserActivityUserDetailWithDate {
    ...
    public class GetTeamsUserActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<GetTeamsUserActivityUserDetailWithDateResponse> GetAsync(Action<GetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetTeamsUserActivityUserDetailWithDateResponse>(requestInfo, GetTeamsUserActivityUserDetailWithDateResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
