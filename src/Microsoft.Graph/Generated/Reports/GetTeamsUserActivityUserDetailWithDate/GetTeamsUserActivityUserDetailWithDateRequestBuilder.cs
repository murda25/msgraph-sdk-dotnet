...
namespace Microsoft.Graph.Reports.GetTeamsUserActivityUserDetailWithDate {
    ...
    public class GetTeamsUserActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetTeamsUserActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
