...
namespace Microsoft.Graph.Reports.GetEmailActivityUserCountsWithPeriod {
    ...
    public class GetEmailActivityUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetEmailActivityUserCountsWithPeriodResponse> GetAsync(Action<GetEmailActivityUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<GetEmailActivityUserCountsWithPeriodResponse>(requestInfo, GetEmailActivityUserCountsWithPeriodResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
