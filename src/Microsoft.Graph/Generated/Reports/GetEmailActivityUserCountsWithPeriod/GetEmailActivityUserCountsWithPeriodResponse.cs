...
namespace Microsoft.Graph.Reports.GetEmailActivityUserCountsWithPeriod {
    ...
    public class GetEmailActivityUserCountsWithPeriodResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public GetEmailActivityUserCountsWithPeriodResponse() {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetEmailActivityUserCountsWithPeriodResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
