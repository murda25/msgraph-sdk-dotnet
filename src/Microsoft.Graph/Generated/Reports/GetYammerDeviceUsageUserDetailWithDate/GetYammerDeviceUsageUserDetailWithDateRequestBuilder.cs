...
namespace Microsoft.Graph.Reports.GetYammerDeviceUsageUserDetailWithDate {
    ...
    public class GetYammerDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
