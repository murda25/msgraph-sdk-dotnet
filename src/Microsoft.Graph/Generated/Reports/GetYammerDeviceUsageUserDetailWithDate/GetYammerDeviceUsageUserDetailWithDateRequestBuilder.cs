...
namespace Microsoft.Graph.Reports.GetYammerDeviceUsageUserDetailWithDate {
    ...
    public class GetYammerDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetYammerDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
