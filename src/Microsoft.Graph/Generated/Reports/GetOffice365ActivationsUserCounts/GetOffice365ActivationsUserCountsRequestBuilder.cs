...
namespace Microsoft.Graph.Reports.GetOffice365ActivationsUserCounts {
    ...
    public class GetOffice365ActivationsUserCountsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOffice365ActivationsUserCountsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
