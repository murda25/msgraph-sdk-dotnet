...
namespace Microsoft.Graph.Reports.GetOffice365ActivationsUserDetail {
    ...
    public class GetOffice365ActivationsUserDetailRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActivationsUserDetailRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
