...
namespace Microsoft.Graph.Reports.GetOffice365GroupsActivityDetailWithPeriod {
    ...
    public class GetOffice365GroupsActivityDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365GroupsActivityDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
