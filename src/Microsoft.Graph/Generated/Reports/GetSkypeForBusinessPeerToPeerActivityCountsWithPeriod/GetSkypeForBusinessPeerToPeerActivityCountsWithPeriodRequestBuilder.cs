...
namespace Microsoft.Graph.Reports.GetSkypeForBusinessPeerToPeerActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder {
        ...
        public GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')";
