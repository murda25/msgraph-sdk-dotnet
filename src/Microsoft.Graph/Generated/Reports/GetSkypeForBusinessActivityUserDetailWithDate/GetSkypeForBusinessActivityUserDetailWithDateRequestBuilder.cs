...
namespace Microsoft.Graph.Reports.GetSkypeForBusinessActivityUserDetailWithDate {
    ...
    public class GetSkypeForBusinessActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetSkypeForBusinessActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetSkypeForBusinessActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
