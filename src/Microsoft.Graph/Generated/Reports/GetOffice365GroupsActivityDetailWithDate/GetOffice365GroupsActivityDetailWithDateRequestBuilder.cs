...
namespace Microsoft.Graph.Reports.GetOffice365GroupsActivityDetailWithDate {
    ...
    public class GetOffice365GroupsActivityDetailWithDateRequestBuilder {
        ...
        public GetOffice365GroupsActivityDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, Date? date = default) {
            ...
            UrlTemplate = "{+baseurl}/reports/getOffice365GroupsActivityDetail(date={date})";
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<GetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<GetOffice365GroupsActivityDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
