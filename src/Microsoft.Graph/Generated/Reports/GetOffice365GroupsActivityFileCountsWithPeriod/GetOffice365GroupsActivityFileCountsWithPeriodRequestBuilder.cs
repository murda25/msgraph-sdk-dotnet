...
namespace Microsoft.Graph.Reports.GetOffice365GroupsActivityFileCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
