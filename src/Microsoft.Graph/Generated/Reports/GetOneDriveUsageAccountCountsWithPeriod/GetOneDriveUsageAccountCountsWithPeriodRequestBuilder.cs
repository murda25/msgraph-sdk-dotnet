...
namespace Microsoft.Graph.Reports.GetOneDriveUsageAccountCountsWithPeriod {
    ...
    public class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOneDriveUsageAccountCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
