...
namespace Microsoft.Graph.Reports.GetOffice365GroupsActivityStorageWithPeriod {
    ...
    public class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365GroupsActivityStorageWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
