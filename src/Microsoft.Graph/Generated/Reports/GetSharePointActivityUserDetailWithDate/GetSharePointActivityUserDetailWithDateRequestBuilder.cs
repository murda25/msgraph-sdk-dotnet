...
namespace Microsoft.Graph.Reports.GetSharePointActivityUserDetailWithDate {
    ...
    public class GetSharePointActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetSharePointActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
