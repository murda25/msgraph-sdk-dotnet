...
namespace Microsoft.Graph.Reports.GetYammerActivityUserDetailWithDate {
    ...
    public class GetYammerActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
