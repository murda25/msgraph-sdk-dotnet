...
namespace Microsoft.Graph.Reports.GetYammerActivityUserDetailWithDate {
    ...
    public class GetYammerActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetYammerActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
