...
namespace Microsoft.Graph.Reports.GetOffice365ServicesUserCountsWithPeriod {
    ...
    public class GetOffice365ServicesUserCountsWithPeriodRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOffice365ServicesUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
