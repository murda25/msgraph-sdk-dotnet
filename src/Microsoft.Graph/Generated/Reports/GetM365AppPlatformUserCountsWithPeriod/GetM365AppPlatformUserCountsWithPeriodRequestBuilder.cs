...
namespace Microsoft.Graph.Reports.GetM365AppPlatformUserCountsWithPeriod {
    ...
    public class GetM365AppPlatformUserCountsWithPeriodRequestBuilder {
        ...
        public GetM365AppPlatformUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getM365AppPlatformUserCounts(period='{period}')";
