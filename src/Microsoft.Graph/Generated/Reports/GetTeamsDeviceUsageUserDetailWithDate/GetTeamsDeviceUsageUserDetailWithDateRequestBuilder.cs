...
namespace Microsoft.Graph.Reports.GetTeamsDeviceUsageUserDetailWithDate {
    ...
    public class GetTeamsDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<GetTeamsDeviceUsageUserDetailWithDateResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
