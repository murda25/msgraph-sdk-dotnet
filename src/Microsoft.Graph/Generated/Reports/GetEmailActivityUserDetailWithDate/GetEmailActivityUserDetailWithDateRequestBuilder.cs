...
namespace Microsoft.Graph.Reports.GetEmailActivityUserDetailWithDate {
    ...
    public class GetEmailActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetEmailActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
