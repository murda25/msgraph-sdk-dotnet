...
namespace Microsoft.Graph.Reports.GetEmailActivityUserDetailWithDate {
    ...
    public class GetEmailActivityUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<GetEmailActivityUserDetailWithDateResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
