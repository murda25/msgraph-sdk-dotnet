...
namespace Microsoft.Graph.Reports.GetSharePointActivityFileCountsWithPeriod {
    ...
    public class GetSharePointActivityFileCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetSharePointActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
