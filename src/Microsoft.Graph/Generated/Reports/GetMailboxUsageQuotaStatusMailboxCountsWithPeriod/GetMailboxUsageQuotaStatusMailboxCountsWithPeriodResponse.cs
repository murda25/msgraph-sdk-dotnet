...
namespace Microsoft.Graph.Reports.GetMailboxUsageQuotaStatusMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse() {
        ...
        /// </summary>
        public static GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetMailboxUsageQuotaStatusMailboxCountsWithPeriodResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
