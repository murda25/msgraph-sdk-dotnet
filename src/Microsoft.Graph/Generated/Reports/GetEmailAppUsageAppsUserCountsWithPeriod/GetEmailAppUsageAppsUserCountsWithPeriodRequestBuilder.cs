...
namespace Microsoft.Graph.Reports.GetEmailAppUsageAppsUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
