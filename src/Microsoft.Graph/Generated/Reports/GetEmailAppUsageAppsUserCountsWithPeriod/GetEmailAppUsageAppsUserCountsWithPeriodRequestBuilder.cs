...
namespace Microsoft.Graph.Reports.GetEmailAppUsageAppsUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetEmailAppUsageAppsUserCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
