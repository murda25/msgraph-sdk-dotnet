...
namespace Microsoft.Graph.Reports.GetYammerDeviceUsageUserDetailWithPeriod {
    ...
    public class GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetYammerDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
