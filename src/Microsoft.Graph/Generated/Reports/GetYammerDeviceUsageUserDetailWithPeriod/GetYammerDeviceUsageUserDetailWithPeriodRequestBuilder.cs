...
namespace Microsoft.Graph.Reports.GetYammerDeviceUsageUserDetailWithPeriod {
    ...
    public class GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetYammerDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
