...
namespace Microsoft.Graph.Reports.GetOffice365GroupsActivityGroupCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOffice365GroupsActivityGroupCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
