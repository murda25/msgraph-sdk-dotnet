...
namespace Microsoft.Graph.Reports.GetYammerActivityUserDetailWithPeriod {
    ...
    public class GetYammerActivityUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetYammerActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetYammerActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
