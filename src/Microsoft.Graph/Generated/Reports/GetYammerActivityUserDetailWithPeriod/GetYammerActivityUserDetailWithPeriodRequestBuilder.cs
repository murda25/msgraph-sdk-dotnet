...
namespace Microsoft.Graph.Reports.GetYammerActivityUserDetailWithPeriod {
    ...
    public class GetYammerActivityUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetYammerActivityUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
