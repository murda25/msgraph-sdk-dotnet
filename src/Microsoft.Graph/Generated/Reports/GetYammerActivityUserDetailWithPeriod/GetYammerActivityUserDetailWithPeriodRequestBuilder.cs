...
namespace Microsoft.Graph.Reports.GetYammerActivityUserDetailWithPeriod {
    ...
    public class GetYammerActivityUserDetailWithPeriodRequestBuilder {
        ...
        public GetYammerActivityUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/getYammerActivityUserDetail(period='{period}')";
