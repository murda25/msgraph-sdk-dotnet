...
namespace Microsoft.Graph.Reports.GetOffice365ActiveUserDetailWithPeriod {
    ...
    public class GetOffice365ActiveUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOffice365ActiveUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
