...
namespace Microsoft.Graph.Reports.GetOffice365ActiveUserDetailWithPeriod {
    ...
    public class GetOffice365ActiveUserDetailWithPeriodRequestBuilder {
        ...
        public GetOffice365ActiveUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
            ...
            UrlTemplate = "{+baseurl}/reports/getOffice365ActiveUserDetail(period='{period}')";
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<GetOffice365ActiveUserDetailWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<GetOffice365ActiveUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
