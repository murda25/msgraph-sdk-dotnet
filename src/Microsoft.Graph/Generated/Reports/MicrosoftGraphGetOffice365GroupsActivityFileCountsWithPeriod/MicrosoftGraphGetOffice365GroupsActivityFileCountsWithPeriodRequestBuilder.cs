...
namespace Microsoft.Graph.Reports.MicrosoftGraphGetOffice365GroupsActivityFileCountsWithPeriod {
    /// <summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<MicrosoftGraphGetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<MicrosoftGraphGetOffice365GroupsActivityFileCountsWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
