...
namespace Microsoft.Graph.Reports.GetTeamsDeviceUsageUserDetailWithPeriod {
    ...
    public class GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<GetTeamsDeviceUsageUserDetailWithPeriodResponse> GetAsync(Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
