...
namespace Microsoft.Graph.Reports.GetTeamsDeviceUsageUserDetailWithPeriod {
    ...
    public class GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(CancellationToken cancellationToken = default, Action<GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
