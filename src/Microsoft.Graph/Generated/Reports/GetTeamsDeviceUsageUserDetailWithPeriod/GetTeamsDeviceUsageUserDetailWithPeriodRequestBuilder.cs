...
namespace Microsoft.Graph.Reports.GetTeamsDeviceUsageUserDetailWithPeriod {
    ...
    public class GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> GetAsync(Action<GetTeamsDeviceUsageUserDetailWithPeriodRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
