...
namespace Microsoft.Graph.Reports.GetSkypeForBusinessDeviceUsageUserDetailWithDate {
    ...
    public class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
