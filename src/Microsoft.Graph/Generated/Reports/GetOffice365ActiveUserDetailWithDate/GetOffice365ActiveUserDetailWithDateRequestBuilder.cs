...
namespace Microsoft.Graph.Reports.GetOffice365ActiveUserDetailWithDate {
    ...
    public class GetOffice365ActiveUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(Action<GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
