...
namespace Microsoft.Graph.Reports.GetOffice365ActiveUserDetailWithDate {
    ...
    public class GetOffice365ActiveUserDetailWithDateRequestBuilder {
        ...
        /// </summary>
        public async Task<Report> GetAsync(CancellationToken cancellationToken = default, Action<GetOffice365ActiveUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
