...
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Count;
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.FilterByCurrentUserWithOn;
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item;
...
namespace Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests {
    ...
    public class RoleEligibilityScheduleRequestsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.roleManagement.directory.roleEligibilityScheduleRequests.item collection</summary>
        ...
        public RoleEligibilityScheduleRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleEligibilityScheduleRequest> PostAsync(UnifiedRoleEligibilityScheduleRequest body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
