...
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item.AppScope;
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item.Cancel;
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item.DirectoryScope;
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item.Principal;
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item.RoleDefinition;
using Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item.TargetSchedule;
...
namespace Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item {
    ...
    public class UnifiedRoleEligibilityScheduleRequestItemRequestBuilder {
        ...
        public UnifiedRoleEligibilityScheduleRequestItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest_id}{?select,expand}";
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(UnifiedRoleEligibilityScheduleRequest body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleEligibilityScheduleRequest> GetAsync(Action<GetQueryParameters> queryParameters = default, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(UnifiedRoleEligibilityScheduleRequest body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
