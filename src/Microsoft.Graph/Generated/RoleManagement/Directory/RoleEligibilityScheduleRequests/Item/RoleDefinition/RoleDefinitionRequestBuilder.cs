...
namespace Microsoft.Graph.RoleManagement.Directory.RoleEligibilityScheduleRequests.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        public RoleDefinitionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/roleDefinition{?%24select,%24expand}";
