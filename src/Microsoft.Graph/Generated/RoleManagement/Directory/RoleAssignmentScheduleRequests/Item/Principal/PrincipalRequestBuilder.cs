...
namespace Microsoft.Graph.RoleManagement.Directory.RoleAssignmentScheduleRequests.Item.Principal {
    ...
    public class PrincipalRequestBuilder {
        ...
        public PrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/principal{?%24select,%24expand}";
