...
using Microsoft.Graph.RoleManagement.Directory.RoleAssignmentScheduleInstances.Item.ActivatedUsing;
...
namespace Microsoft.Graph.RoleManagement.Directory.RoleAssignmentScheduleInstances.Item {
    ...
    public class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder {
        ...
        public UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance_id}{?select,expand}";
