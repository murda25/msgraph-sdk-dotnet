...
namespace Microsoft.Graph.RoleManagement {
    ...
    public class RoleManagementRequestBuilder {
        ...
        /// </summary>
        public async Task<Microsoft.Graph.Models.RoleManagement> GetAsync(CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.RoleManagement body, CancellationToken cancellationToken = default, Action<RoleManagementRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
