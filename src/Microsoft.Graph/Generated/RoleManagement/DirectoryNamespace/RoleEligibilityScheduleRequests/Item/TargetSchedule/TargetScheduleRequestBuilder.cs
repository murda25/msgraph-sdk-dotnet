...
namespace Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.TargetSchedule {
    ...
    public class TargetScheduleRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleEligibilitySchedule> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
