...
namespace Microsoft.Graph.RoleManagement.DirectoryNamespace.RoleAssignmentSchedules.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnRequestBuilder {
        ...
        public FilterByCurrentUserWithOnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string on = "") {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentSchedules/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
