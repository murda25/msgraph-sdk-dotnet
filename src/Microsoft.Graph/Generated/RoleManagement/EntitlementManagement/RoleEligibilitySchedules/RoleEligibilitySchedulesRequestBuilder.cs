...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleEligibilitySchedules {
    ...
    public class RoleEligibilitySchedulesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.roleManagement.entitlementManagement.roleEligibilitySchedules.item collection</summary>
        ...
        public RoleEligibilitySchedulesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleEligibilitySchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
