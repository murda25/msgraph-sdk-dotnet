...
using MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleAssignments {
    /// <summary>Builds and executes requests for operations under \roleManagement\entitlementManagement\roleAssignments</summary>
    public class RoleAssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.entitlementManagement.roleAssignments.item collection</summary>
        ...
        public RoleAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
