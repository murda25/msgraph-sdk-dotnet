...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.roleManagement.entitlementManagement.roleAssignments.item collection</summary>
        ...
        public RoleAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
