...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleDefinitions {
    ...
    public class RoleDefinitionsRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleDefinitionCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<RoleDefinitionsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleDefinition> PostAsync(UnifiedRoleDefinition body, CancellationToken cancellationToken = default, Action<RoleDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
