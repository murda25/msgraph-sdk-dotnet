...
using MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleDefinitions.Item;
using System;
...
namespace MicrosoftGraphSdk.RoleManagement.EntitlementManagement.RoleDefinitions {
    /// <summary>Builds and executes requests for operations under \roleManagement\entitlementManagement\roleDefinitions</summary>
    public class RoleDefinitionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.roleManagement.entitlementManagement.roleDefinitions.item collection</summary>
        ...
        public RoleDefinitionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
