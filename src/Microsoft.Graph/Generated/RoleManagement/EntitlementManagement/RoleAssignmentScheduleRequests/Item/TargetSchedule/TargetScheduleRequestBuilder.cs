...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleAssignmentScheduleRequests.Item.TargetSchedule {
    ...
    public class TargetScheduleRequestBuilder {
        ...
        public TargetScheduleRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/targetSchedule{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<UnifiedRoleAssignmentSchedule> GetAsync(CancellationToken cancellationToken = default, Action<TargetScheduleRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
