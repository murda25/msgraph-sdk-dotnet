...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleAssignmentScheduleRequests.Item.ActivatedUsing {
    ...
    public class ActivatedUsingRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleEligibilitySchedule> GetAsync(Action<ActivatedUsingRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
