...
namespace Microsoft.Graph.RoleManagement.EntitlementManagement.RoleAssignmentScheduleRequests.Item.ActivatedUsing {
    ...
    public class ActivatedUsingRequestBuilder {
        ...
        public ActivatedUsingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/activatedUsing{?%24select,%24expand}";
        ...
        /// </summary>
        public async Task<UnifiedRoleEligibilitySchedule> GetAsync(CancellationToken cancellationToken = default, Action<ActivatedUsingRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
