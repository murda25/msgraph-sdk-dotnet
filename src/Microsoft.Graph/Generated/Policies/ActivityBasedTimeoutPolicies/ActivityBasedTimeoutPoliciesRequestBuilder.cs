...
namespace Microsoft.Graph.Policies.ActivityBasedTimeoutPolicies {
    ...
    public class ActivityBasedTimeoutPoliciesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<ActivityBasedTimeoutPolicyCollectionResponse> GetAsync(Action<ActivityBasedTimeoutPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public async Task<ActivityBasedTimeoutPolicy> PostAsync(ActivityBasedTimeoutPolicy body, Action<ActivityBasedTimeoutPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
