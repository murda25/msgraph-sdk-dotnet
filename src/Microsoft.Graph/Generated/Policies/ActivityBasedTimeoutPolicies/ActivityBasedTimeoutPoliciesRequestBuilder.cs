...
namespace MicrosoftGraphSdk.Policies.ActivityBasedTimeoutPolicies {
    ...
    public class ActivityBasedTimeoutPoliciesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ActivityBasedTimeoutPolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
