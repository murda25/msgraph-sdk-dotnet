...
namespace Microsoft.Graph.Policies.ClaimsMappingPolicies {
    ...
    public class ClaimsMappingPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<ClaimsMappingPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ClaimsMappingPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ClaimsMappingPolicy> PostAsync(ClaimsMappingPolicy body, CancellationToken cancellationToken = default, Action<ClaimsMappingPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
