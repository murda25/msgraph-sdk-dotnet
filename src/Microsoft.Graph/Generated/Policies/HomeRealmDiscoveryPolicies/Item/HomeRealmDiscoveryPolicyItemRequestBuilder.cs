...
namespace Microsoft.Graph.Policies.HomeRealmDiscoveryPolicies.Item {
    ...
    public class HomeRealmDiscoveryPolicyItemRequestBuilder {
        ...
        /// </summary>
        public async Task DeleteAsync(Action<HomeRealmDiscoveryPolicyItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<HomeRealmDiscoveryPolicy> PatchAsync(HomeRealmDiscoveryPolicy body, Action<HomeRealmDiscoveryPolicyItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
