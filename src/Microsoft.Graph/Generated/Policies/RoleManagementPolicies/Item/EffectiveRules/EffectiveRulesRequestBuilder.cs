...
namespace Microsoft.Graph.Policies.RoleManagementPolicies.Item.EffectiveRules {
    ...
    public class EffectiveRulesRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.policies.roleManagementPolicies.item.effectiveRules.item collection</summary>
        ...
        /// </summary>
        public async Task<UnifiedRoleManagementPolicyRuleCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<EffectiveRulesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UnifiedRoleManagementPolicyRule> PostAsync(UnifiedRoleManagementPolicyRule body, CancellationToken cancellationToken = default, Action<EffectiveRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
