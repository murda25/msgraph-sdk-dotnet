...
namespace Microsoft.Graph.Policies.PermissionGrantPolicies {
    ...
    public class PermissionGrantPoliciesRequestBuilder {
        ...
        /// </summary>
        public async Task<PermissionGrantPolicyCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PermissionGrantPoliciesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PermissionGrantPolicy> PostAsync(PermissionGrantPolicy body, CancellationToken cancellationToken = default, Action<PermissionGrantPoliciesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
