...
using MicrosoftGraphSdk.Policies.PermissionGrantPolicies.Item.Excludes.Item;
using System;
...
namespace MicrosoftGraphSdk.Policies.PermissionGrantPolicies.Item.Excludes {
    /// <summary>Builds and executes requests for operations under \policies\permissionGrantPolicies\{permissionGrantPolicy-id}\excludes</summary>
    public class ExcludesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraphSdk.policies.permissionGrantPolicies.item.excludes.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PermissionGrantConditionSet body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
