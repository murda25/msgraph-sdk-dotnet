...
namespace Microsoft.Graph.Policies.PermissionGrantPolicies.Item.Excludes {
    ...
    public class ExcludesRequestBuilder {
        ...
        /// </summary>
        public async Task<PermissionGrantConditionSetCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<ExcludesRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PermissionGrantConditionSet> PostAsync(PermissionGrantConditionSet body, CancellationToken cancellationToken = default, Action<ExcludesRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
