...
namespace Microsoft.Graph.Policies.RoleManagementPolicyAssignments.Item.Policy {
    ...
    public class PolicyRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleManagementPolicy> GetAsync(CancellationToken cancellationToken = default, Action<PolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
