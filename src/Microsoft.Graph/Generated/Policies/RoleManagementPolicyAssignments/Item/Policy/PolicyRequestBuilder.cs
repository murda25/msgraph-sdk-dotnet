...
namespace Microsoft.Graph.Policies.RoleManagementPolicyAssignments.Item.Policy {
    ...
    public class PolicyRequestBuilder {
        ...
        /// </summary>
        public async Task<UnifiedRoleManagementPolicy> GetAsync(Action<PolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
