...
using MicrosoftGraphSdk.Policies.FeatureRolloutPolicies.Item.AppliesTo;
using System;
...
namespace MicrosoftGraphSdk.Policies.FeatureRolloutPolicies.Item {
    ...
    public class FeatureRolloutPolicyRequestBuilder {
        ...
        /// </summary>
        public FeatureRolloutPolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/policies/featureRolloutPolicies/{featureRolloutPolicy_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public FeatureRolloutPolicyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
