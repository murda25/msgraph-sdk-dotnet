...
namespace Microsoft.Graph.Policies.CrossTenantAccessPolicy {
    ...
    public class CrossTenantAccessPolicyRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.CrossTenantAccessPolicy> GetAsync(CancellationToken cancellationToken = default, Action<CrossTenantAccessPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.CrossTenantAccessPolicy body, CancellationToken cancellationToken = default, Action<CrossTenantAccessPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
