...
namespace Microsoft.Graph.Policies.CrossTenantAccessPolicy.Partners {
    ...
    public class PartnersRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.policies.crossTenantAccessPolicy.partners.item collection</summary>
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CrossTenantAccessPolicyConfigurationPartner body, Action<PartnersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> GetAsync(Action<PartnersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CrossTenantAccessPolicyConfigurationPartner> PostAsync(CrossTenantAccessPolicyConfigurationPartner body, Action<PartnersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
