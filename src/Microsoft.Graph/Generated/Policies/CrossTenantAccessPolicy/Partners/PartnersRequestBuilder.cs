...
namespace Microsoft.Graph.Policies.CrossTenantAccessPolicy.Partners {
    ...
    public class PartnersRequestBuilder {
        ...
        /// </summary>
        public async Task<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<PartnersRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CrossTenantAccessPolicyConfigurationPartner> PostAsync(CrossTenantAccessPolicyConfigurationPartner body, CancellationToken cancellationToken = default, Action<PartnersRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
