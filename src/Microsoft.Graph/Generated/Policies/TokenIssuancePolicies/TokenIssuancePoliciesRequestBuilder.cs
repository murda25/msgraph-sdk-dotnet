...
using MicrosoftGraphSdk.Policies.TokenIssuancePolicies.Item;
using System;
...
namespace MicrosoftGraphSdk.Policies.TokenIssuancePolicies {
    /// <summary>Builds and executes requests for operations under \policies\tokenIssuancePolicies</summary>
    public class TokenIssuancePoliciesRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(TokenIssuancePolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
