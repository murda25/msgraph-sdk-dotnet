...
namespace MicrosoftGraphSdk.Policies.ConditionalAccessPolicies.Item {
    /// <summary>Builds and executes requests for operations under \policies\conditionalAccessPolicies\{conditionalAccessPolicy-id}</summary>
    public class ConditionalAccessPolicyRequestBuilder {
        ...
        public ConditionalAccessPolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/policies/conditionalAccessPolicies/{conditionalAccessPolicy_id}{?select,expand}";
