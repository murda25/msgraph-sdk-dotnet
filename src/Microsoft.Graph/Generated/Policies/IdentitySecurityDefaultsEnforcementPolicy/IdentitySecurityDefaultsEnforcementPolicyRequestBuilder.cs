...
namespace Microsoft.Graph.Policies.IdentitySecurityDefaultsEnforcementPolicy {
    ...
    public class IdentitySecurityDefaultsEnforcementPolicyRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.IdentitySecurityDefaultsEnforcementPolicy> GetAsync(CancellationToken cancellationToken = default, Action<IdentitySecurityDefaultsEnforcementPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Microsoft.Graph.Models.IdentitySecurityDefaultsEnforcementPolicy body, CancellationToken cancellationToken = default, Action<IdentitySecurityDefaultsEnforcementPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
