...
namespace Microsoft.Graph
{
    ...
    public partial class AccessPackageAssignmentRequestRequestBuilder : EntityRequestBuilder, IAccessPackageAssignmentRequestRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>The <see cref="IAccessPackageAssignmentWithReferenceRequestBuilder"/>.</returns>
        public IAccessPackageAssignmentWithReferenceRequestBuilder Assignment
        {
            get
            {
                return new AccessPackageAssignmentWithReferenceRequestBuilder(this.AppendSegmentToRequestUrl("assignment"), this.Client);
            }
        }
        ...
        public IAccessPackageSubjectWithReferenceRequestBuilder Requestor
        {
            get
            {
                return new AccessPackageSubjectWithReferenceRequestBuilder(this.AppendSegmentToRequestUrl("requestor"), this.Client);
            }
        }
