...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type AccessPackageQuestionReferenceRequest.
    /// </summary>
    public partial class AccessPackageQuestionReferenceRequest : BaseRequest, IAccessPackageQuestionReferenceRequest
    {
        /// <summary>
        /// Constructs a new AccessPackageQuestionReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public AccessPackageQuestionReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AccessPackageQuestion reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified AccessPackageQuestion reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AccessPackageQuestion reference.
        /// </summary>
        /// <param name="id">The AccessPackageQuestion reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified AccessPackageQuestion reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AccessPackageQuestion reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
