...
namespace Microsoft.Graph
{
    ...
    public partial class AccessPackageAssignmentRequestBuilder : EntityRequestBuilder, IAccessPackageAssignmentRequestBuilder
    {
        ...
        public IAccessPackageSubjectWithReferenceRequestBuilder Target
        {
            get
            {
                return new AccessPackageSubjectWithReferenceRequestBuilder(this.AppendSegmentToRequestUrl("target"), this.Client);
            }
        }
