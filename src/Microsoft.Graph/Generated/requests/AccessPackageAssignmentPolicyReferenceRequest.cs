...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class AccessPackageAssignmentPolicyReferenceRequest : BaseRequest, IAccessPackageAssignmentPolicyReferenceRequest
    {
        /// <summary>
        ...
        public AccessPackageAssignmentPolicyReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AccessPackageAssignmentPolicy reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AccessPackageAssignmentPolicy reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AccessPackageAssignmentPolicy reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
