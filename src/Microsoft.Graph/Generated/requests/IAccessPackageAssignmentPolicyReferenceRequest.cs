...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IAccessPackageAssignmentPolicyReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Puts the specified AccessPackageAssignmentPolicy reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The AccessPackageAssignmentPolicy reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
