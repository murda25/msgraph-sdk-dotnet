using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.Application;
using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.Count;
using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.Device;
using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.Group;
using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.Item;
using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.OrgContact;
using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.ServicePrincipal;
using Microsoft.Graph.Contacts.Item.TransitiveMemberOf.User;
...
namespace Microsoft.Graph.Contacts.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.contacts.item.transitiveMemberOf.item collection</summary>
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
