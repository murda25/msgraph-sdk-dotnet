using Microsoft.Graph.Contacts.Item.MemberOf.Application;
using Microsoft.Graph.Contacts.Item.MemberOf.Count;
using Microsoft.Graph.Contacts.Item.MemberOf.Device;
using Microsoft.Graph.Contacts.Item.MemberOf.Group;
using Microsoft.Graph.Contacts.Item.MemberOf.Item;
using Microsoft.Graph.Contacts.Item.MemberOf.OrgContact;
using Microsoft.Graph.Contacts.Item.MemberOf.ServicePrincipal;
using Microsoft.Graph.Contacts.Item.MemberOf.User;
...
namespace Microsoft.Graph.Contacts.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.contacts.item.memberOf.item collection</summary>
        ...
        public MemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
