...
namespace Microsoft.Graph.Contacts.Item.MemberOf.Item.OrgContact.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.orgContact/microsoft.graph.restore";
