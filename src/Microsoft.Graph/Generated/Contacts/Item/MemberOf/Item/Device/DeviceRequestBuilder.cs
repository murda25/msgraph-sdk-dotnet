...
namespace Microsoft.Graph.Contacts.Item.MemberOf.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}";
