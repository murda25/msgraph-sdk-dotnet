...
namespace Microsoft.Graph.Contacts.Item.DirectReports {
    ...
    public class DirectReportsRequestBuilder {
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(CancellationToken cancellationToken = default, Action<DirectReportsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
