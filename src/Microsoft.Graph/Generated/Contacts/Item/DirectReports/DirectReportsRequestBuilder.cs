...
using Microsoft.Graph.Contacts.Item.DirectReports.OrgContact;
using Microsoft.Graph.Contacts.Item.DirectReports.User;
...
namespace Microsoft.Graph.Contacts.Item.DirectReports {
    ...
    public class DirectReportsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.contacts.item.directReports.item collection</summary>
        ...
        public DirectReportsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/directReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DirectReportsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// </summary>
        public async Task<DirectoryObjectCollectionResponse> GetAsync(Action<DirectReportsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
