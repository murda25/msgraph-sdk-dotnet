...
namespace Microsoft.Graph.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.OrgContact> PostAsync(Microsoft.Graph.Models.OrgContact body, CancellationToken cancellationToken = default, Action<ContactsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
