...
namespace Microsoft.Graph.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        /// <summary>Gets an item from the Microsoft.Graph.contacts.item collection</summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Microsoft.Graph.Models.OrgContact> PostAsync(Microsoft.Graph.Models.OrgContact body, Action<ContactsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
