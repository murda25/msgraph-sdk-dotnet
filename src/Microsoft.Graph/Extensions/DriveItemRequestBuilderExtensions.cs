...
public static class DriveItemRequestBuilderExtensions
{
    ...
    /// <returns>The drive item request builder.</returns>
    /// </summary>
    public static CustomDriveItemItemRequestBuilder ItemWithPath(this Microsoft.Graph.Drive.Root.RootRequestBuilder rootRequestBuilder, string path)
    {
        if (!string.IsNullOrEmpty(path))
        {
            if (!path.StartsWith("/"))
    ...
    /// <returns>The drive item request builder.</returns>
    /// </summary>
    public static CustomDriveItemItemRequestBuilder ItemWithPath(this Microsoft.Graph.Drive.Items.Item.DriveItemItemRequestBuilder rootRequestBuilder, string path)
    {
        if (!string.IsNullOrEmpty(path))
        {
            if (!path.StartsWith("/"))
    ...
    /// <returns>The drive item request builder.</returns>
    /// </summary>
    public static CustomDriveItemItemRequestBuilder ItemWithPath(this Microsoft.Graph.Me.Drives.Item.Items.Item.DriveItemItemRequestBuilder rootRequestBuilder, string path)
    {
        if (!string.IsNullOrEmpty(path))
        {
            if (!path.StartsWith("/"))
...
public class CustomDriveItemItemRequestBuilder : Microsoft.Graph.Drive.Items.Item.DriveItemItemRequestBuilder
{
