...
namespace Microsoft.Graph.DotnetCore.Test.Requests.Functional
{
    ...
    public class DeltaQueryTests: GraphTestBase
    {
        ...
        public async Task DeltaLinkDriveItem()
        {
            ...
            var driveItemDeltaCollectionPage = await graphClient.Drives["driveId"].Root.Delta().GetAsync();
            ...
            {
                driveItemDeltaCollectionPage = await new Microsoft.Graph.Drives.Item.Root.Delta.DeltaRequestBuilder(driveItemDeltaCollectionPage.OdataNextLink, graphClient.RequestAdapter).GetAsync();
            }
            ...
            {
                driveItemDeltaCollectionPage = await new Microsoft.Graph.Drives.Item.Root.Delta.DeltaRequestBuilder(driveItemDeltaCollectionPage.OdataDeltaLink, graphClient.RequestAdapter).GetAsync();
            }
