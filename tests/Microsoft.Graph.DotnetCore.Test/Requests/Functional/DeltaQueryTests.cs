...
namespace Microsoft.Graph.DotnetCore.Test.Requests.Functional
{
    ...
    public class DeltaQueryTests: GraphTestBase
    {
        ...
        public async Task DeltaLinkDriveItem()
        {
            ...
            var driveItemDeltaCollectionPage = await graphClient.Drives["driveId"].Items["itemId"].MicrosoftGraphDelta.GetAsync();
            ...
            {
                driveItemDeltaCollectionPage = await new Microsoft.Graph.Drives.Item.Items.Item.MicrosoftGraphDelta.MicrosoftGraphDeltaRequestBuilder(driveItemDeltaCollectionPage.OdataNextLink, graphClient.RequestAdapter).GetAsync();
            }
            ...
            {
                driveItemDeltaCollectionPage = await new Microsoft.Graph.Drives.Item.Items.Item.MicrosoftGraphDelta.MicrosoftGraphDeltaRequestBuilder(driveItemDeltaCollectionPage.OdataDeltaLink, graphClient.RequestAdapter).GetAsync();
            }
        ...
        public async Task DeltaLinkMessages()
        {
            ...
            {
                messagesDeltaCollectionPage = await new Microsoft.Graph.Me.MailFolders.Item.Messages.MicrosoftGraphDelta.MicrosoftGraphDeltaRequestBuilder(messagesDeltaCollectionPage.OdataNextLink,graphClient.RequestAdapter).GetAsync();
            }
        ...
        public async Task UserDeltaLink()
        {
            ...
            {
                userDeltaCollectionPage = await new Microsoft.Graph.Users.MicrosoftGraphDelta.MicrosoftGraphDeltaRequestBuilder(userDeltaCollectionPage.OdataNextLink, graphClient.RequestAdapter).GetAsync();
            }
            ...
            {
                userDeltaCollectionPage = await new Microsoft.Graph.Users.MicrosoftGraphDelta.MicrosoftGraphDeltaRequestBuilder(userDeltaCollectionPage.OdataDeltaLink, graphClient.RequestAdapter).GetAsync();
            }
        }
        ...
        public async Task GroupDeltaLink()
        {
            ...
            {
                groupDeltaCollectionPage = await new Microsoft.Graph.Groups.MicrosoftGraphDelta.MicrosoftGraphDeltaRequestBuilder(groupDeltaCollectionPage.OdataNextLink,graphClient.RequestAdapter).GetAsync();
            }

            // Now let's use the deltalink to make sure there aren't any changes.
            if (groupDeltaCollectionPage.OdataDeltaLink != null)
            {
                groupDeltaCollectionPage = await new Microsoft.Graph.Groups.MicrosoftGraphDelta.MicrosoftGraphDeltaRequestBuilder(groupDeltaCollectionPage.OdataDeltaLink,graphClient.RequestAdapter).GetAsync();
